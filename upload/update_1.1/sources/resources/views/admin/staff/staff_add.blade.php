...
@push('title', get_phrase('Staff Add'))
@push('meta')
@endpush
@push('css')
@endpush
                ...
                <div class="ol-card-body">
                    <form action="{{ route('admin.staff.store') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" value="{{ old('name') }}" name="name" class="form-control ol-form-control" id="name" placeholder="{{ get_phrase('Enter staff name') }}" aria-label="{{ get_phrase('Enter staff name') }}" required>
                        </div>

                        <div class="mb-3">
                            <label for="email" class="form-label ol-form-label">{{ get_phrase('Account Email') }}</label>
                            <input type="text" value="{{ old('email') }}" name="email" class="form-control ol-form-control" id="email" placeholder="{{ get_phrase('Enter staff email') }}" aria-label="{{ get_phrase('Enter staff email') }}" required>
                        </div>

                        <div class="mb-3">
                            <label for="password" class="form-label ol-form-label">{{ get_phrase('Account Password') }}</label>
                            <input type="text" value="{{ old('password') }}" name="password" class="form-control ol-form-control" id="password" placeholder="{{ get_phrase('Enter staff password') }}" aria-label="{{ get_phrase('Enter staff password') }}" required>
                        </div>

                        <div class="mb-3">
                            <label for="phone" class="form-label ol-form-label">{{ get_phrase('Staff Phone') }}</label>
                            <input type="text" value="{{ old('phone') }}" name="phone" class="form-control ol-form-control" id="phone" placeholder="{{ get_phrase('Enter staff phone') }}" aria-label="{{ get_phrase('Enter staff phone') }}" required>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" value="{{ old('zip') }}" name="zip" class="form-control ol-form-control" id="zip" placeholder="{{ get_phrase('Enter staff zip code') }}" aria-label="{{ get_phrase('Enter staff zip code') }}" required>
                        </div>
