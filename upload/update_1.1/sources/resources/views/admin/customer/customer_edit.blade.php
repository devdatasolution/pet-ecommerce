...
@push('title', get_phrase('Edit customer'))
@push('meta')
@endpush
@push('css')
@endpush
        ...
        <div class="col-md-7">
            <div class="ol-card p-4">
                <div class="ol-card-body">
                    <form action="{{ route('admin.customer.update', ['id' => $customer->id]) }}" method="post" enctype="multipart/form-data">
                        @csrf

                        <div class="mb-3">
                            <label for="name" class="form-label ol-form-label">{{ get_phrase('Customer Name') }}</label>
                            <input type="text" value="{{ $customer->name }}" name="name" class="form-control ol-form-control" id="name" placeholder="{{ get_phrase('Enter customer name') }}" aria-label="{{ get_phrase('Enter customer name') }}" required>
                        </div>

                        <div class="mb-3">
                            <label for="email" class="form-label ol-form-label">{{ get_phrase('Customer Email') }}</label>
                            <input type="text" value="{{ $customer->email }}" name="email" class="form-control ol-form-control" id="email" placeholder="{{ get_phrase('Enter customer email') }}" aria-label="{{ get_phrase('Enter customer email') }}" required>
                        </div>

                        <div class="mb-3">
                            <label for="phone" class="form-label ol-form-label">{{ get_phrase('Customer Phone') }}</label>
                            <input type="text" value="{{ $customer->phone }}" name="phone" class="form-control ol-form-control" id="phone" placeholder="{{ get_phrase('Enter customer phone') }}" aria-label="{{ get_phrase('Enter customer phone') }}" required>
                        </div>

                        <div class="mb-3">
                            <label for="address" class="form-label ol-form-label">{{ get_phrase('Address') }}</label>
                            <textarea name="address" rows="4" class="form-control ol-form-control" id="address" placeholder="{{ get_phrase('Write address') }}">{{ $customer->address }}</textarea>
                        </div>

                        @php
                            $selected_city = $customer->city;
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" value="{{ $customer->zip }}" name="zip" class="form-control ol-form-control" id="zip" placeholder="{{ get_phrase('Enter customer zip code') }}" aria-label="{{ get_phrase('Enter customer zip code') }}" required>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="date" value="{{ date('Y-m-d', strtotime($customer->date_of_birth)) }}" name="date_of_birth" class="form-control ol-form-control" id="date_of_birth" placeholder="{{ get_phrase('Enter date of birth') }}" aria-label="{{ get_phrase('Enter date of birth') }}" required>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="eRadios">
                                <div class="form-check">
                                    <input @if ($customer->gender == 'male') checked @endif type="radio" value="male" name="gender" class="form-check-input eRadioSuccess" id="gender_male">
                                    <label for="gender_male" class="form-check-label">{{ get_phrase('Male') }}</label>
                                </div>

                                <div class="form-check">
                                    <input @if ($customer->gender == 'female') checked @endif type="radio" value="female" name="gender" class="form-check-input eRadioPrimary" id="gender_female">
                         ...
                         <div class="col-sm-6 mb-3">
                            ...
                            <div class="form-check">
                                <input class="form-check-input"  name="email_verified_at" type="checkbox"  value="1" 
                                    id="email_verified_at" {{ $customer->email_verified_at ? 'checked' : '' }}>
