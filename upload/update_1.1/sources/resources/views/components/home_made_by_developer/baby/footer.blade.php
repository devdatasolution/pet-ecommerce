...
<div class="commonDivHidden">
                ...
                <div class="col-12">
                    <div class="footer-top-main">
                        <div class="footer-logo-area">
                            ...
                            <p class="footer-subtitle">{{get_settings('summary')}}</p>
                                ...
                                <li>
                                    <a href="{{get_settings('contact_instagram')}}" target="_blank" class="footer-social-link">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 19 18" fill="none">
                                            ...
                                            <path d="M15.4471 4.19404C15.4471 4.79169 14.9621 5.27333 14.3681 5.27333C13.7706 5.27333 13.2891 4.78817 13.2891 4.19404C13.2891 3.59638 13.7741 3.11475 14.3681 3.11475C14.9621 3.11475 15.4471 3.5999 15.4471 4.19404Z" fill="#000"/>
                                            </g>
                                            <defs>
                        ...
                        <div class="footer-nav-main">
                            <div class="footer-nav-wrap">
                                <h3 class="footer-nav-title builder-editable" builder-identity="BF1">{{get_phrase('Quick Links')}}</h3>
                            ...
                            @endphp
                            <div class="footer-nav-wrap">
                                <h3 class="footer-nav-title builder-editable" builder-identity="BF2">{{get_phrase('Top Categories')}}</h3>
                                <ul class="footer-navbar-nav">
                            ...
                            <div class="footer-nav-wrap">
                                <h3 class="footer-nav-title builder-editable" builder-identity="BF3">{{get_phrase('Support')}}</h3>
                                <ul class="footer-navbar-nav">
                    ...
                    <div class="footer-copyright-area">
                        ...
                        <ul class="ft-card-list">
                                 @php $payment_gateways = \App\Models\Payment_gateway::where('status', 1)->take(6)->get(); @endphp
                                    @foreach ($payment_gateways as $key => $payment_gateway)
                                        <li class="ft-single-card" >
                                            <img class="card"  src="{{ asset('assets/payment/' . $payment_gateway->identifier . '.png') }}" alt="">
 ...
 {{-- Baby --}}
<script src="{{ asset('assets/frontend/baby/vendors/swiper/swiper-bundle.min.js') }}"></script>
{{-- <script src="{{ asset('assets/frontend/baby/vendors/wow-js/wow.min.js') }}"></script> --}}
<script src="{{ asset('assets/frontend/baby/js/header.js') }}"></script>
<script src="{{ asset('assets/frontend/baby/js/script.js') }}"></script>