                    ...
                    <div class="col-lg-8">
                        <div class="footer-middle-area d-flex justify-content-between flex-wrap">
                            <div class="footer-nav-area">
                                <h4 class="al-title-18px text-white mb-4 builder-editable" builder-identity="f1">{{get_phrase('Quick Links')}}</h4>
                            ...
                            @endphp
                            <div class="footer-nav-area">
                                <h4 class="al-title-18px text-white mb-4 builder-editable" builder-identity="f2">{{get_phrase('Top Categories')}}</h4>
                                <ul class="d-flex flex-column gap-18px">
                            ...
                            <div class="footer-nav-area">
                                <h4 class="al-title-18px text-white mb-4 builder-editable" builder-identity="f3">{{get_phrase('Support')}}</h4>
                                <ul class="d-flex flex-column gap-18px">
                            ...
                            <div class="footer-nav-area">
                                <h4 class="al-title-18px text-white mb-4 builder-editable" builder-identity="f4">{{get_phrase('Contact Us')}}</h4>
                                <ul class="d-flex flex-column gap-18px">
                                    <li>
                                        <a href="tel:{{get_settings('phone')}}" class="footer-nav-link">
                                            <div class="d-flex column-gap-2 align-items-start">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="25" viewBox="0 0 24 25" fill="none">
                                                    <path d="M17.3585 15.2602C16.7204 15.123 16.2156 15.4193 15.7686 15.678C15.3108 15.9446 14.4404 16.6507 13.9414 16.4701C11.387 15.4183 8.98453 13.1825 7.94451 10.6178C7.76122 10.1082 8.46403 9.23223 8.72869 8.76907C8.98551 8.32072 9.27565 7.81114 9.14332 7.16824C9.02373 6.59052 7.47695 4.62232 6.93 4.08411C6.56928 3.72859 6.19974 3.53305 5.8204 3.50144C4.39418 3.44022 2.80134 5.34324 2.52198 5.7985C1.82211 6.76927 1.82603 8.061 2.53374 9.62725C4.23931 13.8343 10.6901 20.1832 14.9128 21.9529C15.6921 22.3173 16.4047 22.5 17.0448 22.5C17.6711 22.5 18.2289 22.3252 18.7083 21.9786C19.0699 21.7702 21.051 20.0983 20.999 18.6338C20.9676 18.2604 20.7726 17.8872 20.4217 17.5257C19.8874 16.9737 17.9319 15.3808 17.3585 15.2602Z" fill="#C3FF3D"></path>
                                                </svg>
                                    ...
                                    <li>
                                        <a href="mailto:{{get_settings('system_email')}}" class="footer-nav-link">
                                            <div class="d-flex column-gap-2 align-items-start">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="25" viewBox="0 0 24 25" fill="none">
                                                    <path d="M17 4H7C4 4 2 5.5 2 9V16C2 19.5 4 21 7 21H17C20 21 22 19.5 22 16V9C22 5.5 20 4 17 4ZM17.47 10.09L14.34 12.59C13.68 13.12 12.84 13.38 12 13.38C11.16 13.38 10.31 13.12 9.66 12.59L6.53 10.09C6.21 9.83 6.16 9.35 6.41 9.03C6.67 8.71 7.14 8.65 7.46 8.91L10.59 11.41C11.35 12.02 12.64 12.02 13.4 11.41L16.53 8.91C16.85 8.65 17.33 8.7 17.58 9.03C17.84 9.35 17.79 9.83 17.47 10.09Z" fill="#C3FF3D"></path>
                                                </svg>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="footer-copyright-area d-flex align-items-center justify-content-center justify-content-sm-between column-gap-4 row-gap-4 flex-wrap flex-column flex-sm-row">
                    <p class="al-subtitle2-16px lh-1  text-center text-sm-left builder-editable" builder-identity="f5"> {{get_phrase('Copyright ©')}} {{ date('Y') }} | {{get_phrase('All rights reserved by creativeitem.com')}}</p>
...
<script src="{{ asset('assets/frontend/sports/vendors/swiper/swiper-bundle.min.js') }}"></script>

<script src="{{ asset('assets/frontend/sports/js/header.js') }}"></script>
<script src="{{ asset('assets/frontend/sports/js/script.js') }}"></script> 
