<link rel="stylesheet" href="{{ asset('assets/frontend/perfume/css/header.css') }}">
<link rel="stylesheet" href="{{ asset('assets/frontend/perfume/css/footer.css') }}">
<link rel="stylesheet" href="{{ asset('assets/frontend/perfume/css/style.css') }}">
<link rel="stylesheet" href="{{ asset('assets/frontend/perfume/css/responsive.css') }}">
...
<!-- Main Header -->
<header class="pf-header-section">
    <div class="container">
        <div class="row">
            <div class="col-12">
                <div class="pf-header-area">
                    <nav class="pf-header-navbar">
                        <!-- Menu Button -->
                        <button class="pf-menu-button d-block d-lg-none" type="button" data-bs-toggle="offcanvas"
                        ...
                        <div class="d-none d-lg-block">
                            <ul class="pf-navbar-nav">
                                <li class="pf-nav-item"><a
                                        class="pf-nav-link @if ($current_route == 'home') active @endif"
                                        href="{{ route('home') }}">{{ get_phrase('Home') }}</a></li>
                                <!-- Mega Menu Button -->
                                <li class="pf-nav-item pf-mega-menu-btn">
                                    <a href="javascript:void(0)" class="pf-nav-link pf-mega-menu-link">
                                        <span>{{ get_phrase('Categories') }}</span>
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" height="6"
                                            viewBox="0 0 10 6" fill="none">
                                            <path d="M9 1L5 5L1 1" stroke="white" stroke-width="1.2"
                                                stroke-linecap="round" stroke-linejoin="round" />
                                        </svg>
                                    </a>
                                    <!-- Mega Menu -->
                                    <div class="pf-mega-menu-wrap">
                                        <div class="container">
                                            <div class="row">
                                                @php
                                                ...
                                                <div class="col-12">
                                                    <div class="mega-menu-inner">
                                                        <div class="mega-banner-wrap">
                                                            @foreach ($categories->take(2) as $index => $category)
                                                                @if (!empty($category->thumbnail))
                                                                    <div class="mega-menu-banner d-none d-xl-block">
                                                                        <img class="banner"
                                                        ...
                                                        <div class="mega-nav-main d-flex flex-wrap">
                                                            @foreach ($categories as $category)
                                                                @php
                                                                    $subCategories = App\Models\Category::where(
                                                                        ...
                                                                        ->get();
                                                                @endphp
                                                                <div class="pf-mega-nav fit-w-304px">

                                                                    <a href="{{ route('products', $category->slug) }}">
                                                                        <h2 class="mega-nav-title">
                                                                            {{ $category->title }}</h2>
                                                                    </a>
                                                                    <ul class="mega-navbar-nav max-w-199px">
                                ...
                                <li class="pf-nav-item"><a class="pf-nav-link"
                                        href="{{ route('blog') }}">{{ get_phrase('Blog') }}</a></li>
                            </ul>
                        </div>
                    </nav>
                    <a href="{{ route('home') }}" class="pf-header-logo">
                        <img class="logo" src="{{ get_image(get_frontend_settings('light_logo')) }}" alt="logo">
                    </a>
                    <div class="pf-header-right d-flex align-items-center gap-2">
                        <div class="header-access-items">
                                ...
                                <a href="javascript:void(0)" class="header-access-item" data-bs-toggle="modal"
                                    ...
                                    <span
                                        ...
                                        <svg width="22" height="22" viewBox="0 0 22 22" fill="none"
                                            ...
                                            <path d="M16.7383 16.3792L21.1464 20.7873" stroke="white"
                                                stroke-width="1.44431" stroke-linecap="round" stroke-linejoin="round" />
                                            <path
                                                d="M1.30957 9.76697C1.30957 14.6361 5.25675 18.5832 10.1259 18.5832C12.5647 18.5832 14.7721 17.5931 16.3682 15.9927C17.9588 14.3979 18.9421 12.1973 18.9421 9.76697C18.9421 4.89787 14.995 0.950684 10.1259 0.950684C5.25675 0.950684 1.30957 4.89787 1.30957 9.76697Z"
                            ...
                            <a onclick="load_view('{{ route('view', ['path' => 'frontend.cart.offcanvas_cart_body']) }}', '#offcanvasCart')"
                                ...
                                aria-controls="offcanvasCart" class="header-access-item">
                                <span
                                    ...
                                    <svg width="23" height="22" viewBox="0 0 23 22" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path
                                            d="M19.0004 20.9183C19.8221 20.9183 20.4882 20.2522 20.4882 19.4306C20.4882 18.609 19.8221 17.9428 19.0004 17.9428C18.1788 17.9428 17.5127 18.609 17.5127 19.4306C17.5127 20.2522 18.1788 20.9183 19.0004 20.9183Z"
                                            fill="white" stroke="white" stroke-width="1.44431"
                                            stroke-linecap="round" stroke-linejoin="round" />
                                        <path
                                            d="M9.08247 20.9183C9.90411 20.9183 10.5702 20.2522 10.5702 19.4306C10.5702 18.609 9.90411 17.9428 9.08247 17.9428C8.26081 17.9428 7.59473 18.609 7.59473 19.4306C7.59473 20.2522 8.26081 20.9183 9.08247 20.9183Z"
                                            fill="white" stroke="white" stroke-width="1.44431"
                                            stroke-linecap="round" stroke-linejoin="round" />
                                        <path
                                            d="M4.61905 3.06536H21.4802L19.4965 13.9755H6.60271L4.61905 3.06536ZM4.61905 3.06536C4.45374 2.40413 3.62722 1.0817 1.64355 1.0817"
                                            stroke="white" stroke-width="1.44431" stroke-linecap="round"
                                            stroke-linejoin="round" />
                                        <path
                                            d="M19.4967 13.9755H6.60289H4.84811C3.07838 13.9755 2.13965 14.7503 2.13965 15.9592C2.13965 17.168 3.07838 17.9428 4.84811 17.9428H19.0008"
                                            stroke="white" stroke-width="1.44431" stroke-linecap="round"
                                            stroke-linejoin="round" />
                                    </svg>
                                </span>
                                ...
                                <a href="javascript:;" class="header-access-item">
                                    <span
                                        ...
                                        <svg width="25" height="22" viewBox="0 0 25 22" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path
                                                d="M23.4676 7.67308C23.4676 9.37736 22.805 11.0143 21.6218 12.2252C18.8982 15.0135 16.2565 17.921 13.4312 20.6082C12.7836 21.2152 11.7563 21.1931 11.1365 20.5586L2.99665 12.2252C0.536274 9.70632 0.536274 5.63984 2.99665 3.12096C5.4812 0.577329 9.52881 0.577329 12.0133 3.12096L12.3092 3.42385L12.6049 3.12114C13.7962 1.90093 15.4186 1.21271 17.1134 1.21271C18.8082 1.21271 20.4305 1.90086 21.6218 3.12096C22.8051 4.33196 23.4676 5.96884 23.4676 7.67308Z"
                                                stroke="white" stroke-width="1.44431" stroke-linejoin="round" />
                                        </svg>
                                    </span>
                                </a>
                            </div>
                            ...
                            @if (Auth::check())
                                <div class="dropdown">
                                    <button class="btn pf-user-dropdown-btn dropdown-toggle" type="button"
                                        data-bs-toggle="dropdown" aria-expanded="false">
                                        <div class="pf-user-dropdown-profile">
                                            <span
                                                class="d-flex align-items-center justify-content-center h-100 w-100 rounded-circle"
                                    ...
                                    <div class="dropdown-menu dropdown-menu-end pf-user-dropdown-menu">
                                        <div class="d-flex align-items-center gap-1 pf-user-dropdown-header">
                                            <div class="pf-user-dropdown-profile2">
                                                <img src="{{ get_image(auth()->user()->photo) }}" alt="user">
                                            </div>
                                            <h4 class="pf-user-dropdown-name">{{ auth()->user()->name }}</h4>
                                        </div>
                                        <ul>
