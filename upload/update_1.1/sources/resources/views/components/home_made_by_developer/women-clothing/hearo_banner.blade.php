                ...
                <div class="col-12">
                    <div class="hero-content-area">
                        <div class="hero-position-image1 wow animate__fadeInLeft" data-wow-delay=".1s">
                            <img class="img builder-editable" builder-identity="WOB1" src=" {{ asset('assets/frontend/women-clothing/images/hero-banner1.webp') }}" alt="">
                        </div>
                        <div class="hero-position-image2 wow animate__fadeInRight" data-wow-delay=".1s">
                            <img class="img builder-editable" builder-identity="WOB2" src="{{ asset('assets/frontend/women-clothing/images/hero-banner2.webp') }}" alt="">
                        </div>
                        <!-- Swiper -->
                            ...
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <div class="hero-slide-content">
                                        ...
                                        <h1 class="hero-title builder-editable" builder-identity="WOB4">{{get_phrase('Fashion That Speaks!')}}</h1>
