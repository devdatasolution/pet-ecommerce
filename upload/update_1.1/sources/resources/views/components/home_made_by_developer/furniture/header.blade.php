...
<link rel="stylesheet" href="{{ asset('assets/frontend/furniture/css/header.css') }}">
<link rel="stylesheet" href="{{ asset('assets/frontend/furniture/css/footer.css') }}">
<link rel="stylesheet" href="{{ asset('assets/frontend/furniture/css/style.css') }}">
<link rel="stylesheet" href="{{ asset('assets/frontend/furniture/css/responsive.css') }}">
...
<header class="logo-header">
    <div class="container">
        <div class="row justify-content-between align-items-center">
            ...
            <div class="col-auto col-md-6 col-lg-6 order-1 order-md-2">
                <div class="px-lg-4">
                    <div class="d-block d-md-none">
                        <button class="btn menu-button" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasMenu" aria-controls="offcanvasMenu">
                            <img src="{{ asset('assets/frontend/furniture/images/svg-icons/menu-bar.svg') }}" alt="icon">
                        </button>                                  
                    </div>
                            ...
                            <div class="mega-menu-btn-wrap">
                                <a href="javascript:void(0)" class="mega-menu-btn">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                                        <path d="M17.5 4.375H2.5C2.15833 4.375 1.875 4.09167 1.875 3.75C1.875 3.40833 2.15833 3.125 2.5 3.125H17.5C17.8417 3.125 18.125 3.40833 18.125 3.75C18.125 4.09167 17.8417 4.375 17.5 4.375Z" fill="#15191D"/>
                                        <path d="M10.3917 8.54166H2.5C2.15833 8.54166 1.875 8.25832 1.875 7.91666C1.875 7.57499 2.15833 7.29166 2.5 7.29166H10.3917C10.7333 7.29166 11.0167 7.57499 11.0167 7.91666C11.0167 8.25832 10.7417 8.54166 10.3917 8.54166Z" fill="#15191D"/>
                                        <path d="M17.5 12.7083H2.5C2.15833 12.7083 1.875 12.425 1.875 12.0833C1.875 11.7417 2.15833 11.4583 2.5 11.4583H17.5C17.8417 11.4583 18.125 11.7417 18.125 12.0833C18.125 12.425 17.8417 12.7083 17.5 12.7083Z" fill="#15191D"/>
                                        <path d="M10.3917 16.875H2.5C2.15833 16.875 1.875 16.5917 1.875 16.25C1.875 15.9083 2.15833 15.625 2.5 15.625H10.3917C10.7333 15.625 11.0167 15.9083 11.0167 16.25C11.0167 16.5917 10.7417 16.875 10.3917 16.875Z" fill="#15191D"/>
                                    </svg>
                                    <span>{{get_phrase('All Category')}}</span>
                                </a>
                                                    ...
                                                    @foreach ($categories->take(1) as $index => $category)
                                                        @if (!empty($category->thumbnail))
                                                            ...
                                                            <div class="mega-ads-wrap">
                                                                <div class="mega-ads-card"  style="background-image: url({{ get_image($category->thumbnail) }});">
                                                                    <div class="mads-titles-wrap">
                                                                        <h4 class="mads-sm-title">{{ $category->title }} </h4>
                                                                    </div>
                                                                    <div class="text-center">
                                                                        <a class="btn ec2-btn-white text-center" href="{{ route('products', $category->slug) }}">{{get_phrase('Shop Now')}}</a>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            @endif
                             ...
                             <nav>
                                <ul class="header-menu-ul">
                                    ...
                                    <li><a href="{{ route('events') }}" class="header-menuitem-a @if($current_route == 'events') active @endif">{{ get_phrase('Events') }}</a></li>
            ...
            <div class="col-auto col-md order-3">
                <div class="d-flex align-items-center gap-3 justify-content-end">
                    <div class="d-none d-md-block">
                        <a href="javascript:;" class="d-flex align-items-center gap-6px header-icontext-link" data-bs-toggle="modal" data-bs-target="#searchModal">
                    ...
                    <a class="d-flex align-items-center gap-6px header-icontext-link" onclick="load_view('{{ route('view', ['path' => 'frontend.cart.offcanvas_cart_body']) }}', '#offcanvasCart')"   data-bs-toggle="offcanvas" href="#offcanvasCart" role="button" aria-controls="offcanvasCart" href="javascript:;">
                        ...
                        <span class="d-none d-lg-block">{{get_phrase('Cart')}}</span>
                    </a>
                    <!-- For Login User -->
                     @if(Auth::check())
                    ...
                    <!-- For Logout User -->
                    <div>
                        <a href="javascript:;" onclick="formModal('{{ route('view', ['path' => 'auth.login_modal']) }}', '{{ get_phrase('Log In') }}')" class="d-flex align-items-center gap-6px header-icontext-link" data-bs-toggle="modal" data-bs-target="#loginModal">
                            ...
                            <span class="d-none d-lg-block">{{get_phrase('Login')}}</span>
                        </a>
                    </div>
                    @endif
                </div>
                ...
                <div class="modal-body">
                    <div class="mb-20px">
                        <form action="{{route('filter.search')}}" method="post">
                            @csrf
                            <label for="searchFormControlInput1" class="form-label modal-search-label mb-12px builder-editable" builder-identity="FH1">{{get_phrase('Search')}}</label>
