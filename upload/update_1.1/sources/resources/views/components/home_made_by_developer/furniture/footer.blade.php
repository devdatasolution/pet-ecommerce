                    ...
                    <div class="col-lg-8">
                        <div class="footer-middle-area d-flex justify-content-between flex-wrap">
                            <div class="footer-nav-area">
                                <h4 class="al-title-18px text-white mb-4 builder-editable" builder-identity="FF1">{{get_phrase('Quick Links')}}</h4>
                            ...
                            @endphp
                            <div class="footer-nav-area">
                                <h4 class="al-title-18px text-white mb-4 builder-editable" builder-identity="FF2">{{get_phrase('Top Categories')}}</h4>
                                <ul class="d-flex flex-column gap-18px">
                            ...
                            <div class="footer-nav-area">
                                <h4 class="al-title-18px text-white mb-4 builder-editable" builder-identity="FF3">{{get_phrase('Support')}}</h4>
                                <ul class="d-flex flex-column gap-18px">
                                ...
                                <ul class="d-flex flex-column gap-18px">
                                    ...
                                    <li>
                                        <a href="mailto:{{get_settings('system_email')}}" class="footer-nav-link">
                                            <div class="d-flex column-gap-2 align-items-start">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                                    <path d="M17 3.5H7C4 3.5 2 5 2 8.5V15.5C2 19 4 20.5 7 20.5H17C20 20.5 22 19 22 15.5V8.5C22 5 20 3.5 17 3.5ZM17.47 9.59L14.34 12.09C13.68 12.62 12.84 12.88 12 12.88C11.16 12.88 10.31 12.62 9.66 12.09L6.53 9.59C6.21 9.33 6.16 8.85 6.41 8.53C6.67 8.21 7.14 8.15 7.46 8.41L10.59 10.91C11.35 11.52 12.64 11.52 13.4 10.91L16.53 8.41C16.85 8.15 17.33 8.2 17.58 8.53C17.84 8.85 17.79 9.33 17.47 9.59Z" fill="#E67E22"/>
                                                </svg>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="footer-copyright-area d-flex align-items-center justify-content-center justify-content-sm-between column-gap-4 row-gap-4 flex-wrap flex-column flex-sm-row">
                    <p class="al-subtitle2-16px lh-1 text-center text-sm-left builder-editable" builder-identity="FF6"> {{get_phrase('Copyright ©')}} {{ date('Y') }} | {{get_phrase('All rights reserved by creativeitem.com')}}</p>
                    <ul class="d-flex align-items-center gap-20px flex-wrap justify-content-center justify-content-sm-start">
                        <li>
                            <a href="{{get_settings('contact_facebook')}}" target="_blank" class="svg-link2 d-block">
                        ...
                        <li>
                            <a href="{{get_settings('contact_twitter')}}" target="_blank" class="svg-link2 d-block">
                        ...
                        <li>
                            <a href="{{get_settings('contact_instagram')}}" target="_blank" class="svg-link2 d-block">
                                <svg xmlns="http://www.w3.org/2000/svg" width="19" height="18" viewBox="0 0 19 18" fill="none">
                        ...
                        <li>
                            <a href="{{get_settings('contact_linkedin')}}" target="_blank"  class="svg-link2 d-block">
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="18" viewBox="0 0 20 18" fill="none">
...
<!-- Scroll Top -->
 ...
 {{-- furniture --}}
 <script src="{{ asset('assets/frontend/furniture/vendors/swiper/swiper-bundle.min.js') }}"></script>
<script src="{{ asset('assets/frontend/furniture/vendors/nice-select/jquery.nice-select.min.js') }}"></script>
<script src="{{ asset('assets/frontend/furniture/js/header.js') }}"></script>
<script src="{{ asset('assets/frontend/furniture/js/script.js') }}"></script>