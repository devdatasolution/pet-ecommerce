...
<link rel="stylesheet" href="{{ asset('assets/frontend/fitness/css/header.css') }}">
<link rel="stylesheet" href="{{ asset('assets/frontend/fitness/css/footer.css') }}">
<link rel="stylesheet" href="{{ asset('assets/frontend/fitness/css/style.css') }}">
<link rel="stylesheet" href="{{ asset('assets/frontend/fitness/css/responsive.css') }}">
...
<!-- Main Header -->
<header class="fn-header-section">
    <div class="container">
        <div class="row">
            <div class="col-12">
                <div class="fn-header-area">
                    <a href="{{ route('home') }}" class="fn-header-logo">
                        <img class="logo" src="{{ get_image(get_frontend_settings('light_logo')) }}" alt="logo">
                    </a>
                    <nav class="fn-header-navbar d-none d-lg-block">
                        <ul class="fn-navbar-nav">
                            <li class="fn-nav-item"><a class="fn-nav-link"
                                    href="{{ route('home') }}">{{ get_phrase('Home') }}</a></li>
                            <!-- Mega Menu Button -->
                            <li class="fn-nav-item fn-mega-menu-btn">
                                <a href="javascript:void(0)" class="fn-nav-link fn-mega-menu-link">
                                ...
                                <!-- Mega Menu -->
                                <div class="fn-mega-menu-wrap">
                                    <div class="container">
                                        <div class="row mega-inner-row">
                                            @php
                            ...
                            <li class="bs-nav-item"><a href="{{ route('store') }}"
                                    class="fn-nav-link ">{{ get_phrase('Store') }}</a></li>
                            <li class="bs-nav-item"><a href="{{ route('events') }}"
                                    class="fn-nav-link ">{{ get_phrase('Events') }}</a></li>
                            <li class="bs-nav-item"><a href="{{ route('blog') }}"
                                    class="fn-nav-link ">{{ get_phrase('Blog') }}</a></li>
                        </ul>
                    </nav>
                    <div class="fn-header-right d-flex align-items-center gap-2">
                        <div class="fn-header-right-items d-flex align-items-center gap-6px">
                            <div class="d-none d-lg-block">
                                <a href="javascript:void(0)" class="fn-header-right-item" data-bs-toggle="modal"
                            ...
                            <a onclick="load_view('{{ route('view', ['path' => 'frontend.cart.offcanvas_cart_body']) }}', '#offcanvasCart')"
                                ...
                                aria-controls="offcanvasCart" href="javascript:;" class="fn-header-right-item">
                                <span
                            ...
                            <div class="d-none d-lg-block">
                                <a href="javascript:;" class="fn-header-right-item">
                                    <span
                                        class="d-flex align-items-center justify-content-center h-100 w-100 rounded-circle position-relative"
                            ...
                            @if (Auth::check())
                                <div class="dropdown">
                                    <button class="btn fn-user-dropdown-btn dropdown-toggle" type="button"
                                        data-bs-toggle="dropdown" aria-expanded="false">
                                        <div class="fn-user-dropdown-profile">
                                            <span
                                                class="d-flex align-items-center justify-content-center h-100 w-100 rounded-circle"
                                    ...
                                    <div class="dropdown-menu dropdown-menu-end fn-user-dropdown-menu">
                                        <div class="d-flex align-items-center gap-1 fn-user-dropdown-header">
                                            <div class="fn-user-dropdown-profile2">
                                                <img src="{{ get_image(auth()->user()->photo) }}" alt="user">
                                            </div>
                                            <h4 class="fn-user-dropdown-name">{{ auth()->user()->name }}</h4>
                                        </div>
                                        <ul>
                        ...
                        <!-- Menu Button -->
                        <button class="fn-menu-button d-block d-lg-none" type="button" data-bs-toggle="offcanvas"
                    ...
                    <form action="{{ route('filter.search') }}" method="post">
                        ...
                        <div class="header-search-form">
                            ...
                            <button class="btn header-search-btn" type="submit">
                                <img src="{{ asset('assets/frontend/fitness/images/svg-icons/search-white-16.svg') }}"
                                    alt="icon">
                            </button>
                        </div>
                    </form>
