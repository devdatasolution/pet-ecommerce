...
@endphp
<style>
   .layout-md  .pc-slider-image {
	height: 300px;
}
   .layout-sm  .pc-slider-image {
	height: 260px;
}
.layout-sm  .product-card-title{
    font-size: 20px;
}
.layout-md  .product-card-title {
	font-size: 24px;
}
   .layout-sm .product-card-price {
    line-height: 25px;
	font-size: 20px;
}
  .layout-sm  .fn-btn-dark {
	font-size: 16px;
}
</style>

<div class="single-product-card layout-{{ $layout }}">
