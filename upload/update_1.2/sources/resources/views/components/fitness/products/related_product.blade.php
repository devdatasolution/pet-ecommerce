...
<div class="swiper products-slider">
    <div class="swiper-wrapper">
            ...
            @foreach ($product->related_products()->where('status', 1)->take(30)->get() as $related_product)
             <div class="single-product-card swiper-slide">
                        <div class="pc-slider-wrap">
                            ...
                            <a href="javascript:;" class="pc-wishlist-btn {{ wishlist_class($related_product->id) }}" 
                            ...
                            <a href="javascript:;"  onclick="load_view('{{ route('view', ['path' => 'frontend.products.quick_view', 'product_id' => $related_product->id]) }}', '#quickViewModal .modal-body')" data-bs-toggle="modal" data-bs-target="#quickViewModal" class="pc-addToCart-btn">
                        ...
                        <div class="pc-details-wrap">
                            ...
                            <a href="{{ route('product', $related_product->slug) }}" class="product-card-title">{{ \Illuminate\Support\Str::limit($related_product->title, 70, '...') }}</a>
                                ...
                                <a href="{{ route('product', $related_product->slug) }}" class="btn fn-btn-dark">
