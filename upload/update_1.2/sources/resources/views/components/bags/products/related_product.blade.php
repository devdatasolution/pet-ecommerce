    ...
    <div class="swiper-wrapper">
            ...
            @foreach ($product->related_products()->where('status', 1)->take(30)->get() as $related_product)
                  ...
                  <div class="product-card swiper-slide">
                    ...
                    <div>
                        <div class="d-flex align-items-center gap-12px flex-wrap pc-rating-wrap mb-2">
                            ...
                            <p class="product-card-rating">({{ number_format($related_product->average_rating, 1) }})</p>
                        </div>
