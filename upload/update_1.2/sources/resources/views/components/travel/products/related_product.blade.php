                ...
                <div class="tr-tranding-card swiper-slide">
                        <div class="tr-tranding-image">
                            <div class="tr-title d-flex justify-content-between">
                                <h4>{{ \Illuminate\Support\Str::limit($related_product->title, 50, '...') }}</h4>
                                <span class="pc-wishlist-btn {{ wishlist_class($related_product->id) }}" 
                        ...
                        <a href="{{ route('product', $related_product->slug) }}" class="tr-tomato-btn w-100 text-center">
