            ...
            @foreach ($product->related_products()->where('status', 1)->take(30)->get() as $related_product)
                 <div class="product-card  swiper-slide">
                        <div class="product-card-banner">
                            ...
                            <a href="javascript:;" onclick="load_view('{{ route('view', ['path' => 'frontend.products.quick_view', 'product_id' => $related_product->id]) }}', '#quickViewModal .modal-body')" data-bs-toggle="modal" data-bs-target="#quickViewModal" class="pc-card-view">
                            ...
                            <a href="{{ route('product', $related_product->slug) }}"   class="btn product-card-btn">
                              {{get_phrase('Shop Now')}}
                            </a>
                        </div>
                        <div class="product-card-body pt-2">
                            ...
                            <div class="pc-stars-ratings mb-0">
                                ...
                                <p class="pc-rating-average">{{ number_format($related_product->average_rating, 1) }}</p>
                            </div>
