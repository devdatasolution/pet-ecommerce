            ...
            @foreach ($product->related_products()->where('status', 1)->take(30)->get() as $related_product)
                <div class="product-md-card swiper-slide">
                    <div class="product-md-banner mb-3">
                        ...
                        <a href="{{ route('product', $related_product->slug) }}" class="add-to-cart-btn">
                        ...
                        <a href="javascript:void(0)" onclick="load_view('{{ route('view', ['path' => 'frontend.products.quick_view', 'product_id' => $related_product->id]) }}', '#quickViewModal .modal-body')" class="quick-view-btn" data-bs-toggle="modal" data-bs-target="#quickViewModal">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                    ...
                    <div class="product-md-details">
                        <a href="{{ route('product', $related_product->slug) }}" class="mb-10px al-title-16px text-link">{{ $related_product->title }}</a>
                        <p class="mb-3 al-subtitle-14px capitalize">{{$related_product->quality_label}}</p>
