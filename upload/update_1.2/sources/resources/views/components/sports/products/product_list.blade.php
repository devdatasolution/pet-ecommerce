    ...
    <div class="d-block product-list-view">
        <div class="d-flex align-items-center gap-4 flex-column flex-md-row">
            <div class="product-list-banner">
                ...
                <a href="javascript:void(0)" class="quick-view-btn" onclick="load_view('{{ route('view', ['path' => 'frontend.products.quick_view', 'product_id' => $product->id]) }}', '#quickViewModal .modal-body')"  class="dark-light-iconbtn" data-bs-toggle="modal" data-bs-target="#quickViewModal">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
            ...
            <div class="w-100">
                <div class="d-flex align-items-start gap-3 mb-4 justify-content-between flex-column flex-md-row">
                    ...
                    {{-- <a href="" class="btn ec2-btn-dark text-nowrap"> {{ strtoupper(get_phrase('ADDED TO CART')) }}
                    </a> --}}
                </div>
                <p class="al-subtitle2-14px">{{ $product->summary }}</p>
            </div>
        </div>
    </div>
</div>