            ...
            <div class="row">
                <div class="col-12">
                    <div class="seasonal-section-title-area">
                        <h5 class="section-sm-title text-center mb-22px wow animate__fadeInUp builder-editable" builder-identity="WOSE1" data-wow-delay=".1s">{{get_phrase('Seasonal Style Picks')}}</h5>
                        <div class="d-flex  align-items-start align-items-lg-center justify-content-start justify-content-lg-between column-gap-4 row-gap-4 flex-column flex-lg-row">
                            <h2 class="section-title text-center m-auto seasonal-section-title wow animate__fadeInUp builder-editable" builder-identity="WOSE2" data-wow-delay=".2s">{{get_phrase('Handpicked looks to match the moment')}}</h2>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row mt-5">
                <div class="col-12">
                    <div class="text-center">
                        <a href="{{route('all_products')}}" class="btn dark-corner-btn hero-corner-btn builder-editable" builder-identity="WOSX1">{{get_phrase('Explore Products')}}</a>
                    </div>
                </div>
            </div>
