        ...
        <div class="row">
            <div class="col-12">
                <div class="latest-essential-title-area d-flex justify-content-between align-items-center gap-3 flex-wrap">
                    <h2 class="section-title le-area-title text-center text-xl-start wow animate__fadeInUp builder-editable" builder-identity="PE1" data-wow-delay=".1s">{{get_phrase('Latest Essentials for Every Pet')}}</h2>
                    <div class="le-title-right">
                        <p class="section-subtitle le-area-subtitle mb-30px text-center text-xl-start wow animate__fadeInUp builder-editable" builder-identity="PE2" data-wow-delay=".2s">{{get_phrase('Fresh finds your furry (or feathered) friends will love. Discover the latest in pet care and fun.')}}</p>
                        <div class="d-flex gap-14px align-items-center flex-wrap justify-content-center justify-content-xl-start wow animate__fadeInUp" data-wow-delay=".3s">
                            <button type="button" data-filter=".show-all" class="btn product-filter-btn mixitup-control-active">{{get_phrase('All Products')}}</button>
                             @php
                            ...
                            <div class="d-flex align-items-center column-gap-12px row-gap-2 mb-4 flex-wrap">
                                <div class="d-flex align-items-center gap-2">
                                    ...
                                    @if ($catproduct->is_discounted()->exists())
                                        @if ($product->is_discounted->discount_type == 'flat')
                                            <div class="d-flex align-items-baseline gap-2">
                                                <h6 class="card-product-price">  {{ currency($catproduct->price - $product->is_discounted->discount_value) }} </h6>
                                                <h6 class="al-title-14px fw-medium fsh-text-gray"><del>{{ currency($catproduct->price) }}</del></h6>
                                            </div>
                                        @else
                                            @php
                                            ...
                                            @endphp
                                            <div class="d-flex align-items-baseline gap-2">
                                                <h6 class="card-product-price"> {{ currency($catproduct->price - $discount_amount) }}  </h6>
                                                    <h6 class="al-title-14px fw-medium fsh-text-gray"><del>{{ currency($product->price) }}</del></h6>
                                            </div>
                                            
                                        @endif
                                    @else
                                            <h6 class="card-product-price">{{ currency($catproduct->price) }}</h6>
                                    @endif
                            </div>
