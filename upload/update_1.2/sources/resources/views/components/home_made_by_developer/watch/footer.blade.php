...
<div class="commonDivHidden">
    ...
    <footer class="wch-footer-section">
        <div class="footer-typo-text">
            <img class="text" src="{{ get_image(get_frontend_settings('light_logo')) }}" alt="">
        </div>
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <div class="footer-content-area">
                        <div class="footer-left-area">
                            <p class="footer-info-text">“{{get_settings('summary')}}”</p>
                            <div class="d-flex align-items-center flex-wrap gap-20px mb-40px">
                                ...
                                <p class="ft-socail-text builder-editable" builder-identity="WF1">{{get_phrase('Follow us')}}</p>
                            </div>
                            <p class="footer-copyright-text builder-editable" builder-identity="WF2"> {{get_phrase('Copyright ©')}} {{ date('Y') }} | {{get_phrase('All rights reserved by watch.com')}}</p>
                        </div>
 ...
 {{-- Watch --}}
<script src="{{ asset('assets/frontend/watch/vendors/swiper/swiper-bundle.min.js') }}"></script>
<script src="{{ asset('assets/frontend/watch/vendors/slick/slick.min.js') }}"></script>
{{-- <script src="{{ asset('assets/frontend/watch/vendors/wow-js/wow.min.js') }}"></script> --}}
<script src="{{ asset('assets/frontend/watch/js/header.js') }}"></script>
<script src="{{ asset('assets/frontend/watch/js/script.js') }}"></script>