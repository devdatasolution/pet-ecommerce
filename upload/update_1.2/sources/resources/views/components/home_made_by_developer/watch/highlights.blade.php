                ...
                <div class="col-sm-12 col-md-10 col-lg-7">
                    <div class="highlighted-product-details wow animate__fadeInUp" data-wow-delay=".1s">
                        ...
                        <div class="wch-section-badge mb-26px wow animate__fadeInUp" data-wow-delay=".2s">
                            ...
                            <p class="builder-editable" builder-identity="WH1">{{get_phrase('Highlighted Product')}}</p>
                        ...
                        <div class="hp-subtitle-wrap wow animate__fadeInUp" data-wow-delay=".4s">
                            <p class="section-subtitle fw-bold text-black text-uppercase builder-editable" builder-identity="WH2">{{get_phrase('“Crafted for the Few. Built to Last.”')}}</p>
                            <p class="section-subtitle builder-editable" builder-identity="WH3">{{get_phrase('Only 500 pieces made. Swiss precision meets timeless design.')}}</p>
                            <p class="section-subtitle builder-editable" builder-identity="WH4">{{get_phrase('Precision-engineered in brushed titanium and fitted with genuine Swiss movement, the Valtor Chrono 500 is more than a watch—it’s a symbol of distinction. Sapphire crystal glass, hand-assembled detailing, and a numbered caseback make each piece a rare collectible. Built for those who value time as much as legacy.')}}</p>
                        </div>
                        <a href="{{route('all_products')}}" class="btn wch-btn-skin min-w-209px wow animate__fadeInUp builder-editable" builder-identity="WH5" data-wow-delay=".5s">{{get_phrase('View Full Specs')}}</a>
                    </div>
                </div>
                <div class="col-sm-8 col-md-8 col-lg-5">
                    <div class="highlighted-banner-wrap">
                        <div class="highlighted-banner1 wow animate__fadeInRight" data-wow-delay=".3s">
                            <img class="banner builder-editable" builder-identity="WH6" src="{{ asset('assets/frontend/watch/images/highlight-banner1.webp') }}" alt="category">
                        </div>
                        <div class="highlighted-banner2 wow animate__fadeInRight" data-wow-delay=".4s">
                              <img class="banner builder-editable" builder-identity="WH7" src="{{ asset('assets/frontend/watch/images/highlight-banner2.webp') }}" alt="category">
                        </div>
                    </div>
                </div>
            </div>
