                ...
                <div class="col-12">
                    <div class="footer-content-area">
                        <div class="footer-left-area">
                            <p class="footer-info-text builder-editable" builder-identity="WAF1">{{get_phrase('“Discover watches and jewelry that celebrate heritage, precision & personal style.”')}}</p>
                            <div class="d-flex align-items-center flex-wrap gap-20px mb-40px">
                                ...
                                <p class="ft-socail-text builder-editable" builder-identity="WAF2">{{get_phrase('Follow us')}}</p>
                            </div>
                            <p class="footer-copyright-text builder-editable" builder-identity="WAF3">{{get_phrase('Copyright ©')}} {{ date('Y') }} | {{get_phrase('All rights reserved by creativeitem.com')}}</p>
                        </div>
