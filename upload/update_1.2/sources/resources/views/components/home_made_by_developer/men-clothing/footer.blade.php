                    ...
                    <div class="col-12">
                        ...
                        <div class="footer-middle-wrap">
                            <div class="footer-logo-area">
                                ...
                                <p class="ft-info-text builder-editable" builder-identity="MEF1">{{get_phrase('We have clothes that suits your style and which you’re proud to wear. For the man.')}}</p>
                            ...
                            <div class="footer-nav-wrap">
                                <h4 class="ft-nav-title builder-editable" builder-identity="MEF2">{{get_phrase('Quick Link')}}</h4>
                                <ul>
                            ...
                            @endphp
                            <div class="footer-nav-wrap">
                                <h4 class="ft-nav-title builder-editable" builder-identity="MEF3">{{get_phrase('Categories')}}</h4>
                                <ul>
                            ...
                            <div class="footer-nav-wrap">
                                <h4 class="ft-nav-title builder-editable" builder-identity="MEF4">{{get_phrase('Support')}}</h4>
                                <ul>
                        ...
                        <div class="footer-copyright-area">
                            <p class="ft-copyright-text builder-editable" builder-identity="MEF5">{{get_phrase('Copyright ©')}} {{ date('Y') }} | {{get_phrase('All rights reserved by creativeitem.com')}}</p>
