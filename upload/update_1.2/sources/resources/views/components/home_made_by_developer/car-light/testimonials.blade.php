            ...
            <div class="row">
                <div class="col-12">
                    <div class="testi-section-title-area">
                        <h2 class="section-title text-center max-w-735px mx-auto wow animate__fadeInUp builder-editable" builder-identity="CTTS1" data-wow-delay=".1s">{{get_phrase('Loved by our customers')}}</h2>
                    </div>
                </div>
            </div>
                           ...
                           @endphp
                            ...
                            <div class="swiper-slide">
                                <div class="single-testimonial">
                                    ...
                                    <p class="testimonial-comment mt-4">{{$review->comment}}</p>
