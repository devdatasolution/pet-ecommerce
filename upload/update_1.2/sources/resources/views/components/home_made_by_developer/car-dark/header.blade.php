                ...
                <div class="header-search-area">
                    <form action="{{ route('filter.search') }}" method="post" class="d-lg-block d-none">
                        ...
                        <div class="position-relative">
                            <input type="search" id="h-search" name="search" class="form-control header-form-control" placeholder="{{ get_phrase('Search') }}">

                        </div>
                    </form>
                    <!-- Menu Button -->
                    <button class="wch-menu-button d-block d-lg-none" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasMenu" aria-controls="offcanvasMenu">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewbox="0 0 24 24" fill="none">
                            <path d="M21 5.25H3C2.59 5.25 2.25 4.91 2.25 4.5C2.25 4.09 2.59 3.75 3 3.75H21C21.41 3.75 21.75 4.09 21.75 4.5C21.75 4.91 21.41 5.25 21 5.25Z" fill="white"></path>
                            <path d="M21 10.25H3C2.59 10.25 2.25 9.91 2.25 9.5C2.25 9.09 2.59 8.75 3 8.75H21C21.41 8.75 21.75 9.09 21.75 9.5C21.75 9.91 21.41 10.25 21 10.25Z" fill="white"></path>
                            <path d="M21 15.25H3C2.59 15.25 2.25 14.91 2.25 14.5C2.25 14.09 2.59 13.75 3 13.75H21C21.41 13.75 21.75 14.09 21.75 14.5C21.75 14.91 21.41 15.25 21 15.25Z" fill="white"></path>
                            <path d="M21 20.25H3C2.59 20.25 2.25 19.91 2.25 19.5C2.25 19.09 2.59 18.75 3 18.75H21C21.41 18.75 21.75 19.09 21.75 19.5C21.75 19.91 21.41 20.25 21 20.25Z" fill="white"></path>
                        </svg>
                    </button>
                </div>
            </div>
            <div class="col-xl-6 col-auto">
                <nav class="ca-header-navbar d-none d-lg-block">
                    <ul class="ca-navbar-nav">
                        <li class="ca-nav-item"><a class="ca-nav-link" href="{{ route('home') }}">{{ get_phrase('Home') }}</a></li>
                        <li class="ca-nav-item"><a class="ca-nav-link" href="{{ route('blog') }}">{{ get_phrase('Blog') }}</a></li>
                        <li class="ca-nav-item"><a class="ca-nav-link" href="{{ route('contact_us') }}">{{ get_phrase('Contact us') }}</a></li>
                        <!-- Mega Menu Button -->
                        <li class="ca-nav-item ca-mega-menu-btn">
                            <a href="javascript:void(0)" class="ca-nav-link ca-mega-menu-link">
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" width="10" height="6" viewbox="0 0 10 6" fill="none">
                                    <path d="M9 1L5 5L1 1" stroke="#FFFFFF99" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round"></path>
                                </svg>
                            </a>
                            <!-- Mega Menu -->
            ...
            <div class="col-xl-3 col-auto">
                <div class="header-access-items">
                    ...
                    <a href="javascript:;" class="header-access-item" data-bs-toggle="tooltip" data-bs-title="Cart">
                        <span class="access-item-inner" onclick="load_view('{{ route('view', ['path' => 'frontend.cart.offcanvas_cart_body']) }}', '#offcanvasCart')" data-bs-toggle="offcanvas" href="#offcanvasCart" role="button" aria-controls="offcanvasCart">
                            <div class="access-item-badge">
                                {{ \App\Models\Cart_item::where('user_id', auth()->id())->count() }}</div>
                            <svg xmlns="http://www.w3.org/2000/svg" width="25" height="24" viewbox="0 0 25 24" fill="none">
                                <path d="M9.08838 22.8969C9.65172 22.8969 10.1084 22.4402 10.1084 21.8768C10.1084 21.3135 9.65172 20.8568 9.08838 20.8568C8.52504 20.8568 8.06836 21.3135 8.06836 21.8768C8.06836 22.4402 8.52504 22.8969 9.08838 22.8969Z" stroke="white" stroke-width="1.57522" stroke-linecap="round" stroke-linejoin="round"></path>
                                <path d="M20.3091 22.8969C20.8724 22.8969 21.3291 22.4402 21.3291 21.8768C21.3291 21.3135 20.8724 20.8568 20.3091 20.8568C19.7457 20.8568 19.2891 21.3135 19.2891 21.8768C19.2891 22.4402 19.7457 22.8969 20.3091 22.8969Z" stroke="white" stroke-width="1.57522" stroke-linecap="round" stroke-linejoin="round"></path>
                                <path d="M0.927734 1.4765H5.00782L7.74147 15.1346C7.83475 15.6042 8.09022 16.026 8.46318 16.3263C8.83614 16.6265 9.30281 16.786 9.78151 16.7768H19.6961C20.1748 16.786 20.6415 16.6265 21.0144 16.3263C21.3874 16.026 21.6429 15.6042 21.7361 15.1346L23.3682 6.5766H6.02784" stroke="white" stroke-width="1.57522" stroke-linecap="round" stroke-linejoin="round"></path>
                            </svg>
                        </span>
                    </a>
                    <!-- Login Dropdown -->
                ...
                <div class="position-relative">
                    ...
                    <button type="submit" class="btn search-submit-btn">
                        <svg width="19" height="18" viewbox="0 0 19 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M13.7544 13.3951L17.3099 16.9506" stroke="black" stroke-width="1.44431" stroke-linecap="round" stroke-linejoin="round"></path>
                            <path d="M1.31006 8.0618C1.31006 11.9892 4.49377 15.1729 8.42108 15.1729C10.3882 15.1729 12.1687 14.3742 13.456 13.0834C14.7389 11.7971 15.5321 10.0221 15.5321 8.0618C15.5321 4.13444 12.3484 0.950684 8.42108 0.950684C4.49377 0.950684 1.31006 4.13444 1.31006 8.0618Z" stroke="black" stroke-width="1.44431" stroke-linecap="round" stroke-linejoin="round"></path>
                        </svg>
                    </button>
                </div>
            </form>
                ...
                <ul class="d-flex flex-column gap-30px mobile-menu-ul">
                    ...
                    <li>
                        <a href="{{ route('events') }}" class="d-flex gap-2 mobile-menuitem-a">
                            <svg width="22" height="22" viewbox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M14.4833 2.02579C14.1075 1.64995 13.4567 1.90662 13.4567 2.42912V5.62829C13.4567 6.96662 14.5933 8.07579 15.9775 8.07579C16.8483 8.08495 18.0583 8.08495 19.0942 8.08495C19.6167 8.08495 19.8917 7.47079 19.525 7.10412C18.205 5.77495 15.84 3.38245 14.4833 2.02579Z" fill="#fff"></path>
                                <path d="M18.7916 9.34099H16.1425C13.97 9.34099 12.2008 7.57183 12.2008 5.39933V2.75016C12.2008 2.246 11.7883 1.8335 11.2841 1.8335H7.39746C4.57413 1.8335 2.29163 3.66683 2.29163 6.93933V15.061C2.29163 18.3335 4.57413 20.1668 7.39746 20.1668H14.6025C17.4258 20.1668 19.7083 18.3335 19.7083 15.061V10.2577C19.7083 9.75349 19.2958 9.34099 18.7916 9.34099ZM10.5416 16.271H6.87496C6.49913 16.271 6.18746 15.9593 6.18746 15.5835C6.18746 15.2077 6.49913 14.896 6.87496 14.896H10.5416C10.9175 14.896 11.2291 15.2077 11.2291 15.5835C11.2291 15.9593 10.9175 16.271 10.5416 16.271ZM12.375 12.6043H6.87496C6.49913 12.6043 6.18746 12.2927 6.18746 11.9168C6.18746 11.541 6.49913 11.2293 6.87496 11.2293H12.375C12.7508 11.2293 13.0625 11.541 13.0625 11.9168C13.0625 12.2927 12.7508 12.6043 12.375 12.6043Z" fill="#fff"></path>
                            </svg>
                    ...
                    <li>
                        <a href="{{ route('blog') }}" class="d-flex gap-2 mobile-menuitem-a">
                            <svg width="22" height="22" viewbox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M12.8333 12.146H9.16663C8.79079 12.146 8.47913 12.4577 8.47913 12.8335C8.47913 13.2093 8.79079 13.521 9.16663 13.521H12.8333C13.2091 13.521 13.5208 13.2093 13.5208 12.8335C13.5208 12.4577 13.2091 12.146 12.8333 12.146Z" fill="#fff"></path>
                                <path d="M9.16663 9.854H11C11.3758 9.854 11.6875 9.54234 11.6875 9.1665C11.6875 8.79067 11.3758 8.479 11 8.479H9.16663C8.79079 8.479 8.47913 8.79067 8.47913 9.1665C8.47913 9.54234 8.79079 9.854 9.16663 9.854Z" fill="#fff"></path>
                                <path d="M14.8409 1.8335H7.16836C3.83169 1.8335 1.84253 3.82266 1.84253 7.15933V14.8318C1.84253 18.1685 3.83169 20.1577 7.16836 20.1577H14.8409C18.1775 20.1577 20.1667 18.1685 20.1667 14.8318V7.15933C20.1667 3.82266 18.1775 1.8335 14.8409 1.8335ZM16.5 13.7502C16.5 15.5835 15.5834 16.5002 13.75 16.5002H8.25002C6.41669 16.5002 5.50002 15.5835 5.50002 13.7502V8.25016C5.50002 6.41683 6.41669 5.50016 8.25002 5.50016H11.9167C13.75 5.50016 14.6667 6.41683 14.6667 8.25016V9.16683C14.6667 9.671 15.0792 10.0835 15.5834 10.0835C16.0875 10.0835 16.5 10.496 16.5 11.0002V13.7502Z" fill="#fff"></path>
                            </svg>
