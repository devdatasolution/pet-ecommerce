        ...
        <div class="ol-card-body">
            ...
            <div class="row">
                <div class="col-md-4">
                    ...
                    <p class="mb-12px">{{ get_phrase('Total') }} : {{ $order->currency_code }} {{ number_format($order->payable_amount, 2)}}</p>
                </div>
            ...
            <div class="ol-card p-4">
                <div class="ol-card-body">
                    <div class="d-flex align-items-center justify-content-between gap-2 mb-3">
                        ...
                        <a href="javascript:;" onclick="ajaxModal('{{ route('view', ['path' => 'admin.order.order_status_update', 'id' => $order->id]) }}', '{{ get_phrase('Update order status') }}')" data-bs-toggle="tooltip" title="{{ get_phrase('Update timeline') }}" class="btn up-sm-btn-dark">
                        ...
                        <div class="delivery-processing-card">
                            @foreach ($orderStatuses as $status)
                                <div class="delivery-processing-step">
                                    ...
                                    {{-- Delete icon --}}
                                    <a href="javascript:;" onclick="confirmModal('{{ route('admin.order.timeline_remove', ['id' => $status->id]) }}')" data-bs-toggle="tooltip" title="{{ get_phrase('Delete') }}" class="delete-icon" title="Delete">
                            ...
                            <div class="delivery-processing-step">
                                ...
                                @if($deliveredStatus)
                                    {{-- Delete icon --}}
                                    <a href="javascript:;" onclick="confirmModal('{{ route('admin.order.timeline_remove', ['id' => $deliveredStatus->id]) }}')" data-bs-toggle="tooltip" title="{{ get_phrase('Delete') }}" class="delete-icon" title="Delete">
                                        <i class="fi-rr-trash"></i>
                                    </a>
                                @endif
                            </div>
                ...
                <div class="ol-card-body">
                    <div class="mb-20px">
                        <div class="d-flex align-items-center justify-content-between gap-2 mb-3">
                            ...
                            <a href="{{ route('admin.order.invoice', ['id'=> $order->id, 'download'=>'pdf']) }}" class="btn up-sm-btn-dark">
