        ...
        <div class="row">
            <div class="col-12">
                <div class="featured-title-area">
                    <p class="title-badge mb-30px wow animate__fadeInUp builder-editable" builder-identity="sP1" data-wow-delay=".1s"><?php echo e(get_phrase('Featured Products')); ?></p>
                    <div class="d-flex justify-content-between flex-wrap gap-3">
                        <div class="featured-title-left">
                            <h2 class="section-title text-capitalize wow animate__fadeInUp builder-editable" builder-identity="sP2" data-wow-delay=".2s"><?php echo e(get_phrase('our best-selling shoes blend timeless style!')); ?></h2>
                        </div>
                        <div class="featured-title-right">
                            <p class="section-subtitle text-capitalize mb-30px wow animate__fadeInUp builder-editable" builder-identity="sP3" data-wow-delay=".3s"><?php echo e(get_phrase('Step into what everyone’s loving our best-selling shoes blend timeless style, next-level comfort & quality that lasts.')); ?></p>
                            <a href="<?php echo e(route('all_products')); ?>" class="btn sh1b2-btn-dark wow animate__fadeInUp builder-editable" builder-identity="sP4" data-wow-delay=".4s"><?php echo e(get_phrase('See More')); ?></a>
                        </div>
                    </div>
                </div>
            </div>
...
<!-- End Featured Product --><?php /**PATH C:\laragon\www\elevate\resources\views/components/home_made_by_builder/shoe/feature.blade.php ENDPATH**/ ?>