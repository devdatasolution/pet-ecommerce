...
<link rel="stylesheet" href="<?php echo e(asset('assets/frontend/shoe/css/header.css')); ?>">
<link rel="stylesheet" href="<?php echo e(asset('assets/frontend/shoe/css/footer.css')); ?>">
<link rel="stylesheet" href="<?php echo e(asset('assets/frontend/shoe/css/style.css')); ?>">
<link rel="stylesheet" href="<?php echo e(asset('assets/frontend/shoe/css/custom.css')); ?>">
<link rel="stylesheet" href="<?php echo e(asset('assets/frontend/shoe/css/responsive.css')); ?>">
        ...
        <div class="row">
            <div class="col-12">
                <div class="d-flex align-items-center justify-content-between gap-2">
                    <a href="<?php echo e(route('home')); ?>" class="sh1-header-logo">
                        <img src="<?php echo e(get_image(get_frontend_settings('dark_logo'))); ?>" alt="Logo" class="logo">
                    </a>
                    <nav class="sh1-header-navbar d-none d-lg-block">
                        <ul class="sh1-navbar-nav">
                            <li class="sh1-nav-item"><a class="sh1-nav-link"
                                    href="<?php echo e(route('home')); ?>"><?php echo e(get_phrase('Home')); ?></a></li>
                            <!-- Mega Menu Button -->
                            <li class="sh1-nav-item sh1-mega-menu-btn">
                                <a href="javascript:void(0)" class="sh1-nav-link sh1-mega-menu-link">
                                    <span><?php echo e(get_phrase('Categories')); ?></span>
                                            ...
                                            <div class="col-12">
                                                <div class="sh1-mega-menu-inner">
                                                                        ...
                                                                        <?php $__currentLoopData = $subCategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subCategory): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                            ...
                                                                            <?php if($subCategories->count() > 0 && $subSubCategories->count() > 0): ?>
                                                                                <li class="mega-nav-item">
                                                                                    <a href="javascript:void(0)"
                                                                                        class="mega-nav-link mega-nav-link-have-sub sh1-mega-nav-link"><?php echo e($subCategory->title); ?></a>
                                                                                    <ul class="mega-nav-dropdown">
                                                                                        <?php $__currentLoopData = $subSubCategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subSubCategory): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                                            <li><a href="<?php echo e(route('products', get_category_params($subSubCategory))); ?>"
                                                                                                    class="mage-nav-sublink sh1-mega-nav-link"><?php echo e($subSubCategory->title); ?></a>
                                                                                            </li>
                                                                            ...
                                                                            <?php else: ?>
                                                                                <li class="mega-nav-item"><a
                                                                                        href="<?php echo e(route('products', get_category_params($subCategory))); ?>"
                                                                                        class="sh1-mega-nav-link"><?php echo e($subCategory->title); ?></a>
                                                                                </li>
                                                                            <?php endif; ?>
                                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                                    <?php endif; ?>
                                                    ...
                                                    <div class="sh1-mega-ads-wrap">
                                                        <?php $__currentLoopData = $categories->take(2); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <a href="javascript:;" class="sh1-mega-single-ads">
                                                                <img class="banner"
                                                                    src="<?php echo e(get_image($category->thumbnail)); ?>"
                                                                    alt="banner">
                                                                <h3 class="sh1-mega-ads-title text-capitalize">
                                                                    <?php echo e($category->title); ?></h3>
                                                            </a>
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                    </div>
                                                </div>
                            ...
                            <li class="sh1-nav-item"><a class="sh1-nav-link"
                                    href="<?php echo e(route('events')); ?>"><?php echo e(get_phrase('Events')); ?></a></li>
                            <li class="sh1-nav-item"><a class="sh1-nav-link"
                                    href="<?php echo e(route('blog')); ?>"><?php echo e(get_phrase('Blog')); ?></a></li>
                            <li class="sh1-nav-item"><a class="sh1-nav-link"
                                    href="<?php echo e(route('store')); ?>"><?php echo e(get_phrase('Store')); ?></a></li>
                        </ul>
                    </nav>
                    <div class="sh1-header-right d-flex align-items-center gap-2">
                        <div class="sh1-header-right-items d-flex align-items-center gap-6px">
                            ...
                            <a href="javascript:;" class="sh1-header-right-item">
                                <span
                                    ...
                                    <span class="dark-circle-badge"
                                        id="header-cart-item-counter"><?php echo e(\App\Models\Cart_item::where('user_id', auth()->id())->count()); ?></span>
                                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                                        xmlns="http://www.w3.org/2000/svg"
                                        onclick="load_view('<?php echo e(route('view', ['path' => 'frontend.cart.offcanvas_cart_body'])); ?>', '#offcanvasCart')"
                            ...
                            <div class="d-none d-lg-block">
                                <a href="javascript:;" class="sh1-header-right-item">
                                    <span
                                        ...
                                        <span class="dark-circle-badge"
                                            id="header-cart-item-counter"><?php echo e(\App\Models\Wishlist_item::where('user_id', auth()->id())->count()); ?></span>
                                ...
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-end sh1-user-dropdown-menu">
                                        <div class="d-flex align-items-center gap-1 sh1-user-dropdown-header">
                                            ...
                                            <h4 class="sh1-user-dropdown-name"><?php echo e(auth()->user()->name); ?></h4>
                                        </div>
                                        <ul>
                                            <?php if(auth()->user()->user_type == 'admin'): ?>
                                                <li>
                                                    <a class="dropdown-item"
                                                        href="<?php echo e(route('admin.dashboard')); ?>"><?php echo e(get_phrase('Admin Dashboard')); ?></a>
                                                </li>
                                            <?php else: ?>
                                                <li>
                                                    <a href="<?php echo e(route('customer.wishlist_items')); ?>"
                                                        class="dropdown-item <?php if($current_route == 'customer.wishlist_items'): ?> active <?php endif; ?>"><?php echo e(get_phrase('Wishlist')); ?></a>
                                                </li>
                                                <li>
                                                    <a href="<?php echo e(route('customer.cart_items')); ?>"
                                                        class="dropdown-item <?php if($current_route == 'customer.cart_items'): ?> active <?php endif; ?>"><?php echo e(get_phrase('Cart')); ?></a>
                                                </li>
                                                <li>
                                                    <a href="<?php echo e(route('customer.orders')); ?>"
                                                        class="dropdown-item <?php if($current_route == 'customer.orders'): ?> active <?php endif; ?>"><?php echo e(get_phrase('Orders')); ?></a>
                                                </li>
                                                <li>
                                                    <a href="<?php echo e(route('customer.shipping_addresses')); ?>"
                                                        class="dropdown-item <?php if($current_route == 'customer.shipping_addresses'): ?> active <?php endif; ?>"><?php echo e(get_phrase('Shipping addresses')); ?></a>
                                                </li>
                                                <li>
                                                    <a href="<?php echo e(route('customer.payments')); ?>"
                                                        class="dropdown-item <?php if($current_route == 'customer.payments'): ?> active <?php endif; ?>"><?php echo e(get_phrase('Payments')); ?></a>
                                                </li>
                                                <li>
                                                    <a href="<?php echo e(route('customer.profile')); ?>"
                                                        class="dropdown-item <?php if($current_route == 'customer.profile'): ?> active <?php endif; ?>"><?php echo e(get_phrase('My Profile')); ?></a>
                                                </li>
                                                <li>
                                                    <a href="<?php echo e(route('customer.account')); ?>"
                                                        class="dropdown-item <?php if($current_route == 'customer.account'): ?> active <?php endif; ?>"><?php echo e(get_phrase('Account')); ?></a>
                                                </li>
                                            <?php endif; ?>
                                            <li>
                                                <a class="dropdown-item"
                                                    href="<?php echo e(route('logout')); ?>"><?php echo e(get_phrase('Logout')); ?></a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                            <?php else: ?>
                                <a href="javascript:;"
                                    onclick="formModal('<?php echo e(route('view', ['path' => 'auth.login_modal'])); ?>', '<?php echo e(get_phrase('Log In')); ?>')"
                    ...
                    <li class="mobile-menuitem-have-sub active-mobile-submenu">
                        ...
                        <ul class="mobile-dropdown-menu">
                            <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <li class="mobile-dropitem-have-sub">
                                        ...
                                        <ul class="mobile-subdrop-menu">
                                            <?php $__currentLoopData = $subCategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subCategory): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                ...
                                                <?php if($subSubCategories->count() > 0): ?>
                                                    <li class="mobile-dropitem-have-sub">
                                                        ...
                                                        <ul class="mobile-subdrop-menu">
                                                            <?php $__currentLoopData = $subSubCategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subSubCategory): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <li>
                                                                    <a href="<?php echo e(route('products', get_category_params($subSubCategory))); ?>"
                                                ...
                                                <?php else: ?>
                                                    <li>
                                                        <a href="<?php echo e(route('products', get_category_params($subCategory))); ?>"
                                                            class="mobile-menuitem-a">
                                                            <?php echo e($subCategory->title); ?>
                                ...
                                <?php else: ?>
                                    <li>
                                        <a href="<?php echo e(route('products', get_category_params($category))); ?>"
                                            class="mobile-menuitem-a">
                    ...
                    <form action="<?php echo e(route('filter.search')); ?>" method="post">
                        ...
                        <div class="header-search-form">
                            <input type="search" name="search" class="form-control header-search-input"
                                placeholder="<?php echo e(get_phrase('Search for products...')); ?>">
                            <button class="btn header-search-btn" type="submit">
                                <img src="<?php echo e(asset('assets/frontend/shoe/images/svg-icons/search-white-16.svg')); ?>"
                                    alt="icon">
                            </button>
                        </div>
                    </form>
...
<!-- End Search Modal  -->
<?php /**PATH C:\laragon\www\elevate\resources\views/components/home_made_by_builder/shoe/header.blade.php ENDPATH**/ ?>