...
<section>
    <div class="container">
        <div class="row">
            <div class="col-12">
                <div class="mb-30px">
                    <h1 class="mv-title-40px text-center wow animate__fadeInUp  builder-editable" builder-identity="19" data-wow-delay=".2s"><?php echo e(get_phrase('New Arrivals')); ?></h1>
                </div>
            </div>
        </div>
            ...
            <div class="col-12">
                <div class="text-center wow animate__fadeInUp" data-wow-delay=".2s">
                    <a href="<?php echo e(route('all_products')); ?>" class="btn fsh-btn-dark pe-4 icon-right">
                        <span class="builder-editable" builder-identity="20"><?php echo e(get_phrase('Show More')); ?></span>
...
<!-- New Arrivals Area End --><?php /**PATH C:\laragon\www\elevate\resources\views/components/home_made_by_builder/fashion/new_arrival.blade.php ENDPATH**/ ?>