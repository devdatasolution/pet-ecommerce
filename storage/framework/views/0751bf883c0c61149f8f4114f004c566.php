<?php $__env->startPush('title', 'Products'); ?>
...
<?php if(isset($font_family['font_family']) && isset($filter['background-color']) ): ?>
    <style>
        /* background color */
        body ,
        ...
        .al-title-18px,
        .category-nav-link {
            font-family: <?php echo e($font_family['font_family']); ?>;
        }
        .form-checkbox-input:checked,
        #slider-range .ui-widget-header ,
        #slider-range .ui-slider-handle {
                background-color: <?php echo e($filter['background-color']); ?> ;
                
            }
            .form-checkbox-input:checked {
                border-color:<?php echo e($filter['background-color']); ?> ;
            }
            .form-checkbox-label,
            .al-subtitle-14px,
            .al-title-18px,
            .category-nav-link{
                 color:<?php echo e($filter['color']); ?> ;
            }
    </style>
<?php endif; ?>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="breadcrumb-area mt-30px mb-3 wow animate__fadeInUp" data-wow-delay=".1s">
                        <h1 class="al-title-42px text-center"><?php echo e(get_phrase('All products')); ?></h1>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb fsh-breadcrumb mt-3">
                                <?php $route_params = []; ?>
                                <?php $__currentLoopData = $selected_categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $parameter_name => $selected_category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php $route_params[$parameter_name] = $selected_category->slug; ?>
                                    <?php if($loop->last): ?>
                                        <li class="breadcrumb-item active" aria-current="page"><?php echo e($selected_category->title); ?></li>
                                    <?php else: ?>
                                        <li class="breadcrumb-item">
                                            <a href="<?php echo e(route('products', $route_params)); ?>"><?php echo e($selected_category->title); ?></a>
                                        </li>
                                    <?php endif; ?>
        ...
        <div class="container">
            <div class="row gy-4 mb-100px">
                ...
                <div class="col-xl-3 col-lg-4 wow animate__fadeInUp" data-wow-delay=".2s">
                    <?php echo $__env->make('frontend.products.filter_sidebar', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                </div>
                    ...
                    <div class="filter-tab-header mb-30px wow animate__fadeInUp" data-wow-delay=".3s">
                         <div class="recap d-flex align-items-center gap-2">
                            <button class="btn filter-nav-link d-lg-none " type="button" data-bs-toggle="offcanvas" data-bs-target="#filterOffcanvas" aria-controls="filterOffcanvas" >
                                <svg data-bs-toggle="tooltip" data-bs-title="<?php echo e(get_phrase('Filter')); ?>" data-bs-placement="top" width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <h4 class="al-title-14px fw-semibold">
                                ...
                                <?php echo e($products->total().' '.get_phrase('Products found')); ?>

                                <?php else: ?>
                                <?php echo e(get_phrase('No products found')); ?>
                        ...
                        <div class="d-flex align-items-center gap-12px">
                            <p class="al-subtitle-14px lh-1 d-none d-md-block"><?php echo e(get_phrase('Sort By')); ?></p>
                            <form action="">
                                <select name="sort_by" class="fsh-md-select min-w-155px right fsh-nice-select" onchange="document.getElementById('sort_by').value = this.value; submitFilterForm();">
                                    <option value="low-to-high" <?php if(request()->sort_by == 'low-to-high'): ?> selected <?php endif; ?>><?php echo e(get_phrase('Price')); ?> : <?php echo e(get_phrase('Low to High')); ?></option>
                                    <option value="high-to-low" <?php if(request()->sort_by == 'high-to-low'): ?> selected <?php endif; ?>><?php echo e(get_phrase('Price')); ?> : <?php echo e(get_phrase('High to Low')); ?></option>
                                    <option value="best-rated" <?php if(request()->sort_by == 'best-rated'): ?> selected <?php endif; ?>><?php echo e(get_phrase('Rating')); ?> : <?php echo e(get_phrase('Best rated')); ?></option>
                                    <option value="release-date" <?php if(request()->sort_by == 'release-date'): ?> selected <?php endif; ?>><?php echo e(get_phrase('Release Date')); ?></option>
                                </select>
                            </form>
                        </div>
                        ...
                        <div class="tab-content wow animate__fadeInUp" data-wow-delay=".4s" id="filter-pills-tabContent">
                                ...
                                <div class="row gy-4  mb-30px">
                                    ...
                                    <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="col-xl-3 col-lg-4 col-md-4 col-sm-6">
                                            <?php echo $__env->make("components.{$active_theme->identifier}.products.product_grid", ['layout' => 'sm'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                                        </div>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <div class="row gy-4 mb-30px">
                                    ...
                                    <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="col-xl-4 col-lg-6 col-md-6 col-sm-6">
                                            <?php echo $__env->make("components.{$active_theme->identifier}.products.product_grid", ['layout' => 'md'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                                        </div>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <div class="tab-pane fade " id="pills-filter1" role="tabpanel" aria-labelledby="pills-filter1-tab" tabindex="0">
                                <div class="row gy-4 mb-30px">
                                    <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="col-md-6">
                                            <?php echo $__env->make("components.{$active_theme->identifier}.products.product_grid", ['layout' => 'lg'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                                        </div>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <div class="tab-pane fade" id="pills-filter4" role="tabpanel" aria-labelledby="pills-filter4-tab" tabindex="0">
                                <div class="row gy-4 mb-30px">
                                        <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php echo $__env->make("components.{$active_theme->identifier}.products.product_list", array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <div class="col-12 mt-5">
                                         <div class="noData text-center pt-5">
                                               <svg width="228" height="180" viewBox="0 0 228 180" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                <h4 class="mb-3 mt-3"><?php echo e(get_phrase('No Result Found')); ?></h4>
                                                <p class="mb-2"><?php echo e(get_phrase('No Data were found matching your selection.')); ?></p>
                                                <a href="javascript:void(0)" onclick="goBackToProducts()" class="btn mt-1 fsh-btn-dark"><?php echo e(get_phrase('Go Back')); ?></a>
                                          </div>
                                        </div>
                            <?php endif; ?>
...
<?php echo $__env->make('layouts.frontend', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\elevate\resources\views/frontend/products/index.blade.php ENDPATH**/ ?>