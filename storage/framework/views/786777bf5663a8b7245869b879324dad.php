                    ...
                    <div class="col-lg-4">
                        <div class="footer-top-area mb-30px pb-30px d-flex align-items-end justify-content-between gap-4 flex-wrap">
                            <div class="">
                                ...
                                <p class="al-subtitle2-16px max-w-337px builder-editable" builder-identity="1"><?php echo e(get_settings('summary')); ?></p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-8">
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="footer-copyright-area d-flex align-items-center justify-content-center justify-content-sm-between column-gap-4 row-gap-4 flex-wrap flex-column flex-sm-row">
                    <p class="al-subtitle2-16px lh-1  text-center text-sm-left builder-editable" builder-identity="6"> <?php echo e(get_phrase('Copyright ©')); ?> <?php echo e(date('Y')); ?> | <?php echo e(get_phrase('All rights reserved by creativeitem.com')); ?></p>
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" width="19" height="18" viewBox="0 0 19 18" fill="none">
                                    ...
                                    <defs>
                                      <clipPath id="clip0_1208_14439">
                                        <rect width="18.8134" height="17.9999" fill="#9E9EA9"/>
                                      </clipPath>
                                    </defs>
                                </svg>
                            </a>
...
<!-- Scroll Top -->
<?php /**PATH C:\laragon\www\elevate\resources\views/components/home_made_by_developer/fashion/footer.blade.php ENDPATH**/ ?>