...
<section class="best-deal-section">
    <div class="container">
        <div class="row">
            <div class="col-12">
                <h1 class="ml-title-48px text-center mb-2 wow animate__fadeInUp builder-editable" builder-identity="1" data-wow-delay=".2s"><?php echo e(get_phrase('Best Deal This Week')); ?></h1>
            </div>
        </div>
    </div>
    <div class="egBest egBest1">
        <img class="builder-editable" builder-identity="B1" src="<?php echo e(asset('assets/frontend/grocery/images/images/best-deal-before.webp')); ?>" alt="">
    </div>
    <div class="egBest2 egBest">
        <img class="builder-editable" builder-identity="B2" src="<?php echo e(asset('assets/frontend/grocery/images/images/best-deal-after.webp')); ?>" alt="">
    </div>
</section>
                ...
                <div class="product-lg-card">
                    <div class="product-lg-banner" >
                            <?php if($product->is_discounted()->exists()): ?>
                                ...
                                ?>
                                <p class="product-discount-badge1 capitalize"><?php echo e($discount_text); ?></p>
                             <?php endif; ?>
                        <?php
                        ...
                        <div class="view-bookmark-md-wrap">
                            <a href="javascript:void(0)" class="dark-light-iconbtn" onclick="load_view('<?php echo e(route('view', ['path' => 'frontend.products.quick_view', 'product_id' => $product->id])); ?>', '#quickViewModal .modal-body')" data-bs-toggle="modal" data-bs-target="#quickViewModal" >
                                <span class="d-flex align-items-center justify-content-center w-100 h-100 rounded-circle" data-bs-toggle="tooltip" data-bs-title="<?php echo e(get_phrase('Quick View')); ?>" >
                    ...
                    <div class="product-lg-details">
                        <a href="<?php echo e(route('product', $product->slug)); ?>" class="al-title-20px text-link mb-12px"><?php echo e($product->title); ?></a>
                        <div class="d-flex align-items-center gap-1 flex-wrap mb-6px">
                            <div class="d-flex align-items-center gap-3px">
                                 <?php
                                    ...
                                    <img src="<?php echo e(asset('assets/frontend/grocery/images/image-icons/star-yellow-16.svg')); ?>" alt="">
                                    <?php endfor; ?>
                            ...
                            <p class="al-title-16px"><?php echo e($product->average_rating ?? 0); ?> <span class="ec-text-gray">(<?php echo e($product->reviews->count()); ?>)</span></p>
                        </div>
                        <div class="d-flex align-items-end gap-3 justify-content-between flex-wrap">
                                  ...
                                  <?php if($product->is_discounted()->exists()): ?>
                                        <?php if($product->is_discounted->discount_type == 'flat'): ?>
                                            <div class="d-flex gap-2">
                                                <h6 class="al-title-18px">  <?php echo e(currency($product->price - $product->is_discounted->discount_value)); ?> </h6>
                                        ...
                                        <?php else: ?>
                                            ...
                                            ?>
                                            <div class="d-flex gap-2">
                                                <h6 class="al-title-18px"> <?php echo e(currency($product->price - $discount_amount)); ?>  </h6>
                                                    <h6 class="al-title-16px fw-medium ec-text-gray"><del><?php echo e(currency($product->price)); ?></del></h6>
                                            </div>
                            ...
                            <a href="<?php echo e(route('product', $product->slug)); ?>" class="btn ec-sm2-btn-dark text-capitalize py-12px px-4">
                        ...
                        <div class="mt-18px">
                            <div class="d-flex align-items-center justify-content-between gap-2 mb-12px">
                                <h6 class="al-title2-14px"><?php echo e(get_phrase('Total  Stock:')); ?> <?php echo e($product->total_stock); ?></h6>
                                <h6 class="al-title2-14px"><?php echo e(get_phrase('Sold:')); ?> <?php echo e(getSoldQuantity($product->id)); ?></h6>
                            </div>
                           <div class="progress ec-progress" role="progressbar" 
                                aria-valuenow="<?php echo e(getSoldProgress($product->id)); ?>" 
                                aria-valuemin="0" aria-valuemax="100">
                                <div class="progress-bar" data-progress="<?php echo e(getSoldProgress($product->id)); ?>"></div>
                            </div>
...
<!-- Best Deal Area End --><?php /**PATH C:\laragon\www\elevate\resources\views/components/home_made_by_developer/grocery/best_deal.blade.php ENDPATH**/ ?>