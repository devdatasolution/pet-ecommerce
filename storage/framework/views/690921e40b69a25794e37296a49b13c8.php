<?php $__env->startPush('title', get_phrase('Product List')); ?>
        ...
        <div class="ol-card-body p-3 mb-5">
            <div class="row mb-4">
                <div class="col-lg-7 mb-2 d-flex flex-wrap align-items-center gap-3">
                     <a href="<?php echo e(route('admin.product.add')); ?>" class="btn ol-btn-outline-secondary d-flex align-items-center cg-10px">
                        <span class="fi-rr-plus"></span>
                        <span><?php echo e(get_phrase('Add new Product')); ?></span>
                    </a>
                    <div class="custom-dropdown ms-2">
                        ...
                        <ul class="dropdown-list">
                            <li>
                                <a class="dropdown-item export-btn" href="javascript:;" onclick="downloadPDF('.print-table', 'Product-list')"><i class="fi-rr-file-pdf"></i> <?php echo e(get_phrase('PDF')); ?></a>
                            </li>
                            <li>
                    ...
                    <div class="custom-dropdown dropdown-filter <?php if(!isset($_GET) || (isset($_GET) && count($_GET) == 0)): ?>  <?php endif; ?>">
                        ...
                        <ul class="dropdown-list w-250px">
                            <li>
                                <form id="filter-dropdown" action="<?php echo e(route('admin.products')); ?>" method="get">
                                    ...
                                    <div class="filter-option d-flex flex-column gap-3">
                                        ...
                                        <div>
                                            ...
                                            <select class="form-control ol-form-control ol-select2" data-toggle="select2" name="category" data-placeholder="Type to search...">
                                                ...
                                                <?php $__currentLoopData = App\Models\Category::orderBy('title', 'asc')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <div>
                                            <label for="eDataList" class="form-label ol-form-label"><?php echo e(get_phrase('Store')); ?></label>
                                            <select class="form-control ol-form-control ol-select2" data-toggle="select2" name="store" data-placeholder="Type to search...">
                                                <option value="all"><?php echo e(get_phrase('All')); ?></option>

                                                <?php $__currentLoopData = App\Models\Store::orderBy('name', 'asc')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $store): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($store->slug); ?>" <?php if(request('store') == $store->slug): ?> selected <?php endif; ?>>
                                        ...
                                        <div>
                                            <label for="eDataList" class="form-label ol-form-label"><?php echo e(get_phrase('Brand')); ?></label>
                                            <select class="form-control ol-form-control ol-select2" data-toggle="select2" name="brand" data-placeholder="Type to search...">
                                                ...
                                                <?php $__currentLoopData = App\Models\Brand::orderBy('name', 'asc')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $brand): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($brand->name); ?>" <?php if(request('brand') == $brand->name): ?> selected <?php endif; ?>>
                    ...
                    <?php if(isset($_GET) && count($_GET) > 0): ?>
                        <a href="<?php echo e(route('admin.products')); ?>" class="me-2" data-bs-toggle="tooltip" title="<?php echo e(get_phrase('Clear')); ?>"><i class="fi-rr-cross-circle"></i></a>
                    <?php endif; ?>
                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-7 col-9">
                                <div class="search-input flex-grow-1">
                                    <input type="text" name="search" value="<?php echo e(request('search')); ?>" placeholder="<?php echo e(get_phrase('Search by product name')); ?>" class="ol-form-control form-control" />
                                </div>
                            </div>
            ...
            <?php if($counted = $products->count() > 0): ?>
                ...
                <div class="table-responsive overflow-auto">
                    <table class="table print-table">
                        <thead>
                            <tr>
                                <th scope="col">#</th>
                                <th scope="col"><?php echo e(get_phrase('Product')); ?></th>
                                <th scope="col"><?php echo e(get_phrase('Barcode')); ?></th>
                                ...
                                <tr class="hidden-btn">
                                    ...
                                    <td width="320px">
                                        <div class="d-flex align-items-center min-w-200px" bis_skin_checked="1">
                                            <img class="image-40 radius-5px" width="40" height="40" src="<?php echo e(get_image($firstImage)); ?>">
                                            <div class="ms-2 mt-1" bis_skin_checked="1">
                                                <h4 class="title fs-14px"><?php echo e($product->title); ?></h4>
                                                <p class="sub-title2 text-12px ellipsis-line-2"><?php echo e($product->summary); ?></p>
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="d-flex align-items-center gap-2">
                                            ...
                                            ?>
                                            <div>
                                                <img  src="data:image/png;base64,<?php echo e($barcode_image); ?>" alt="Barcode" height="25px" width="135px">
                                                <p><?php echo e(get_phrase('SN')); ?>: <?php echo e($product?->code); ?></p>
                                            </div>
                                            <div class="d-flex ">
                                                 <a href="javascript:void(0);" 
                                                    class="btn action-label download-btn"
                                                    onclick="downloadBarcode('<?php echo e($barcode_image); ?>', '<?php echo e($product->code); ?>')" data-bs-toggle="tooltip" title="<?php echo e(get_phrase('Download')); ?>">
                                                ...
                                                <a   onclick="downloadBarcodePDF('<?php echo e($barcode_image); ?>', '<?php echo e($product->code); ?>')" href="javascript:void(0)" class="btn action-label download-btn" data-bs-toggle="tooltip" title="<?php echo e(get_phrase('PDF Download')); ?>">
                                                    <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                        <path
                                    ...
                                    <td>
                                     ...
                                     <td>
                                        <?php if($product->is_discounted()->exists()): ?>
                                            <?php if($product->is_discounted->discount_type == 'flat'): ?>
                                                <del><?php echo e(currency($product->price)); ?></del>
                                                <?php echo e(currency($product->price - $product->is_discounted->discount_value)); ?>
                                            ...
                                            <?php else: ?>
                                                ...
                                                ?>
                                                <del><?php echo e(currency($product->price)); ?></del>
                                                <?php echo e(currency($product->price - $discount_amount)); ?>
                                    ...
                                    <td>
                                        ...
                                        <?php else: ?>
                                            <span class="badge bg-secondary"><?php echo e(get_phrase('Inactive')); ?></span>
                                        <?php endif; ?>
                                    </td>
                                    <td>
                                        <div class="print-d-none d-flex flex-wrap align-items-center gap-2 row-gap-2">
                                            <a href="<?php echo e(route('admin.product.edit', ['id' => $product->id])); ?>" data-bs-toggle="tooltip" title="<?php echo e(get_phrase('Edit')); ?>" class="btn btn-primary-light btn-icon"><i class="fi-rr-pencil"></i></a>
                                            <a href="#" onclick="confirmModal('<?php echo e(route('admin.product.delete', ['id' => $product->id])); ?>')" data-bs-toggle="tooltip" title="<?php echo e(get_phrase('Delete')); ?>" class="btn btn-danger-light btn-icon"><i class="fi-rr-trash"></i></a>
                                        </div>
                                    </td>
                                </tr>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                 ...
                 <div class="admin-tInfo-pagi d-flex justify-content-md-between justify-content-center align-items-center gr-15 flex-wrap mb-2">
                    <p class="admin-tInfo">
                        <?php echo e(get_phrase('Showing') . ' ' . count($products) . ' ' . get_phrase('of') . ' ' . $products->total() . ' ' . get_phrase('data')); ?>
...
<script type="text/javascript" src="<?php echo e(asset('assets/global/jquery-3.7.1/jspdf.umd.min.js')); ?>"></script>
    <script>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\elevate\resources\views/admin/product/products.blade.php ENDPATH**/ ?>