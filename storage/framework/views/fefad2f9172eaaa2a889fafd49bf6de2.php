...
<head>
    ...
    <title><?php echo e(get_phrase('Edit Layout')); ?> | <?php echo e(config('app.name')); ?></title>
    ...
    <script src="<?php echo e(asset('assets/global/jquery-3.7.1/jquery-3.7.1.min.js')); ?>"></script>
     <!-- Jquery Ui Js -->
   <script src="<?php echo e(asset('assets/global/jquery-3.7.1/jquery-ui.min.js')); ?>"></script>
...
<body>
        ...
        <div class="container">
            <div class="row">
                <div class="col-4 py-3">
                    <div class="editor_title"><?php echo e(get_phrase('Page Builder')); ?></div>
                </div>
                <div class="col-4 py-2 text-center">
                    <a class="btn btn-dark  mx-1 save-button" href="<?php echo e(route('admin.page.preview', $id)); ?>" target="_blank">
                        <i class="fi-rr-eye"> </i><?php echo e(get_phrase('Preview')); ?>

                    </a>

                    <button class="btn btn-dark  mx-1 save-button" onclick="getDeveloperFileContent('<?php echo e($id); ?>')">
                        <i class="fi-rr-arrow-alt-square-down"> </i><?php echo e(get_phrase('Save')); ?>
                ...
                <div class="col-4 py-2">
                    <a class="btn btn-dark  float-end mx-1" href="<?php echo e(route('admin.themes')); ?>">
                        <i class="fi-rr-angle-left"> </i><?php echo e(get_phrase('Back')); ?></a>
                </div>
            </div>
        </div>
    ...
    <div id="main">
        <?php $__currentLoopData = json_decode($theme->html, true) ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $theme_file_name): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div builder-block-identifier="<?php echo e(time() . rand(1000, 9999) . $key); ?>" builder-block-file-name="<?php echo e($theme_file_name); ?>">
                <?php echo $__env->make('components.home_made_by_builder.'. $theme->identifier . '.'. $theme_file_name, array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            </div>
    ...
    <?php echo $__env->make('admin.page_builder.page_layout_edit_offcanvas', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    ...
    <script>
        ...
        function save_layout(builder_elements) {
            ...
            $.ajax({
                ...
                url: "<?php echo e(route('admin.page.layout.update', ['id' => $id])); ?>",
        ...
        function getDeveloperFileContent(id) {
            ...
            $.ajax({
                ...
                type: "POST",
                url: "<?php echo e(route('admin.page.all.builder.developer.file')); ?>?id=" + id,
...
<?php /**PATH C:\laragon\www\elevate\resources\views/admin/page_builder/page_layout_edit.blade.php ENDPATH**/ ?>