<div class="builderOffcanvas offcanvas offcanvas-end" data-bs-scroll="true" data-bs-backdrop="false" tabindex="-1" id="offcanvasScrolling" aria-labelledby="offcanvasScrollingLabel">
    <div class="offcanvas-header">
        <h5 class="offcanvas-title" id="offcanvasExampleLabel"><?php echo e(get_phrase('Manage content')); ?></h5>
...
<script type="text/javascript">
    ...
    function show_offcanvas(url, title = "<?php echo e(get_phrase('Manage content')); ?>") {
        ...
        if (!url) {
            url = "<?php echo e(route('view', ['path' => 'admin.page_builder.page_layout_edit_offcanvas_body', 'id' => $id])); ?>";
        }
    ...
    function add_block_html_content_by_select_from_offcanvas(file_name, theme_identifier, folder = "home_made_by_developer") {
        var identifier = Math.floor(Math.random() * 100000000);

        $.ajax({
            url: "<?php echo e(route('view', ['path' => 'components.'])); ?>" + folder+ '.' + theme_identifier + '.' + file_name,
    ...
    function text_and_image_make_editable() {
        $('#main .builder-editable:not(.initialized)').each(function(index, elem) {
            ...
            let url = "<?php echo e(route('view', ['path' => 'admin.page_builder.page_layout_edit_image_and_text'])); ?>?element_id=" + identifier + "&tag_name=" + tag_name;
...
<style>
    ...
    .hero-slide-content .hero-title.builder-editable {
        margin: auto;
        margin-bottom: 12px;
    }
...
<?php /**PATH C:\laragon\www\elevate\resources\views/admin/page_builder/page_layout_edit_offcanvas.blade.php ENDPATH**/ ?>