...
<section class="main-banner-section section-margin">
            ...
            <div class="col-12">
                <div class="main-banner-area">
                    <div class="mb-2 text-center wow animate__fadeInUp" data-wow-delay=".1s">
                        <a href="javascript:;" class="btn ec-sm2-btn-success builder-editable" builder-identity="h2"><?php echo e(get_phrase('The Freshness')); ?></a>
                    </div>
                    <h1 class="ml-title-60px max-w-837px mx-auto mb-30px wow animate__fadeInUp builder-editable" builder-identity="2" data-wow-delay=".2s"><?php echo e(get_phrase('Fresh Groceries')); ?> <span class="shape-title"><?php echo e(get_phrase('Delivered')); ?></span> <?php echo e(get_phrase('to Your Door')); ?></h1>
                    <div class="d-flex align-items-center gap-3 flex-wrap justify-content-center wow animate__fadeInUp" data-wow-delay=".3s">
                        <a href="<?php echo e(route('all_products')); ?>" class="btn ec-dark-icon-btn">
                            <span class="builder-editable" builder-identity="3"><?php echo e(get_phrase('Shop Now')); ?></span>
                            <span class="icon">
                        ...
                        <a href="<?php echo e(get_settings('system_video')); ?>" class="play-btn video-popup" data-maxwidth="900px" data-vbtype="video">
                            <span>
                            ...
                            <span class="builder-editable" builder-identity="4"><?php echo e(get_phrase('Order Process')); ?></span>
                        </a>
                    </div>
                        ...
                        <div class="col-lg-10">
                            <div class="d-flex align-items-start justify-content-between gap-3 flex-wrap main-banner-bottom">
                                <div class="fastest-delivery-badge wow animate__fadeInUp" data-wow-delay=".4s">
                                    ...
                                    <p class="text builder-editable" builder-identity="5"><?php echo e(get_phrase('Fastest Delivery')); ?></p>
                                </div>
                                <div class="happy-customer-badge wow animate__fadeInUp" data-wow-delay=".5s">
                                    <ul class="d-flex align-items-center">
                                        ...
                                        <li class="happy-customer-image">
                                            <img src="<?php echo e(get_image($review->user->photo)); ?>" alt="">
                                        </li>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </ul>
                                    <div>
                                        <h4 class="al-title-16px text-capitalize happy-customer-title builder-editable" builder-identity="6"><?php echo e(get_phrase('Our Happy Customer')); ?></h4>
                                        <div class="d-flex align-items-center gap-1">
                                            ...
                                            ?>
                                            <h6 class="al-title2-14px fw-medium"> <?php echo e(number_format($reviewCount, 1)); ?> <span class="ec-text-success">(<?php echo e($totalRatings); ?> <?php echo e(get_phrase('Review')); ?>)</span></h6>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <img class="egBanner builder-editable" builder-identity="h1" src="<?php echo e(asset('assets/frontend/grocery/images/images/banner-after.png')); ?>" alt="">
</section>
<!-- Banner Area End --><?php /**PATH C:\laragon\www\elevate\resources\views/components/home_made_by_developer/grocery/hero_banner.blade.php ENDPATH**/ ?>