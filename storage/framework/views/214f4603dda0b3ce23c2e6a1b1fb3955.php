    ...
    <div class="container mx-auto px-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <a href="#" class="group relative overflow-hidden rounded-lg">
                <img
                    src="<?php echo e(asset('assets/frontend/fashion/blog-feature/ba20.webp')); ?>"
            ...
            <a href="#" class="group relative overflow-hidden rounded-lg">
                <img
                    src="<?php echo e(asset('assets/frontend/fashion/blog-feature/ba21.webp')); ?>"
                    alt="I am so Foody"
                    class="w-full h-[220px] md:h-[300px] object-cover transition duration-700 group-hover:scale-110">
        ...
        <div class="row g-0">
            ...
            <div class="col-6 col-lg-3">
                <div class="service-box">
                    <img src="<?php echo e(asset('assets/frontend/fashion/blog-feature/1.avif')); ?>"
                        alt="Support">
            ...
            <div class="col-6 col-lg-3">
                <div class="service-box">
                    <img src="<?php echo e(asset('assets/frontend/fashion/blog-feature/2.png')); ?>"
                        alt="Shipping">
            ...
            <div class="col-6 col-lg-3">
                <div class="service-box">
                    <img src="<?php echo e(asset('assets/frontend/fashion/blog-feature/3.webp')); ?>"
                        alt="Return">
            ...
            <div class="col-6 col-lg-3">
                <div class="service-box">
                    <img src="<?php echo e(asset('assets/frontend/fashion/blog-feature/4.webp')); ?>"
                        alt="Quality">
...
<?php /**PATH C:\laragon\www\elevate\resources\views/components/home_made_by_developer/fashion/blog.blade.php ENDPATH**/ ?>