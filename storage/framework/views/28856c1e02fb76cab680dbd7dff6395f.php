...
<section>
    <div class="container">
        <div class="row mb-30px wow animate__fadeInUp" data-wow-delay=".2s">
            <div class="col-12">
                <h1 class="mu-title-36px text-center builder-editable" builder-identity="1"><?php echo e(get_phrase('Latest News')); ?></h1>
            </div>
        </div>
        <div class="row gy-4 justify-content-center mb-30px wow animate__fadeInUp" data-wow-delay=".3s">
            ...
            <div class="col-xl-6 col-lg-10">
                <div class="news-card">
                    <a href="<?php echo e(route('blog_details', ['slug' => $blog->slug])); ?>" class="news-card-banner">
                        <img class="banner" src="<?php echo e(get_image($blog->thumbnail)); ?>" alt="banner">
                    </a>
                    <div class="new-card-details">
                        <p class="mb-12px al-subtitle-16px fw-medium lh-1"><?php echo e($blog->created_at->format('d M, Y')); ?></p>
                        <a href="<?php echo e(route('blog_details', ['slug' => $blog->slug])); ?>" class="mb-12px al-title2-20px text-link"><?php echo e($blog->title); ?></a>
                        <p class="mb-20px al-subtitle3-16px"><?php echo e(\Illuminate\Support\Str::limit($blog->summary, 90, '...')); ?></p>
                        <a href="<?php echo e(route('blog_details', ['slug' => $blog->slug])); ?>" class="btn ec-btn-dark pe-4 icon-right">
                            <span><?php echo e(get_phrase('Read Now')); ?></span>
        ...
        <div class="row section-margin wow animate__fadeInUp" data-wow-delay=".4s">
            <div class="col-12">
                <div class="text-center">
                    <a href="<?php echo e(route('blog')); ?>" class="btn ec-btn-outline-dark pe-4 icon-right">
...
<!-- Latest News Area End --><?php /**PATH C:\laragon\www\elevate\resources\views/components/home_made_by_developer/grocery/blog.blade.php ENDPATH**/ ?>