    ...
    <div class="d-block product-list-view">
        <div class="d-flex align-items-center gap-20px flex-column flex-md-row">
            <div class="product-list-banner">
                ...
                <a href="javascript:void(0);"  onclick="load_view('<?php echo e(route('view', ['path' => 'frontend.products.quick_view', 'product_id' => $product->id])); ?>', '#quickViewModal .modal-body')" class="product-quickview-btn" data-bs-toggle="modal" data-bs-target="#quickViewModal">
            ...
            <div class="w-100">
                <div>
                    <div class="d-flex align-items-start gap-12px mb-12px justify-content-between flex-column flex-md-row">
                        ...
                        <a href="<?php echo e(route('product', $product->slug)); ?>"  class="btn fsh-btn-dark text-nowrap"> <?php echo e(get_phrase('Shop Now')); ?>

                        </a>
                    </div>
                    <p class="al-subtitle-14px"><?php echo e(\Illuminate\Support\Str::limit($product->summary, 180, '...')); ?></p>
                </div>
            </div>
        </div>
    </div>
</div><?php /**PATH C:\laragon\www\elevate\resources\views/components/fashion/products/product_list.blade.php ENDPATH**/ ?>