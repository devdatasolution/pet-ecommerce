                ...
                <div class="footer-area">
                    <div class="footer-top-area">
                        <div class="footer-left-content">
                            ...
                            <p class="footer-info-subtitle"><?php echo e(get_settings('summary')); ?></p>
                            <!-- Social Media Links -->
                            <ul class="d-flex align-items-center gap-12px flex-wrap">
                                <li>
                                    <a class="footer-social-link" href="<?php echo e(get_settings('contact_instagram')); ?>" target="_blank">
                                ...
                                <li>
                                    <a class="footer-social-link" href="<?php echo e(get_settings('contact_linkedin')); ?>" target="_blank" >
                                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <li>
                                    <a class="footer-social-link" href="<?php echo e(get_settings('contact_twitter')); ?>" target="_blank">
                                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div class="footer-nav-content">
                            <h2 class="footer-nav-title builder-editable" builder-identity="sf1"><?php echo e(get_phrase('Quick Links')); ?></h2>
                            <ul class="footer-navbar-nav">
                                <li><a class="footer-nav-link" href="<?php echo e(route('home')); ?>"><?php echo e(get_phrase('Home')); ?></a></li>
                                <li><a class="footer-nav-link" href="<?php echo e(route('blog')); ?>"><?php echo e(get_phrase('Blog')); ?></a></li>
                                <li><a class="footer-nav-link" href="<?php echo e(route('events')); ?>"><?php echo e(get_phrase('Event')); ?></a></li>
                                <li><a class="footer-nav-link" href="<?php echo e(route('store')); ?>"><?php echo e(get_phrase('Store')); ?></a></li>
                                <li><a class="footer-nav-link" href="<?php echo e(route('contact_us')); ?>"><?php echo e(get_phrase('Contact Us')); ?></a></li>
                            </ul>
                        </div>
                        ...
                        ?>
                        <div class="footer-nav-content">
                            <h2 class="footer-nav-title builder-editable" builder-identity="sf2"><?php echo e(get_phrase('Top Categories')); ?></h2>
                            <ul class="footer-navbar-nav">
                        ...
                        <div class="footer-nav-content">
                            <h2 class="footer-nav-title builder-editable" builder-identity="sf3"><?php echo e(get_phrase('Support')); ?></h2>
                                 <ul class="footer-navbar-nav">
                    ...
                    <div class="footer-copyright-area">
                        <p class="footer-copyright-text builder-editable" builder-identity="sf4"><?php echo e(get_phrase('Copyright ©')); ?> <?php echo e(date('Y')); ?> | <?php echo e(get_phrase('All rights reserved by creativeitem.com')); ?></p>
                    </div>
                </div>
            </div>
        </div>
...
<!-- Footer End -->
<script src="<?php echo e(asset('assets/frontend/shoe/vendors/swiper/swiper-bundle.min.js')); ?>"></script>
<script src="<?php echo e(asset('assets/frontend/shoe/js/header.js')); ?>"></script>
<script src="<?php echo e(asset('assets/frontend/shoe/js/script.js')); ?>"></script><?php /**PATH C:\laragon\www\elevate\resources\views/components/home_made_by_builder/shoe/footer.blade.php ENDPATH**/ ?>