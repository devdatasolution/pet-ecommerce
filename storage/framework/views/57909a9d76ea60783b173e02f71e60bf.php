                ...
                <div class="brand-story-area">
                    <div class="brand-story-banners">
                        <div class="brand-story-banner1 wow animate__slideInLeft" data-wow-delay=".3s">
                            <img class="banner builder-editable" builder-identity="sB1" src="<?php echo e(asset('assets/frontend/shoe/images/brand-story-banner1.webp')); ?>" alt="banner">
                            <div class="brand-story-banner-content">
                                <h3 class="bs-banner-title builder-editable" builder-identity="sB2"><?php echo e(get_phrase('Our Client Reviews')); ?></h3>
                                <?php 
                                ...
                                <ul class="bs-banner-profiles">
                                    ...
                                    <li class="bs-banner-profile">
                                        <img class="user" src="<?php echo e(get_image($review->user->photo)); ?>" alt="">
                                    </li>
                        ...
                        <div class="brand-story-banner2 wow animate__slideInLeft" data-wow-delay=".2s">
                            <img class="banner builder-editable" builder-identity="sB3" src="<?php echo e(asset('assets/frontend/shoe/images/brand-story-banner2.webp')); ?>" alt="banner">
                        </div>
                    </div>
                    <div class="brand-story-title-area">
                        <p class="title-badge mb-30px wow animate__fadeInUp builder-editable" builder-identity="sB4" data-wow-delay=".1s"><?php echo e(get_phrase('Brand Story')); ?></p>
                        <h2 class="section-title text-capitalize mb-20px wow animate__fadeInUp builder-editable" builder-identity="sB5" data-wow-delay=".2s"><?php echo e(get_phrase('More Than Footwear — A Way of Life!')); ?></h2>
                        <p class="brand-story-subtitle wow animate__fadeInUp builder-editable" builder-identity="sB6" data-wow-delay=".3s"><?php echo e(get_phrase('At Shoe World, we believe in empowering movement — from early morning jogs to late-night events. Our shoes are designed for real life, inspired by real people. Each pair is crafted with premium materials and timeless design to bring you durability, style, and unmatched comfort.')); ?></p>
...
<!-- End Brand Story --><?php /**PATH C:\laragon\www\elevate\resources\views/components/home_made_by_builder/shoe/brand.blade.php ENDPATH**/ ?>