                            ...
                            <div class="d-flex align-items-center gap-2 ">
                                <?php if($product->is_discounted): ?>
                                    ...
                                    <?php if($discount->discount_type == 'percentage'): ?>
                                        <h4 class="al-title2-24px"><?php echo e(currency(($product->price / 100) * $discount->discount_value)); ?></h4>
                                        <h4 class="al-title-16px fw-medium ec-text-gray">><?php echo e(currency($product->price)); ?></h4>
                                    <?php else: ?>
                                        <h4 class="al-title2-24px"><?php echo e(currency($discount->discount_value)); ?></h4>
                                    <?php endif; ?>
                                        <h4 class="al-title2-24px"><del><?php echo e(currency($product->price)); ?></del></h4>
                                    <?php else: ?>
                                        <h4 class="al-title2-24px"><?php echo e(currency($product->price)); ?></h4>
                                    <?php endif; ?>
                            </div>
...
<!-- Best Deal Area End --><?php /**PATH C:\laragon\www\elevate\resources\views/components/home_made_by_builder/grocery/best_deal.blade.php ENDPATH**/ ?>