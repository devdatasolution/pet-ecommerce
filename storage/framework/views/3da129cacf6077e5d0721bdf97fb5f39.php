<?php $__env->startPush('title', get_phrase('Admins')); ?>
                ...
                <div class="stats-card s_box position-relative">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="stats-info">
                            <p class="stats-title"><?php echo e(get_phrase('Total Earning')); ?></p>
                            <p class="stats-value"><?php echo e(currency($balance)); ?></p>
                        </div>
                    </div>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6">
                <div class="stats-card s_box position-relative">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="stats-info">
                            <p class="stats-title"><?php echo e(get_phrase('Total Products')); ?></p>
                            <p class="stats-value"><?php echo e($totalProduct); ?></p>
                        </div>
                    </div>
                    <p class="stats-change">
                        <svg width="15" height="9" viewBox="0 0 15 9" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="col-lg-3 col-md-4 col-sm-6">
                <div class="stats-card s_box position-relative">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="stats-info">
                            <p class="stats-title"><?php echo e(get_phrase('Total Customer')); ?></p>
                            <p class="stats-value"><?php echo e($totalCustomer); ?></p>
                        </div>
                    </div>
                    <p class="stats-change">
                        <svg width="15" height="9" viewBox="0 0 15 9" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="col-lg-3 col-md-4 col-sm-6">
                <div class="stats-card s_box position-relative">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="stats-info">
                            <p class="stats-title"><?php echo e(get_phrase('Total Order')); ?></p>
                            <p class="stats-value"><?php echo e($totalOrder); ?></p>
                        </div>
                    </div>
                    <p class="stats-change">
                        <svg width="15" height="9" viewBox="0 0 15 9" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<div class="dashboard-section d-flex flex-wrap gap-3 mt-4">
    ...
    <div class="chart-card s_box flex-grow-1 p-3 rounded-3 shadow-sm bg-white h-450px">
        <h6 class="textTitle mb-4"><?php echo e(get_phrase('Statistics')); ?></h6>
    ...
    <div class="balance-card s_box text-white p-4 rounded-3 shadow-sm">
        <div class="d-flex flex-column justify-content-between h-100">
            <div class="blanceText">
                <h5><?php echo e(get_phrase('Balance')); ?></h5>
                <p><?php echo e(get_phrase('Your Active Balance')); ?></p>
                <h2><?php echo e(currency($balance)); ?></h2>
            </div>
    ...
    <div class="row g-3">
            ...
            <div class="ol-card s_box p-3">
                  <div class="ol-card-body">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        <h5 class="textTitle"><?php echo e(get_phrase('Top Products')); ?></h5>
                    </div>
                    <div class="table-responsive overflow-auto">
                            ...
                            <th scope="col"><?php echo e(get_phrase('Price')); ?></th>
                                <th scope="col"><?php echo e(get_phrase('Quantity')); ?></th>
                                <th scope="col"><?php echo e(get_phrase('Total Sales')); ?></th>
                                </tr>
                            </thead>
                            <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <small class="text-muted">
                                                <?php echo e(get_phrase('SKU:')); ?> <?php echo e($product->code); ?>
                                        ...
                                        <td>
                                            ...
                                            <?php if($product->discount_type == 'flat'): ?>
                                                <div class="d-flex gap-2">
                                                    <h4 class="product-card-price text-16"><?php echo e(currency($product->price - $product->discount_value)); ?></h4>
                                            ...
                                            <?php else: ?>
                                                ...
                                                ?>
                                                <div class="d-flex gap-2">
                                                    <h4 class="product-card-price text-16"><?php echo e(currency($product->price - $discount_amount)); ?></h4>
                                                    <del class="d-flex align-items-end"><?php echo e(currency($product->price)); ?></del>
                                                </div>
                                            <?php endif; ?>
                                        <?php else: ?>
                                            <h4 class="product-card-price text-16"><?php echo e(currency($product->price)); ?></h4>
                                        <?php endif; ?>

                                        </td>
                                        <td><?php echo e($product->total_quantity); ?></td>
                                        <td><?php echo e(currency(number_format($product->total_sales, 2))); ?></td>
                                    </tr>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </tbody>
                        </table>
                        <div class="admin-tInfo-pagi d-flex justify-content-between justify-content-center align-items-center flex-wrap gr-15">
                            <?php echo e($topProducts->links()); ?>
      ...
      <div class="col-lg-4 col-md-12">
            <div class="ol-card s_box p-3 ">
                <div class="ol-card-body">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        <h5 class="textTitle"><?php echo e(get_phrase('Stores')); ?></h5>
                        </div>
                             ...
                             <ul class="list-group list-group-flush small">
                                  <?php $__currentLoopData = $stores; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $store): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <li class="list-group-item d-flex justify-content-between">
                                        ...
                                        <span><?php echo e(currency(number_format($totalSales, 2))); ?></span>
                                    </li>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                          </ul>
                  </div>
...
<script type="text/javascript" src="<?php echo e(asset('assets/backend/js/chart.js')); ?>"></script>
<script type="text/javascript" src="<?php echo e(asset('assets/backend/js/index.js')); ?>"></script>
<script type="text/javascript" src="<?php echo e(asset('assets/backend/js/map.js')); ?>"></script>
<script type="text/javascript" src="<?php echo e(asset('assets/backend/js/worldLow.js')); ?>"></script>
<script type="text/javascript" src="<?php echo e(asset('assets/backend/js/Animated.js')); ?>"></script>

<script>
    'use strict';
    const months = <?php echo json_encode($months, 15, 512) ?>;
    const monthlyTotals = <?php echo json_encode($monthlyTotals, 15, 512) ?>;
    ...
    am5.ready(function() {
        ...
        var stores = <?php echo json_encode($stores, 15, 512) ?>;
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\elevate\resources\views/admin/dashboard/dashboard.blade.php ENDPATH**/ ?>