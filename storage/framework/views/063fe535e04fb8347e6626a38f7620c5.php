 ...
 <link rel="stylesheet" href="<?php echo e(asset('assets/frontend/fashion/css/header.css')); ?>">
 <link rel="stylesheet" href="<?php echo e(asset('assets/frontend/fashion/css/footer.css')); ?>">
         ...
         <div class="row justify-content-between align-items-center">
             <div class="col-auto col-lg order-2 order-lg-1">
                 <a href="<?php echo e(route('home')); ?>" class="header-logo">
                     <img src="<?php echo e(get_image(get_frontend_settings('dark_logo'))); ?>" alt="logo">
                 </a>
             </div>
                     ...
                     <nav>
                         <ul class="header-menu-ul">
                             <li class="header-menuitem-have-sub">
                                 <a href="<?php echo e(route('home')); ?>" class="header-menuitem-a header-menuitem-a-have-sub <?php if($current_route == 'home'): ?> active <?php endif; ?>">
                                     <span><?php echo e(get_phrase('Home')); ?></span>
                                 </a>
                             </li>
                                             ...
                                             <div class="mega-menu-inner-wrap">
                                                 <div class="mega-list-ads-wrap d-flex gap-3 align-items-start">
                                                                                 ...
                                                                                 <li class="mega-nav-item">
                                                                                     ...
                                                                                     <ul class="mega-nav-dropdown">
                                                                                         <?php $__currentLoopData = $subSubCategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subSubCategory): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                                             <li><a href="<?php echo e(route('products', get_category_params($subSubCategory))); ?>" class="mage-nav-sublink"><?php echo e($subSubCategory->title); ?></a>
                                                                                             </li>
                                                                                         <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                                                     </ul>
                                                                                 </li>
                                                                             <?php else: ?>
                                                                                 <li class="mega-nav-item"><a href="<?php echo e(route('products', get_category_params($subCategory))); ?>" class="mega-nav-link"><?php echo e($subCategory->title); ?></a>
                                                                                 </li>
                                                                             <?php endif; ?>
                                                                         <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                                     <?php endif; ?>
                                                     ...
                                                     <div class="mega-ads-wrap">
                                                         <?php $__currentLoopData = $categories->take(1); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                             <?php if(!empty($category->thumbnail)): ?>
                                                                 <?php if($index === 0): ?>
                                                                     <img class="banner" src="<?php echo e(get_image($category->thumbnail)); ?>" alt="<?php echo e($category->title); ?>">
                                                                 <?php endif; ?>
                                                             <?php endif; ?>
                                                         <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                     </div>
                             ...
                             <li><a href="<?php echo e(route('store')); ?>" class="header-menuitem-a <?php if($current_route == 'store'): ?> active <?php endif; ?>"><?php echo e(get_phrase('Store')); ?></a>
                             </li>
                             <li><a href="<?php echo e(route('events')); ?>" class="header-menuitem-a <?php if($current_route == 'event'): ?> active <?php endif; ?>"><?php echo e(get_phrase('Events')); ?></a>
                             </li>
                             <li><a href="<?php echo e(route('blog')); ?>" class="header-menuitem-a <?php if($current_route == 'blog'): ?> active <?php endif; ?>"><?php echo e(get_phrase('Blog')); ?></a>
                             </li>
                         </ul>
                     </nav>
                 </div>
                 ...
                 <div class="d-flex align-items-center gap-4 justify-content-end">
                     ...
                     <div class="d-flex align-items-center gap-3 justify-content-end">
                                 ...
                                 <div class="dropdown-menu dropdown-menu-end header-user-dropdown-menu">
                                     ...
                                     <ul>
                                         ...
                                         <?php else: ?>
                                            ...
                                            <li>
                                                <a href="<?php echo e(route('vendor.dashboard')); ?>" class="dropdown-item <?php if($current_route == 'vendor.dashboard'): ?> active <?php endif; ?>"><?php echo e(get_phrase('Store  Dashboard')); ?></a>
                                            </li>
                                            <?php endif; ?>
                                             <li>
                         ...
                         <?php else: ?>
                             <!-- without login -->
                             <div class="">
                                 <a href="javascript:;" onclick="formModal('<?php echo e(route('view', ['path' => 'auth.login_modal'])); ?>', '<?php echo e(get_phrase('Log In')); ?>')" class="svg-link header-svg-link d-flex align-items-center" data-bs-toggle="modal">
                         ...
                         <div class="d-none d-lg-block">
                             <a href="javascript:void(0)" class="svg-link header-svg-link d-flex align-items-center">
                                 <span class="header-svg-link-inner" data-bs-toggle="tooltip" data-bs-title="<?php echo e(get_phrase('Wishlist')); ?>" data-bs-placement="bottom">
                         ...
                         <a onclick="load_view('<?php echo e(route('view', ['path' => 'frontend.cart.offcanvas_cart_body'])); ?>', '#offcanvasCart')" data-bs-toggle="offcanvas" href="#offcanvasCart" role="button" aria-controls="offcanvasCart" class="svg-link header-svg-link d-flex align-items-center">
                             <span class="header-svg-link-inner" data-bs-toggle="tooltip" data-bs-title="Cart" data-bs-placement="bottom">
                                 <span class="svg-block position-relative">
                                     <span class="dark-circle-badge" id="header-cart-item-counter"><?php echo e(\App\Models\Cart_item::where('user_id', auth()->id())->count()); ?></span>
                                     <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewbox="0 0 18 18" fill="none">
             ...
             <div class="modal-body">
                 <div class="mb-20px">
                     <form action="<?php echo e(route('filter.search')); ?>" method="post">
                         <?php echo csrf_field(); ?>
                         <label for="searchFormControlInput1" class="form-label modal-search-label mb-12px builder-editable" builder-identity="ff1"><?php echo e(get_phrase('Search')); ?></label>
 ...
 <!-- Search Modal End -->
<?php /**PATH C:\laragon\www\elevate\resources\views/components/home_made_by_builder/fashion/header.blade.php ENDPATH**/ ?>