...
<div class="d-block product-grid-<?php echo e($layout); ?>">
    <div>
        <div class=" product-grid-banner-<?php echo e($layout); ?> mb-3">
            <?php
        ...
        <?php endif; ?>
            ...
            <a href="<?php echo e(route('product', $product->slug)); ?>"  class="btn fsh-btn-dark product-cart-btn-<?php echo e($layout); ?> grid4-product-cart-btn">
                    <?php echo e(get_phrase('Shop Now')); ?>

            </a>
            <a href="javascript:void(0)"  class="product-wishlist-btn grid4-wishlist <?php echo e(wishlist_class($product->id)); ?>"   onclick="toggleWishlist(<?php echo e($product->id); ?>, this)">
            ...
            <a href="javascript:void(0);" onclick="load_view('<?php echo e(route('view', ['path' => 'frontend.products.quick_view', 'product_id' => $product->id])); ?>', '#quickViewModal .modal-body')" class="product-quickview-btn grid4-quickview" data-bs-toggle="modal" data-bs-target="#quickViewModal">
...
</div><?php /**PATH C:\laragon\www\elevate\resources\views/components/fashion/products/product_grid.blade.php ENDPATH**/ ?>