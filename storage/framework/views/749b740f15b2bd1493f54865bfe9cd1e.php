...
<section>
    <div class="container">
        <div class="row">
            <div class="col-12">
                <div class="mb-30px">
                    <h1 class="mv-title-40px text-center wow animate__fadeInUp builder-editable" builder-identity="10" data-wow-delay=".2s"><?php echo e(get_phrase('Featured Products')); ?></h1>
                </div>
            </div>
        </div>
                        ...
                        <div>
                            <div class="product-grid-banner-md mb-12px">
                               ...
                               <?php if($product->is_discounted()->exists()): ?>
                                            ...
                                            <p class="red-badge-md capitalize"><?php echo e($discount_text); ?></p>
                                        <?php endif; ?>
                                
                                <a href="<?php echo e(route('product', $product->slug)); ?>" class="btn fsh-btn-dark product-cart-btn-md"><?php echo e(get_phrase('Shop Now')); ?></a>
                                <a href="javascript:void(0)" class="product-wishlist-btn <?php echo e(wishlist_class($product->id)); ?>" onclick="toggleWishlist(<?php echo e($product->id); ?>, this)">
                                             ...
                                             <?php if($product->is_discounted()->exists()): ?>
                                                <?php if($product->is_discounted->discount_type == 'flat'): ?>
                                                    <div class="d-flex gap-2">
                                                        <h6 class="al-title-16px">  <?php echo e(currency($product->price - $product->is_discounted->discount_value)); ?> </h6>
                                                ...
                                                <?php else: ?>
                                                    ...
                                                    ?>
                                                    <div class="d-flex gap-2">
                                                       <h6 class="al-title-16px"> <?php echo e(currency($product->price - $discount_amount)); ?>  </h6>
                                                         <h6 class="al-title-16px fw-medium fsh-text-gray"><del><?php echo e(currency($product->price)); ?></del></h6>
                                                    </div>
                      ...
                      <div class="d-block product-grid-md">
                            <div>
                                <div class="product-grid-banner-md mb-12px">
                                    ...
                                    <?php if($catproduct->is_discounted()->exists()): ?>
                                            <?php
                                    ...
                                    <a href="<?php echo e(route('product', $catproduct->slug)); ?>" class="btn fsh-btn-dark product-cart-btn-md"><?php echo e(get_phrase('Shop Now')); ?></a>
                                     <a href="javascript:void(0)" class="product-wishlist-btn <?php echo e(wishlist_class($catproduct->id)); ?>" onclick="toggleWishlist(<?php echo e($catproduct->id); ?>, this)">
                                            <span class="d-flex align-items-center justify-content-center w-100 h-100 rounded-circle" data-bs-toggle="tooltip" data-bs-title="Wishlist" data-bs-placement="left">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewbox="0 0 20 20" fill="none">
                                                    <path d="M10.0003 17.5059C9.75916 17.5059 9.52583 17.4748 9.33138 17.4048C6.36027 16.3859 1.63916 12.7692 1.63916 7.42586C1.63916 4.70364 3.84027 2.49475 6.54694 2.49475C7.86138 2.49475 9.09027 3.00808 10.0003 3.92586C10.9103 3.00808 12.1392 2.49475 13.4536 2.49475C16.1603 2.49475 18.3614 4.71142 18.3614 7.42586C18.3614 12.777 13.6403 16.3859 10.6692 17.4048C10.4747 17.4748 10.2414 17.5059 10.0003 17.5059ZM6.54694 3.66142C4.48583 3.66142 2.80583 5.3492 2.80583 7.42586C2.80583 12.7381 7.91583 15.6936 9.71249 16.3081C9.85249 16.3548 10.1558 16.3548 10.2958 16.3081C12.0847 15.6936 17.2025 12.7459 17.2025 7.42586C17.2025 5.3492 15.5225 3.66142 13.4614 3.66142C12.2792 3.66142 11.1825 4.21364 10.4747 5.17031C10.2569 5.46586 9.75916 5.46586 9.54138 5.17031C8.81805 4.20586 7.72916 3.66142 6.54694 3.66142Z" fill="#0D0E10"></path>
                                                </svg>
                                ...
                                <div>
                                    ...
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <div class="d-flex align-items-start gap-2">
                                            <?php if($catproduct->is_discounted()->exists()): ?>
                                                <?php if($catproduct->is_discounted->discount_type == 'flat'): ?>
                                                    <div class="d-flex gap-2">
                                                        <h6 class="al-title-16px">
                                                        <?php echo e(currency($catproduct->price - $catproduct->is_discounted->discount_value)); ?>
                                                ...
                                                <?php else: ?>
                                                    ...
                                                    <div class="d-flex gap-2">
                                                        <h6 class="al-title-16px">
                                                        <?php echo e(currency($catproduct->price - $discount_amount)); ?>
...
<!-- Featured Product Area End --></div></div></section><?php /**PATH C:\laragon\www\elevate\resources\views/components/home_made_by_builder/fashion/featured.blade.php ENDPATH**/ ?>