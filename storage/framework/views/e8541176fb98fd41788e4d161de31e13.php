                        ...
                        <div class="footer-top-area mb-30px pb-30px d-flex align-items-end justify-content-between gap-4 flex-wrap">
                            <div class="">
                                <a href="<?php echo e(route('home')); ?>" class="footer-logo mb-3">
                                    <img class="h-30px" src="<?php echo e(get_image(get_frontend_settings('light_logo'))); ?>" alt="logo">
                                </a>
                                <p class="al-subtitle2-16px max-w-337px"><?php echo e(get_settings('summary')); ?></p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-8">
                        <div class="footer-middle-area d-flex justify-content-between flex-wrap">
                            <div class="footer-nav-area">
                                <h4 class="al-title-18px text-white mb-4 builder-editable" builder-identity="f2"><?php echo e(get_phrase('Quick Links')); ?></h4>
                            ...
                            ?>
                            <div class="footer-nav-area">
                                <h4 class="al-title-18px text-white mb-4 builder-editable" builder-identity="f3"><?php echo e(get_phrase('Top Categories')); ?></h4>
                                <ul class="d-flex flex-column gap-18px">
                            ...
                            <div class="footer-nav-area">
                                <h4 class="al-title-18px text-white mb-4 builder-editable" builder-identity="f4"><?php echo e(get_phrase('Support')); ?></h4>
                                <ul class="d-flex flex-column gap-18px">
                            ...
                            <div class="footer-nav-area">
                                <h4 class="al-title-18px text-white mb-4 builder-editable" builder-identity="f5"><?php echo e(get_phrase('Contact Us')); ?></h4>
                                <ul class="d-flex flex-column gap-18px">
                                    <li>
                                        <a href="tel:<?php echo e(get_settings('phone')); ?>" class="footer-nav-link">
                                            <div class="d-flex column-gap-2 align-items-start">
                                                <img src="<?php echo e(asset('assets/frontend/grocery/images/image-icons/call-green-24.svg')); ?>" alt="icon">
                                    ...
                                    <li>
                                        <a href="mailto:<?php echo e(get_settings('system_email')); ?>" class="footer-nav-link">
                                            <div class="d-flex column-gap-2 align-items-start">
                                                <img src="<?php echo e(asset('assets/frontend/grocery/images/image-icons/sms-green-24.svg')); ?>" alt="icon">
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="footer-copyright-area d-flex align-items-center justify-content-center justify-content-sm-between column-gap-4 row-gap-4 flex-wrap flex-column flex-sm-row">
                    <p class="al-subtitle2-16px lh-1  text-center text-sm-left builder-editable" builder-identity="f6"> <?php echo e(get_phrase('Copyright ©')); ?> <?php echo e(date('Y')); ?> | <?php echo e(get_phrase('All rights reserved by creativeitem.com')); ?></p>
...
<script src="<?php echo e(asset('assets/frontend/grocery/js/script.js')); ?>"></script>
...
<?php $__env->stopPush(); ?><?php /**PATH C:\laragon\www\elevate\resources\views/components/home_made_by_developer/grocery/footer.blade.php ENDPATH**/ ?>