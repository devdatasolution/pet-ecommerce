                                         ...
                                         <?php else: ?>
                                            ...
                                            <li>
                                                <a href="<?php echo e(route('vendor.dashboard')); ?>"
                                                    class="dropdown-item <?php if($current_route == 'vendor.dashboard'): ?> active <?php endif; ?>"><?php echo e(get_phrase('Store  Dashboard')); ?></a>
                                            </li>
                                            <?php endif; ?>
                                             <li>
 ...
 <!-- Search Modal End -->
<?php /**PATH C:\laragon\www\elevate\resources\views/components/home_made_by_developer/fashion/header.blade.php ENDPATH**/ ?>