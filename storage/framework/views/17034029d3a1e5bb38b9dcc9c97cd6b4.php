        ...
        <div class="row gy-4 mb-100px collection-banner-row">
            <div class="col-12 wow animate__fadeInUp" data-wow-delay=".1s">
                ...
                <div class="collection-banner-wrap1 position-relative p-0 w-100 ">
                    <img src="<?php echo e(asset('http://127.0.0.1:8000/assets/frontend/fashion/images/images/collection-top-banner.webp')); ?>" class="builder-editable radius-12" builder-identity="28" alt="">
            ...
            <div class="col-md-6 wow animate__fadeInUp" data-wow-delay=".2s">
                <div class="collection-banner-wrap2">
                    <img class="banner builder-editable" builder-identity="14" src="<?php echo e(asset('http://127.0.0.1:8000/assets/frontend/fashion/images/images/collection-second-banner.webp')); ?>" alt="banner">
            ...
            <div class="col-md-6 wow animate__fadeInUp" data-wow-delay=".3s">
                <div class="collection-banner-wrap3">
                    <img class="banner builder-editable" builder-identity="16" src="<?php echo e(asset('http://127.0.0.1:8000/assets/frontend/fashion/images/images/collection-third-banner.webp')); ?>" alt="banner">
...
<!-- Featured Collection Area End --><?php /**PATH C:\laragon\www\elevate\resources\views/components/home_made_by_builder/fashion/featured_collection.blade.php ENDPATH**/ ?>