                ...
                <div class="col-xl-9 col-lg-8">
                    ...
                    <div class="d-flex align-items-start justify-content-between gap-2 mb-20px">
                        <div class="d-flex justify-content-between align-items-start align-items-lg-center gap-12px flex-column flex-lg-row w-100">
                            <h1 class="in-title-16px text-white-color">{{get_phrase('Change Password')}}</h1>
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb up-breadcrumb">
                                  <li class="breadcrumb-item up-breadcrumb-item"><a href="{{route('home')}}">{{get_phrase('Home')}}</a></li>
                                  <li class="breadcrumb-item up-breadcrumb-item active" aria-current="page">{{get_phrase('Change Password')}}</li>
                                </ol>
                            </nav>
                        </div>
                    ...
                    <div class="up-content-box">
                        <form action="{{ route('customer.account.update') }}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="mb-60px">
                                <div class="row gx-12px gy-3 mb-20px">
                                    <div class="col-md-8 col-xl-6">
                                        <div class="mb-20px">
                                            <label for="user-password5" class="form-label up-form-label">{{ get_phrase('Current Password') }}</label>
                                            <div class="input-password-wrap">
                                                <div class="password-icons2 lock toggle-password" toggle=".password-field5">
                                                    <img class="eye-unlock" src="{{ asset('assets/frontend/fashion/images/image-icons/eye-gray-20.svg') }}" alt="">
                                                    <img class="eye-lock" src="{{ asset('assets/frontend/fashion/images/image-icons/eye-slash-gray-20.svg') }}" alt="">
                                                </div>
                                                <input name="current_password" type="password" class="form-control up-form-control password-field5" id="user-password5" placeholder="{{ get_phrase('Enter your current password') }}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row gx-12px gy-3 mb-20px">
                                    <div class="col-md-8 col-xl-6">
                                        <div class="mb-20px">
                                            <label for="user-password6" class="form-label up-form-label">{{ get_phrase('New Password') }}</label>
                                            <div class="input-password-wrap">
                                                <div class="password-icons2 lock toggle-password" toggle=".password-field6">
                                                    <img class="eye-unlock" src="{{ asset('assets/frontend/fashion/images/image-icons/eye-gray-20.svg') }}" alt="">
                                                    <img class="eye-lock" src="{{ asset('assets/frontend/fashion/images/image-icons/eye-slash-gray-20.svg') }}" alt="">
                                                </div>
                                                <input name="new_password" type="password" class="form-control up-form-control password-field6" id="user-password6" placeholder="{{ get_phrase('Minimum 6 characters with  a number') }}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row gx-12px gy-3">
                                    <div class="col-md-8 col-xl-6">
                                        <div class="mb-20px">
                                            <label for="user-password7" class="form-label up-form-label">{{ get_phrase('Confirm Password') }}</label>
                                            <div class="input-password-wrap">
                                                <div class="password-icons2 lock toggle-password" toggle=".password-field7">
                                                    <img class="eye-unlock" src="{{ asset('assets/frontend/fashion/images/image-icons/eye-gray-20.svg') }}" alt="">
                                                    <img class="eye-lock" src="{{ asset('assets/frontend/fashion/images/image-icons/eye-slash-gray-20.svg') }}" alt="">
                                                </div>
                                                <input name="confirm_password" type="password" class="form-control up-form-control password-field7" id="user-password7" placeholder="{{ get_phrase('Please Retype your password') }}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="d-flex align-items-center gap-12px flex-wrap">
                                <button type="submit" class="btn up-btn-dark">{{ get_phrase('Change password') }}</button>
                            </div>
                        </form>
                    </div>
                </div>
