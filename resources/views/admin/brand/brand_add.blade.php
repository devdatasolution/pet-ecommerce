...
@push('title', get_phrase('Brand Add'))
@push('meta')
@endpush
@push('css')
@endpush
                ...
                <div class="ol-card-body">
                    <form action="{{ route('admin.brand.store') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" value="{{ old('name') }}" name="name" class="form-control ol-form-control" id="name" placeholder="{{ get_phrase('Enter brand name') }}" aria-label="{{ get_phrase('Enter brand name') }}" required>
                        </div>

                        <div class="mb-3">
                            <label for="description" class="form-label ol-form-label">{{ get_phrase('Brand content') }}</label>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" value="{{ old('official_website_link') }}" name="official_website_link" class="form-control ol-form-control" id="official_website_link" placeholder="{{ get_phrase('Enter official website link') }}" aria-label="{{ get_phrase('Enter official website link') }}">
                        </div>
