...
@push('title', get_phrase('Add blog category'))
@push('meta')
@endpush
@push('css')
@endpush
                ...
                <div class="ol-card-body">
                    <form action="{{ route('admin.blog.category.store') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" value="{{ old('title') }}" name="title" class="form-control ol-form-control" id="title" placeholder="{{ get_phrase('Enter category title') }}" aria-label="{{ get_phrase('Enter category title') }}" required>
                        </div>
