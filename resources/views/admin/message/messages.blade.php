                ...
                <div class="message-sidebar-area">
                    <div class="message-sidebar-header">
                        <div class="back-and-plus mb-3 d-flex align-items-center justify-content-between flex-wrap">
                            ...
                            <a href="#" onclick="ajaxModal('{{ route('view', ['path' => 'admin.message.message_new']) }}', '{{ get_phrase('Create a new thread') }}')" data-bs-toggle="tooltip" title="{{ get_phrase('New message') }}" class="btn ol-btn-light ol-icon-btn ol-icon-btn-sm">
                        ...
                        <form action="#">
                            <div class="message-sidebar-search">
                                ...
                                <input type="search" class="form-control" onkeyup="load_view('{{ route('view', ['path' => 'admin.message.message_left_sidebar']) }}?thread_id={{ $thread_details->id }}&search='+$(this).val(), '#message-user-list')" id="message-sideSearch" placeholder="{{ get_phrase('Search user') }}">
                    ...
                    <ul class="message-sidebar-messages" id="message-user-list">
                        @include('admin.message.message_left_sidebar')
                    </ul>
                </div>
            </div>
