                                            ...
                                            <div class="chart-widget-list">
                                                ...
                                                <p class="border-bottom mb-2 pb-2 text-13px d-flex align-items-center">
                                                    ...
                                                    @else
                                                        ...
                                                        <button class="btn custom_btns ol-btn-primary float-end ms-2 me-2 py-0 text-13px" onclick="ajaxModal('{{ route('view', ['path' => 'admin.settings.save_purchase_code', 'action_type' => 'show']) }}', '{{ get_phrase('Enter valid purchase code') }}')">{{ get_phrase('Enter valid purchase code') }}</button>
                                                    @endif
                                                </p>
