...
$payment_gateway = \App\Models\Payment_gateway::where('identifier', 'paystack')->firstOrNew();
...
<form action="#" class="form paystack-form">
    ...
    <button type="button" name="pay_now" id="pay-now" class="btn-payment btn py-2 px-3" onclick="payWithPaystack()"><?php echo get_phrase('Pay by paystack'); ?> <span  data-toggle="tooltip" title="Paystack Payment" class="premium-icon"><i class="fas fa-chess-queen"></i></span></button>
</form>
