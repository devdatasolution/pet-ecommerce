...
@section('content')
        ...
        <div class="ol-card-body">
            <div class="row float-end">
                <div class="col-md-6 text-end">
                     <a href="{{ route('vendor.order.return_requests') }}" class="btn ol-btn-outline-secondary d-flex align-items-center cg-10px">
    ...
    <style>
        ...
        <div class="ol-card p-4 py-3 mt-4">
            <div class="ol-card-body">
                <h3 class="title fs-18px mb-20px">{{ get_phrase('Summary') }}</h3>
                <!-- Comment -->
