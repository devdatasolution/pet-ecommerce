            ...
            <div class="offcanvas-cart-item mb-20 d-flex align-items-center">
                ...
                <div class="offcanvas-cartitem-details d-flex align-items-center justify-content-between">
                    ...
                    <div class="offcanvas-cart-total-remove">
                        <button type="button" class="btn btn-primary-light btn-icon" onclick="append_view('{{route('view', ['path' => 'store.order.ordered_item', 'product_id' => $product->id])}}', '#ordered_product_list')"><i class="fi-rr-plus"></i></button>
                    </div>
                </div>
            </div>
        </div>
