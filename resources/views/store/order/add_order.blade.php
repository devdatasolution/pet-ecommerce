...
@section('content')
    ...
    <form action="{{ route('vendor.order.store') }}" method="post" enctype="multipart/form-data">
        @csrf
        <div class="row">
            <div class="col-md-7">
                <div class="ol-card p-4">
                    <div class="ol-card-body">
                        ...
                        <div class="mb-3">
                            {{-- <label for="user_id" class="form-label ol-form-label">{{ get_phrase('Customer') }}</label> --}}
                            <select class="ol-select2" name="user_id" onchange="load_view('{{ route('view', ['path' => 'store.order.customer_information']) }}?user_id='+$(this).val(), '#customer-information')" id="user_id" required>
                        ...
                        <div id="customer-information">
                            @include('store.order.add_customer_information')
                        </div>
                        ...
                        <div class="mb-3">
                            {{-- <label for="status" class="form-label ol-form-label">{{ get_phrase('Order status') }}</label> --}}
                    ...
                    <div class="ol-card-body">
                        ...
                        <div class="mb-3 mt-3">
                            <div class="input-group">
                                ...
                                <input type="text" onkeyup="searchProduct('{{ route('view', ['path' => 'store.order.product_list']) }}?search='+$(this).val(), '#product_list')" class="form-control ol-form-control" placeholder="{{ get_phrase('Search products') }}" aria-label="{{ get_phrase('Search products') }}">
                            </div>
                        </div>

                        <div id="product_list">
                            @include('store.order.browse_product_list')
                        </div>
