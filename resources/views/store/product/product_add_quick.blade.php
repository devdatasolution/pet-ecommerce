<form action="{{ route('vendor.product.store', ['action_type' => 'quick']) }}" method="post" enctype="multipart/form-data">
    @csrf
    <div class="row">
        <div class="col-lg-6">
            <div class="ol-card">
            ...
            <div class="ol-card">
                ...
                <div class="ol-card-body p-3 mb-5">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="ol-select2" name="category_id" id="category_id_1st" onchange="load_view('{{ route('view', ['path' => 'store.product.attributes_dropdown_list']) }}?category_id='+$(this).val(), '#attributes_dropdown_list_1st'); $('.appended-attributes').html('');" required>
