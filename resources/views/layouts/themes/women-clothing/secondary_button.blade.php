    ...
    <style>
       ...
       .ba-btn-outline-dark:hover{
        ...
        .header-access-item:hover path {
            fill: {{ $secondary_button['background-hover-color'] }} !important;
        }
        .active-mobile-sub-submenu > .mobile-dropitem-a-have-sub path,
        .active-mobile-submenu > .mobile-menuitem-a-have-sub path {
            fill: {{ $secondary_button['background-hover-color'] }} !important;
        }
