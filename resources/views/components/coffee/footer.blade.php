                ...
                <div class="col-12">
                    <div class="footer-top-main">
                        <div class="footer-logo-area">
                            ...
                            <p class="footer-info-text">{{get_phrase('Discover artisan coffee blends, soothing teas & beautifully crafted brewing tools all in one place.')}}</p>
                        ...
                        <div class="footer-nav-main">
                            <div class="footer-nav-wrap">
                                <h3 class="ft-nav-title min-w-225px">{{get_phrase('Quick Links')}}</h3>
                            ...
                            @endphp
                            <div class="footer-nav-wrap">
                                <h3 class="ft-nav-title min-w-225px">{{get_phrase('Top Categories')}}</h3>
                                <ul class="ft-navbar-nav">
                            ...
                            <div class="footer-nav-wrap">
                                <h3 class="ft-nav-title min-w-225px">{{get_phrase('Support')}}</h3>
                                <ul class="ft-navbar-nav">
