                    ...
                    <div class="product-card">
                                ...
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <div class="product-card-banner-slide">
                                            ...
                                            <a href="javascript:;" onclick="load_view('{{ route('view', ['path' => 'frontend.products.quick_view', 'product_id' => $related_product->id]) }}', '#quickViewModal .modal-body')" data-bs-toggle="modal" data-bs-target="#quickViewModal" class="btn wch-sm-btn-black">{{get_phrase('Add To Cart')}}</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="product-card-body">
                            <div class="d-flex align-items-center gap-2 mb-12px flex-wrap">
                                    ...
                                    <p class="pc-rating-review-total">{{ number_format($related_product->average_rating, 1) }} <span class="ec-text-gray">({{ $related_product->reviews->count() }})</span></p>
                                </div>
                            ...
                            <p class="product-card-subtitle">
                                {{ \Illuminate\Support\Str::limit($related_product->summary, 50, '...') }}
                            </p>
