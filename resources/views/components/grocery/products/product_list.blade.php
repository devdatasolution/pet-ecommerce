<div class="product-list-view">
    <div class="product-list-banner">
        ...
        @endphp
        <img src="{{ get_image($firstImage) }}" alt="banner">
        
        <div class="view-bookmark-list-wrap">
    ...
    <div class="product-list-details">
        <div class="product-list-details-inner">
            <div class="list-view-title-wrap mb-3">
                <a href="{{ route('product', $product->slug) }}" class="al-title-16px  text-link mb-12px">{{ $product->title }}</a>
                <div class="d-flex align-items-center gap-1 flex-wrap mb-12px">
            ...
            <p class="al-subtitle2-14px">{{ \Illuminate\Support\Str::limit($product->summary, 140, '...') }}</p>
            <a href="{{ route('product', $product->slug) }}" class="btn ec-btn-dark list-view-btn">
                    {{ get_phrase('Shop Now') }}
            </a>
        </div>
    </div>
