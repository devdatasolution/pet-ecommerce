        ...
        <div class="row g-lg-5">
            <div class="col-lg-4">
                <div class="single-footer-block">
                    ...
                    <p>{{get_phrase('Passionate about smart, sustainable travel. We design gear that makes every journey simpler, lighter, and more inspiring—trusted by travelers worldwide.')}}</p>
