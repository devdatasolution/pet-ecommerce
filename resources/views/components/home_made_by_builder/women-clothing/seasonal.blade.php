    ...
    <section class="section-mb overflow-hidden">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <div class="seasonal-section-title-area">
                        <h5 class="section-sm-title mb-22px wow animate__fadeInUp builder-editable" builder-identity="WOSE1" data-wow-delay=".1s">{{get_phrase('Seasonal Style Picks')}}</h5>
                        <div class="d-flex align-items-start align-items-lg-center justify-content-start justify-content-lg-between column-gap-4 row-gap-4 flex-column flex-lg-row">
                            <h2 class="section-title seasonal-section-title wow animate__fadeInUp builder-editable" builder-identity="WOSE2" data-wow-delay=".2s">{{get_phrase('Handpicked looks to match the moment')}}</h2>
                            <a href="{{route('all_products')}}" class="btn-underline text-nowrap wow animate__fadeInUp builder-editable" builder-identity="WOSE3" data-wow-delay=".3s">{{get_phrase('Explore Collection')}}</a>
                        </div>
                    </div>
                </div>
            </div>
            <div class="row product-card-row2 mb-20px wow animate__fadeInUp" data-wow-delay=".4s">
                @php 
                    $latest_products = App\Models\Product::where('status', 1)->take(4)->get();
                @endphp
            ...
            <div class="row">
                <div class="col-12">
                    <div class="text-center">
                        <a href="{{route('all_products')}}" class="btn wc-btn-outline-dark min-w-177px mx-auto builder-editable" builder-identity="WOSX1">{{get_phrase('Shop Now')}}</a>
                    </div>
                </div>
            </div>
        </div>
