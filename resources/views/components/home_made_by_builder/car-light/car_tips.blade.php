        ...
        <div class="container">
            <div class="row gx-4 gy-5 align-items-center justify-content-center">
                <div class="col-md-10 col-lg-6 col-xl-5">
                    <div>
                        <h2 class="section-title mb-40px wow animate__fadeInUp builder-editable" builder-identity="CTT1" data-wow-delay=".1s">{{get_phrase('Your Go-To Hub for Car Hacks, How-Tos & Pro Tip')}}</h2>
                        <ul class="wow animate__fadeInUp" data-wow-delay=".2s">
                            <li class="tips-list-item">
                                ...
                                <div>
                                    <h5 class="tips-list-title builder-editable" builder-identity="CTT2">{{get_phrase('Top 5 Car Detailing Hacks')}}</h5>
                                    <p class="tips-list-subtitle builder-editable" builder-identity="CTT3">{{get_phrase('Get that showroom shine at home')}}</p>
                                </div>
                            </li>
                            <li class="tips-list-item">
                                <div class="tips-list-iconbox">
                                ...
                                <div>
                                    <h5 class="tips-list-title builder-editable" builder-identity="CTT4">{{get_phrase("Boost Your Ride's Tech")}}</h5>
                                    <p class="tips-list-subtitle builder-editable" builder-identity="CTT5">{{get_phrase('Fleet of late-model luxury vehicles (2019–2022)')}}</p>
                                </div>
                            </li>
                            <li class="tips-list-item">
                                <div class="tips-list-iconbox">
                                ...
                                <div>
                                    <h5 class="tips-list-title builder-editable" builder-identity="CTT6">{{get_phrase('Choosing the Right Floor Mats')}}</h5>
                                    <p class="tips-list-subtitle builder-editable" builder-identity="CTT7">{{get_phrase('Must-have gadgets and how to install them')}}</p>
                                </div>
                            </li>
                            <li class="tips-list-item">
                                <div class="tips-list-iconbox">
                                ...
                                <div>
                                    <h5 class="tips-list-title builder-editable" builder-identity="CTT8">{{get_phrase('Quick DIY Upgrades')}}</h5>
                                    <p class="tips-list-subtitle builder-editable" builder-identity="CTT9">{{get_phrase('Transform your interior in under 10 minutes')}}</p>
                                </div>
                            </li>
                        </ul>
                        <a href="{{route('all_products')}}" class="btn ca-btn-skin min-w-175px mx-auto wow animate__fadeInUp builder-editable" builder-identity="CTT10" data-wow-delay=".3s">{{get_phrase('Grab the Deals')}}</a>
                    </div>
                </div>
                <div class="col-md-10 col-lg-6 col-xl-7">
                    <div class="car-tips-banner-wrap ps-xl-5 ps-lg-4">
                        <div class="car-tips-banner wow animate__fadeInRight" data-wow-delay=".3s">
                            <img class="banner builder-editable" builder-identity="CTT11" src="{{ asset('assets/frontend/car-light/images/car-tips-banner1.webp') }}" alt="banner">
                        </div>
                        <div class="car-tips-banner wow animate__fadeInRight" data-wow-delay=".4s">
                            <img class="banner builder-editable" builder-identity="CTT12" src="{{ asset('assets/frontend/car-light/images/car-tips-banner2.webp') }}" alt="banner">
                        </div>
                    </div>
                </div>
            </div>
