            ...
            <div class="row">
                <div class="col-12">
                    <div class="testi-section-title-area">
                        <h2 class="section-title text-center text-white max-w-735px mx-auto wow animate__fadeInUp builder-editable" builder-identity="CTTS1" data-wow-delay=".1s">{{get_phrase('Loved by our customers')}}</h2>
                    </div>
                </div>
            </div>
