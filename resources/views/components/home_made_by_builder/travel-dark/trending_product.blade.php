        ...
        <div class="row wow animate__fadeInUp" data-wow-delay=".1s">
            <div class="col-12">
                <div class="trending-section-title-area tr-section">
                    ...
                    <span class="d-block mb-40px builder-editable" builder-identity="TDT1">{{get_phrase('Trending Products')}}</span>
                    <div class="trending-section-title-main">
                        <div class="trending-section-title-left">
                            <h2 class="mb-2 builder-editable" builder-identity="TDT2">{{get_phrase('Top Picks Travelers Always Love!')}}</h2>
                        </div>
                        <div class="trending-section-title-right">
                            <p class="builder-editable" builder-identity="TDT3">{{get_phrase('Join thousands of happy travelers who swear by these must-haves. From smart luggage to compact organizers.')}}</p>
                            <a href="{{route('all_products')}}" class="tr-white-btn-large px-3 mt-5 builder-editable" builder-identity="TDT4">{{get_phrase('View All Products')}}</a>
                        </div>
                    </div>
                </div>
            </div>
