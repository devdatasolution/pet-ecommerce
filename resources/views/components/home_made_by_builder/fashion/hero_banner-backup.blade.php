...
background: url({{ asset('assets/frontend/fashion/images/images/ipet-slider.avif') }}) no-repeat scroll center
center / cover;
padding-top: 40px;
height: 80vh;
}
            ...
            <div class="col-12">
                <div class="home-hero-inner-wrap">
                    <!-- Title for tab -->
                        ...
                        <h2 class="sm-title builder-editable wow animate__fadeInUp" builder-identity="1" data-wow-delay=".2s">{{ get_phrase('Stylish') }}
                    ...
                    <div class="ipet-home-hero-banner">
                        {{-- <img class="d-none d-lg-block banner builder-editable" builder-identity="3" src="{{ asset('http://127.0.0.1:8000/uploads/home-page-builder/1782293514-8OJi1Igodct0aRW5ZThl96svzEuKQ2.webp') }}" alt="banner">
                        <img class="d-block d-lg-none banner  builder-editable" builder-identity="4" src="{{ asset('http://127.0.0.1:8000/assets/frontend/fashion/images/images/ipet banner image.webp') }}" alt="banner"> --}}
                    ...
                    <div class="ipet-text-placement wow animate__fadeInUp" data-wow-delay=".5s">
                        <h4 class="ipet-slider-title al-title-24px mb-3  builder-editable" builder-identity="6">{{ get_phrase('Pet Care') }}</h4>
                        <ul>
                            <li class="ipet-subtitle fsh-arrow-list-item  builder-editable" builder-identity="7">{{ get_phrase('We Provide Best Pet Food') }}</li>
                            <li class="ipet-subtitle fsh-arrow-list-item  builder-editable" builder-identity="8">{{ get_phrase('Gildan') }}</li>
                            <li class="ipet-subtitle fsh-arrow-list-item  builder-editable" builder-identity="9">{{ get_phrase('Roughnext') }}</li>
                        </ul>
