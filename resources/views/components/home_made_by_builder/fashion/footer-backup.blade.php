                    ...
                    <div class="col-lg-4">
                        <div class="footer-top-area mb-30px pb-30px d-flex align-items-end justify-content-between gap-4 flex-wrap">
                            <div class="">
                                ...
                                <p class="al-subtitle2-16px max-w-337px builder-editable" builder-identity="1">{{ get_phrase('Sophisticated simplicity for the independent mind.') }}</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-8">
                        <div class="footer-middle-area d-flex justify-content-between flex-wrap">
                            <div class="footer-nav-area">
                                <h4 class="al-title-18px text-white mb-4 builder-editable" builder-identity="2">{{ get_phrase('Quick Links') }}</h4>
                            ...
                            @endphp
                            <div class="footer-nav-area">
                                <h4 class="al-title-18px text-white mb-4 builder-editable" builder-identity="3">{{ get_phrase('Top Categories') }}</h4>
                                <ul class="d-flex flex-column gap-18px">
                            ...
                            <div class="footer-nav-area">
                                <h4 class="al-title-18px text-white mb-4 builder-editable" builder-identity="4">{{ get_phrase('Support') }}</h4>
                                <ul class="d-flex flex-column gap-18px">
                            ...
                            <div class="footer-nav-area">
                                <h4 class="al-title-18px text-white mb-4 builder-editable" builder-identity="5">{{ get_phrase('Contact Us') }}</h4>
                                <ul class="d-flex flex-column gap-18px">
                                    <li>
                                    ...
                                    <li>
                                        <a href="mailto:{{get_settings('system_email')}}" class="footer-nav-link">
                                            <div class="d-flex column-gap-2 align-items-start">
                                                <img src="{{ asset('assets/frontend/fashion/images/image-icons/sms-red-24.svg') }}" alt="icon">
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="footer-copyright-area d-flex align-items-center justify-content-center justify-content-sm-between column-gap-4 row-gap-4 flex-wrap flex-column flex-sm-row">
                    <p class="al-subtitle2-16px lh-1  text-center text-sm-left builder-editable" builder-identity="6">{{ get_phrase(' Copyright © 2026 | All rights reserved by creativeitem.com') }}</p>
