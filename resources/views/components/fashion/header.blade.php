         ...
         <div class="row justify-content-between align-items-center">
                     ...
                     <nav>
                         <ul class="header-menu-ul">
                             <li class="header-menuitem-have-sub">
                                 <a href="{{ route('home') }}"
                                     class="header-menuitem-a header-menuitem-a-have-sub @if ($current_route == 'home') active @endif">
                             ...
                             <li><a href="{{ route('events') }}"
                                     class="header-menuitem-a @if ($current_route == 'event') active @endif">{{ get_phrase('Events') }}</a>
                             </li>
             ...
             <div class="col-auto col-lg order-3">
                 <div class="d-flex align-items-center gap-4 justify-content-end">
                     <button type="button"
                         class="search-modal-btn d-none d-lg-block svg-link header-svg-link d-flex align-items-center"
                     ...
                     <div class="d-flex align-items-center gap-3 justify-content-end">
                             ...
                             <div class="">
                                 <a href="javascript:;"
                                     ...
                                     <span class="svg-block header-svg-link-inner" data-bs-toggle="tooltip"
                                         data-bs-title="Login" data-bs-placement="bottom">
                         ...
                         <div class="d-none d-lg-block">
                             <a href="javascript:void(0)" class="svg-link header-svg-link d-flex align-items-center">
                                 <span class="header-svg-link-inner" data-bs-toggle="tooltip"
                                     data-bs-title="{{ get_phrase('Wishlist') }}" data-bs-placement="bottom">
                                     <span class="svg-block position-relative">
                                         <span
                                             class="dark-circle-badge">{{ \App\Models\Wishlist_item::where('user_id', auth()->id())->count() }}</span>
                                         <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18"
                                             viewBox="0 0 18 18" fill="none">
                                             <path
                         ...
                         <a onclick="load_view('{{ route('view', ['path' => 'frontend.cart.offcanvas_cart_body']) }}', '#offcanvasCart')"
                             ...
                             aria-controls="offcanvasCart" href="javascript:;"
                             class="svg-link header-svg-link d-flex align-items-center">
                             <span class="header-svg-link-inner" data-bs-toggle="tooltip" data-bs-title="Cart"
                                 data-bs-placement="bottom">
                                 <span class="svg-block position-relative">
