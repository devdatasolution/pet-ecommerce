...
<!-- Footer Section Start -->
 <footer class="footer-area wow animate__fadeInUp" data-wow-delay=".1s">
    <div class="container">
        <div class="row g-lg-5">
            <div class="col-lg-4">
                <div class="single-footer-block">
                    <img class="footer-image" src="{{ get_image(get_frontend_settings('light_logo')) }}" alt="...">
                    <p class="builder-editable" builder-identity="TDF1">{{get_phrase('Passionate about smart, sustainable travel. We design gear that makes every journey simpler, lighter, and more inspiring—trusted by travelers worldwide.')}}</p>
                    <ul class="d-flex footer-icon align-items-center gap-20px flex-wrap justify-content-center justify-content-sm-start">
                        <li>
                    ...
                    <p class="builder-editable" builder-identity="TDF2">{{get_phrase('Copyright ©')}} {{ date('Y') }} | {{get_phrase('All rights reserved by creativeitem.com')}}</p>
                </div>
            </div>
            <div class="col-lg-8">
                <div class="row">
                    <div class="col-lg-4 col-md-4">
                        <div class="single-footer-block footer-item">
                            <h4 class="builder-editable" builder-identity="TDF3">{{get_phrase('Quick Link')}}</h4>
                            <ul>
                    ...
                    <div class="col-lg-4 col-md-4">
                        <div class="single-footer-block footer-item">
                            <h4 class="builder-editable" builder-identity="TDF4">{{get_phrase('Top Categories')}}</h4>
                            <ul>
                    ...
                    <div class="col-lg-4 col-md-4">
                        <div class="single-footer-block footer-item">
                            <h4 class="builder-editable" builder-identity="TDF5">{{get_phrase('Support')}}</h4>
                            <ul>
...
<!-- Scroll Top -->
 ...
 {{-- Travel Dark --}}
<script src="{{ asset('assets/frontend/travel-dark/vendors/swiper/swiper-bundle.min.js') }}"></script>
{{-- <script src="{{ asset('assets/frontend/travel-dark/vendors/wow-js/wow.min.js') }}"></script> --}}
<script src="{{ asset('assets/frontend/travel-dark/js/header.js') }}"></script>
<script src="{{ asset('assets/frontend/travel-dark/js/script.js') }}"></script>