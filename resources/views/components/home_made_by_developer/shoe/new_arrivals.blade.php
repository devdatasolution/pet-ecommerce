                                        ...
                                        <div class="d-flex align-items-center column-gap-10px row-gap-1 flex-wrap">
                                           @if ($catproduct->is_discounted()->exists())
                                                    @if ($catproduct->is_discounted->discount_type == 'flat')
                                                        <div class="d-flex align-items-baseline gap-2">
                                                            <h6 class="product-card-price">  {{ currency($catproduct->price - $catproduct->is_discounted->discount_value) }} </h6>
                                                    ...
                                                    @else
                                                        ...
                                                        @endphp
                                                        <div class="d-flex align-items-baseline gap-2">
                                                            <h6 class="product-card-price"> {{ currency($catproduct->price - $discount_amount) }}  </h6>
                                                                <h6 class="al-title-14px fw-medium fsh-text-gray"><del>{{ currency($catproduct->price) }}</del></h6>
                                                        </div>
                                                    @endif
                                                @else
                                                        <h6 class="product-card-price">{{ currency($catproduct->price) }}</h6>
                                                @endif
                                            <div class="d-flex align-items-center gap-1">
                                                <span class="product-card-star">
                                                    <svg width="24" height="24" viewBox="0 0 27 26" fill="none" xmlns="http://www.w3.org/2000/svg">
