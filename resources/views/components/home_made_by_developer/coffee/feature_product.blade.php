            ...
            <div class="row">
                <div class="col-12">
                    <div class="fp-section-title-area">
                        <p class="title-badge mx-auto mb-28px wow animate__fadeInUp builder-editable" builder-identity="COFP1" data-wow-delay=".1s">{{get_phrase('Featured Products')}}</p>
                        <h2 class="section-title text-center max-w-867px mx-auto wow animate__fadeInUp builder-editable" builder-identity="COFP2" data-wow-delay=".2s">{{get_phrase('Featured Products for Coffee & Tea Lovers')}}</h2>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="text-center">
                        <a href="{{route('all_products')}}" class="btn cts-btn-outline-black builder-editable" builder-identity="COFP3">{{get_phrase('Explore Collection')}}</a>
                    </div>
                </div>
            </div>
        </div>
