...
<div class="commonDivHidden">
                ...
                <div class="col-12">
                    <div class="footer-top-area">
                        <div class="footer-logo-area">
                            ...
                            <p class="ft-newsletter-subtitle ft-newsletter-subtitle1">{{get_settings('summary')}}</p>
                        </div>
                        <div class="footer-nav-main">
                            <div class="footer-nav-wrap">
                                <h3 class="ft-nav-title builder-editable" builder-identity="MF1">{{get_phrase('Quick Links')}}</h3>
                                <ul class="ft-navbar-nav">
                                    <li class="ft-nav-item">
                                        <a href="{{route('home')}}" class="ft-nav-link">{{get_phrase('Home')}}</a>
                                    </li>
                                    <li class="ft-nav-item">
                                        <a href="{{route('blog')}}" class="ft-nav-link">{{get_phrase('Blog')}}</a>
                                    </li>
                                    <li class="ft-nav-item">
                                        <a href="{{route('store')}}" class="ft-nav-link">{{get_phrase('Store')}}</a>
                                    </li>
                                    <li class="ft-nav-item">
                                        <a href="{{route('events')}}" class="ft-nav-link">{{get_phrase('Events')}}</a>
                                    </li>
                                    <li class="ft-nav-item">
                                        <a href="{{route('contact_us')}}" class="ft-nav-link">{{get_phrase('Contact')}}</a>
                                    </li>
                                </ul>
                            </div>
                             @php
                            ...
                            @endphp
                            <div class="footer-nav-wrap">
                                <h4 class="ft-nav-title builder-editable" builder-identity="MF2">{{get_phrase('Top Categories')}}</h4>
                                <ul class="ft-navbar-nav">
                            ...
                            <div class="footer-nav-wrap">
                                ...
                                <h4 class="ft-nav-title builder-editable" builder-identity="MF3">{{get_phrase('Support')}}</h4>
                                    <ul class="ft-navbar-nav">
                    ...
                    <div class="footer-copyright-area d-flex align-items-center justify-content-between flex-wrap column-gap-4 row-gap-4 flex-column flex-md-row">
                        <p class="ft-copyright-text text-center text-md-start builder-editable" builder-identity="MF4">{{get_phrase('Copyright ©')}} {{ date('Y') }} | {{get_phrase('All rights reserved by creativeitem.com')}}</p>
                        <ul class="footer-social-list justify-content-center justify-content-md-start">
                        <li>
                            <a href="{{get_settings('contact_facebook')}}" target="_blank" class="ft-social-link">
                                <svg xmlns="http://www.w3.org/2000/svg" width="19" height="18" viewBox="0 0 19 18" fill="none">
                                    <g clip-path="url(#clip0_1208_14439)">
                                      <path d="M18.8134 8.99994C18.8134 4.02941 14.6019 0 9.4067 0C4.21152 0 0 4.02941 0 8.99994C0 13.492 3.43988 17.2154 7.9369 17.8905V11.6015H5.54848V8.99994H7.9369V7.01714C7.9369 4.76153 9.34129 3.5156 11.49 3.5156C12.5188 3.5156 13.5956 3.69138 13.5956 3.69138V5.90621H12.4095C11.241 5.90621 10.8765 6.60001 10.8765 7.31245V8.99994H13.4854L13.0683 11.6015H10.8765V17.8905C15.3735 17.2154 18.8134 13.492 18.8134 8.99994Z" fill="#000"/>
                                    </g>
                                    <defs>
                                      <clipPath id="clip0_1208_14439">
                                        <rect width="18.8134" height="17.9999" fill="#000"/>
                                      </clipPath>
                                    </defs>
                                </svg>
                            </a>
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" width="19" height="18" viewBox="0 0 19 18" fill="#000">
                                    ...
                                    <defs>
                                      <clipPath id="clip0_1208_14435">
                                        <rect width="17.9954" height="17.9999" fill="#000" transform="translate(0.565186)"/>
                                      </clipPath>
                                    </defs>
                                </svg>
                            </a>
    ...
    <!-- Scroll Top -->
 {{-- Music --}}
<script src="{{ asset('assets/frontend/music/vendors/swiper/swiper-bundle.min.js') }}"></script>
{{-- <script src="{{ asset('assets/frontend/music/vendors/wow-js/wow.min.js') }}"></script> --}}
<script src="{{ asset('assets/frontend/music/js/header.js') }}"></script>
<script src="{{ asset('assets/frontend/music/js/script.js') }}"></script>