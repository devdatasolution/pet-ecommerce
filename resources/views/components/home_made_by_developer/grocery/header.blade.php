...
<link rel="stylesheet" href="{{ asset('assets/frontend/grocery/css/header.css') }}">
<link rel="stylesheet" href="{{ asset('assets/frontend/grocery/css/footer.css') }}">
<link rel="stylesheet" href="{{ asset('assets/frontend/grocery/css/style.css') }}">
<link rel="stylesheet" href="{{ asset('assets/frontend/grocery/css/responsive.css') }}">
    ...
    <div class="container">
        <div class="row justify-content-between align-items-center">
            <div class="col-auto col-md order-2 order-md-1">
                <a href="{{ route('home') }}" >
                    <img class="h-30px" src="{{ get_image(get_frontend_settings('dark_logo')) }}" alt="logo">
                </a>
            </div>
                        ...
                        <div class="d-flex align-items-center gap-20px justify-content-center">
                            <div class="mega-menu-btn-wrap">
                                <a href="javascript:void(0)" class="btn ec-btn-success mega-menu-btn d-flex align-items-center gap-2">
                                    <img src="{{ asset('assets/frontend/grocery/images/image-icons/grid-four-white-18.svg') }}" alt="icon">
                                                        ...
                                                        @foreach ($categories as $category)
                                                            ...
                                                            <div class="mega-list-wrap">
                                                                ...
                                                                <a href="{{ route('products', $category->slug) }}">
                                                                        <h5 class="al-title-16px px-10px mb-12px">{{ $category->title }}</h5>
                                                                    </a>
                                                                <ul class="mega-nav">
                            ...
                            <nav>
                                <ul class="header-menu-ul">
                                    <li><a href="{{ route('home') }}" class=" header-menuitem-a {{ request()->routeIs('home') ? 'active' : '' }}">{{ get_phrase('Home') }}</a></li>
                                    <li><a href="{{ route('events') }}" class="header-menuitem-a {{ request()->routeIs('events') ? 'active' : '' }}">{{ get_phrase('Event') }}</a></li>
                                    <li><a href="{{ route('store') }}" class="header-menuitem-a {{ request()->routeIs('store') ? 'active' : '' }}">{{ get_phrase('Store') }}</a></li>
                                    <li><a href="{{ route('blog') }}" class="header-menuitem-a {{ request()->routeIs('blog') ? 'active' : '' }}">{{ get_phrase('Blog') }}</a></li>
                                </ul>
                            </nav>
                        </div>
                    </div>
            ...
            <div class="col-auto col-md order-3">
                <div class="d-flex align-items-center gap-3 justify-content-end">
                    <div class="d-none d-lg-block" data-bs-toggle="modal" data-bs-target="#searchModal">
                        <a href="javascript:;" class="d-flex align-items-center gap-6px icontext-link header-icontext-link" data-bs-toggle="tooltip" data-bs-title="{{get_phrase('Search')}}" aria-describedby="tooltip276572">
                    ...
                    <div class="d-none d-lg-block">
                        <a href="javascript:;" class="d-flex align-items-center gap-6px icontext-link header-icontext-link" data-bs-toggle="tooltip" data-bs-title="{{get_phrase('Wishlist')}}" aria-describedby="tooltip276572">
                            <span class="svg-block position-relative">
                    ...
                    <a href="javascript:;" class="d-flex align-items-center gap-6px icontext-link header-icontext-link" data-bs-toggle="tooltip" data-bs-title="{{get_phrase('Cart')}}" aria-describedby="tooltip276572">
                        <span class="svg-block position-relative" onclick="load_view('{{ route('view', ['path' => 'frontend.cart.offcanvas_cart_body']) }}', '#offcanvasCart')" data-bs-toggle="offcanvas" href="#offcanvasCart" role="button" aria-controls="offcanvasCart">
                            <span class="dark-circle-badge">{{ \App\Models\Cart_item::where('user_id', auth()->id())->count() }}</span>
                            <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    @else
                        <!-- For Logout User -->
                        <div>
                            <a href="javascript:void(0)" onclick="formModal('{{ route('view', ['path' => 'auth.login_modal']) }}', '{{ get_phrase('Log In') }}')" class="d-flex align-items-center gap-6px icontext-link header-icontext-link" data-bs-toggle="modal" >
                                <span class="svg-block" data-bs-toggle="tooltip" data-bs-title="{{get_phrase('Login')}}" aria-describedby="tooltip276572">
                                    <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="modal-body">
                    <div class="mb-20px">
                        <form action="{{route('filter.search')}}" method="post">
                            @csrf
                            <label for="searchFormControlInput1" class="form-label modal-search-label mb-12px builder-editable" builder-identity="sg1">{{get_phrase('Search')}}</label>
