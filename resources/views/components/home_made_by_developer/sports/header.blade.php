...
<link rel="stylesheet" href="{{ asset('assets/frontend/sports/css/header.css') }}">
<link rel="stylesheet" href="{{ asset('assets/frontend/sports/css/footer.css') }}">
<link rel="stylesheet" href="{{ asset('assets/frontend/sports/css/style.css') }}">
<link rel="stylesheet" href="{{ asset('assets/frontend/sports/css/responsive.css') }}">
...
<header class="menu-header dark-menu-header">
    <div class="container">
        <div class="row">
            <div class="col-12">
                    ...
                    <div class="d-block d-lg-none">
                        <button class="menu-button" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasMenu" aria-controls="offcanvasMenu">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                <path d="M21 5.25H3C2.59 5.25 2.25 4.91 2.25 4.5C2.25 4.09 2.59 3.75 3 3.75H21C21.41 3.75 21.75 4.09 21.75 4.5C21.75 4.91 21.41 5.25 21 5.25Z" fill="#0D0E10"></path>
                                <path d="M21 10.25H3C2.59 10.25 2.25 9.91 2.25 9.5C2.25 9.09 2.59 8.75 3 8.75H21C21.41 8.75 21.75 9.09 21.75 9.5C21.75 9.91 21.41 10.25 21 10.25Z" fill="#0D0E10"></path>
                                <path d="M21 15.25H3C2.59 15.25 2.25 14.91 2.25 14.5C2.25 14.09 2.59 13.75 3 13.75H21C21.41 13.75 21.75 14.09 21.75 14.5C21.75 14.91 21.41 15.25 21 15.25Z" fill="#0D0E10"></path>
                                <path d="M21 20.25H3C2.59 20.25 2.25 19.91 2.25 19.5C2.25 19.09 2.59 18.75 3 18.75H21C21.41 18.75 21.75 19.09 21.75 19.5C21.75 19.91 21.41 20.25 21 20.25Z" fill="#0D0E10"></path>
                            </svg>
                        </button>                                  
                    </div>
                    <div class="d-flex align-items-center hr-logo-menu-wrap">
                        <a href="{{route('home')}}" class="header-logo">
                            <img src="{{ get_image(get_frontend_settings('light_logo')) }}" alt="logo">
                        </a>
                        <div class="d-flex align-items-center gap-12px d-none d-lg-flex">
                            <div class="mega-menu-btn-wrap">
                                <a href="javascript:void(0)" class="mega-menu-btn">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none">
                                        <path d="M16.5 6.39V2.985C16.5 1.9275 16.02 1.5 14.8275 1.5H11.7975C10.605 1.5 10.125 1.9275 10.125 2.985V6.3825C10.125 7.4475 10.605 7.8675 11.7975 7.8675H14.8275C16.02 7.875 16.5 7.4475 16.5 6.39Z" fill="white"/>
                                        <path d="M16.5 14.8275V11.7975C16.5 10.605 16.02 10.125 14.8275 10.125H11.7975C10.605 10.125 10.125 10.605 10.125 11.7975V14.8275C10.125 16.02 10.605 16.5 11.7975 16.5H14.8275C16.02 16.5 16.5 16.02 16.5 14.8275Z" fill="white"/>
                                        <path d="M7.875 6.39V2.985C7.875 1.9275 7.395 1.5 6.2025 1.5H3.1725C1.98 1.5 1.5 1.9275 1.5 2.985V6.3825C1.5 7.4475 1.98 7.8675 3.1725 7.8675H6.2025C7.395 7.875 7.875 7.4475 7.875 6.39Z" fill="white"/>
                                        <path d="M7.875 14.8275V11.7975C7.875 10.605 7.395 10.125 6.2025 10.125H3.1725C1.98 10.125 1.5 10.605 1.5 11.7975V14.8275C1.5 16.02 1.98 16.5 3.1725 16.5H6.2025C7.395 16.5 7.875 16.02 7.875 14.8275Z" fill="white"/>
                                    </svg>
                                                        ...
                                                        <div class="mega-list-wrap">
                                                            <div class="mb-30px">
                                                                 <a href="{{ route('products', $category->slug) }}">
                                                                   <h5 class="mega-list-title px-10px mb-12px">{{ $category->title }}</h5>
                                                                </a>
                                                                <ul class="mega-nav">
                                                    ...
                                                    <div class="mega-ads-wrap">
                                                        @foreach ($categories->take(1) as $index => $category)
                                                            @if (!empty($category->banner))
                                                                @if ($index === 0)
                                                                    <img class="banner" src="{{ get_image($category->banner) }}" alt="{{ $category->title }}">
                                                                @endif
                                                            @endif
                                                        @endforeach
                                                    </div>
                            ...
                            <nav>
                                <ul class="header-menu-ul">
                                      <li><a href="{{ route('home') }}" class="header-menuitem-a @if($current_route == 'home') active @endif">{{ get_phrase('Home') }}</a></li>
                                      <li><a href="{{ route('store') }}" class="header-menuitem-a @if($current_route == 'store') active @endif">{{ get_phrase('Store') }}</a></li>
                                    <li><a href="{{ route('events') }}" class="header-menuitem-a @if($current_route == 'event') active @endif">{{ get_phrase('Events') }}</a></li>
                                    <li><a href="{{ route('blog') }}" class="header-menuitem-a @if($current_route == 'blog') active @endif">{{ get_phrase('Blog') }}</a></li>
                                </ul>
                            </nav>
                        </div>
                    </div>
                    <div class="d-flex align-items-center header-right-links">
                        <button type="button" class="search-modal-btn d-none d-lg-block" data-bs-toggle="modal" data-bs-target="#searchModal">
                            <span class="header-svg-link-inner" >
                                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none" data-bs-toggle="tooltip" data-bs-title="Search" data-bs-placement="top">
                                    <path d="M8.625 16.3125C4.3875 16.3125 0.9375 12.8625 0.9375 8.62495C0.9375 4.38745 4.3875 0.937454 8.625 0.937454C12.8625 0.937454 16.3125 4.38745 16.3125 8.62495C16.3125 12.8625 12.8625 16.3125 8.625 16.3125ZM8.625 2.06245C5.0025 2.06245 2.0625 5.00995 2.0625 8.62495C2.0625 12.24 5.0025 15.1875 8.625 15.1875C12.2475 15.1875 15.1875 12.24 15.1875 8.62495C15.1875 5.00995 12.2475 2.06245 8.625 2.06245Z" fill="#0D0E10"/>
                                    <path d="M16.4991 17.0625C16.3566 17.0625 16.2141 17.01 16.1016 16.8975L13.4991 14.2951C13.2816 14.0776 13.2816 13.7176 13.4991 13.5001C13.7166 13.2826 14.0766 13.2826 14.2941 13.5001L16.8966 16.1025C17.1141 16.32 17.1141 16.68 16.8966 16.8975C16.7841 17.01 16.6416 17.0625 16.4991 17.0625Z" fill="#0D0E10"/>
                                </svg>
                            </span>
                        </button>  
                       
                        <div class="d-none d-lg-block">
                            <a href="javascript:void(0)" class="header-svg-link">
                                <span class="header-svg-link-inner" >
                                    <span class="position-relative" data-bs-toggle="tooltip" data-bs-title="{{get_phrase('Wishlist')}}" data-bs-placement="top">
                                        <span class="header-svg-badge">{{ \App\Models\Wishlist_item::where('user_id', auth()->id())->count() }}</span>
                                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none">
                                            <path d="M9 16.2375C8.7675 16.2375 8.5425 16.2075 8.355 16.14C5.49 15.1575 0.9375 11.67 0.9375 6.51745C0.9375 3.89245 3.06 1.76245 5.67 1.76245C6.9375 1.76245 8.1225 2.25745 9 3.14245C9.8775 2.25745 11.0625 1.76245 12.33 1.76245C14.94 1.76245 17.0625 3.89995 17.0625 6.51745C17.0625 11.6775 12.51 15.1575 9.645 16.14C9.4575 16.2075 9.2325 16.2375 9 16.2375ZM5.67 2.88745C3.6825 2.88745 2.0625 4.51495 2.0625 6.51745C2.0625 11.64 6.99 14.49 8.7225 15.0825C8.8575 15.1275 9.15 15.1275 9.285 15.0825C11.01 14.49 15.945 11.6475 15.945 6.51745C15.945 4.51495 14.325 2.88745 12.3375 2.88745C11.1975 2.88745 10.14 3.41995 9.4575 4.34245C9.2475 4.62745 8.7675 4.62745 8.5575 4.34245C7.86 3.41245 6.81 2.88745 5.67 2.88745Z" fill="#0D0E10"/>
                                        </svg>
                                    </span>
                                </span>
                            </a>
                        </div>
                        <a class="header-svg-link" data-bs-toggle="offcanvas"  href="#offcanvasCart"  role="button"  aria-controls="offcanvasCart" onclick="load_view('{{ route('view', ['path' => 'frontend.cart.offcanvas_cart_body']) }}', '#offcanvasCart')">
                          <span class="header-svg-link-inner"  >
                                <span class="position-relative" data-bs-toggle="tooltip"   data-bs-title="Cart"  data-bs-placement="top">
                                    <span class="header-svg-badge">{{ \App\Models\Cart_item::where('user_id', auth()->id())->count() }}</span>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none">
                                        <path d="M12.3673 17.0625H5.62483C4.33483 17.0625 3.36733 16.7175 2.76733 16.035C2.16733 15.3525 1.93482 14.3625 2.09232 13.08L2.76733 7.455C2.96233 5.7975 3.38233 4.3125 6.30733 4.3125H11.7073C14.6248 4.3125 15.0448 5.7975 15.2473 7.455L15.9223 13.08C16.0723 14.3625 15.8473 15.36 15.2473 16.035C14.6248 16.7175 13.6648 17.0625 12.3673 17.0625ZM6.29982 5.4375C4.13982 5.4375 4.03483 6.29249 3.87733 7.58249L3.20233 13.2075C3.08983 14.16 3.22483 14.8575 3.60733 15.285C3.98983 15.7125 4.66483 15.93 5.62483 15.93H12.3673C13.3273 15.93 14.0023 15.7125 14.3848 15.285C14.7673 14.8575 14.9023 14.16 14.7898 13.2075L14.1148 7.58249C13.9573 6.28499 13.8598 5.4375 11.6923 5.4375H6.29982Z" fill="#0D0E10"/>
                                        <path d="M12 6.5625C11.6925 6.5625 11.4375 6.3075 11.4375 6V3.375C11.4375 2.565 10.935 2.0625 10.125 2.0625H7.875C7.065 2.0625 6.5625 2.565 6.5625 3.375V6C6.5625 6.3075 6.3075 6.5625 6 6.5625C5.6925 6.5625 5.4375 6.3075 5.4375 6V3.375C5.4375 1.9425 6.4425 0.9375 7.875 0.9375H10.125C11.5575 0.9375 12.5625 1.9425 12.5625 3.375V6C12.5625 6.3075 12.3075 6.5625 12 6.5625Z" fill="#0D0E10"/>
                                    </svg>
                                </span>
                            </span>
                        </a>
                         ...
                         <div class="dropdown order-3">
                            ...
                            <div class="dropdown-menu dropdown-menu-end header-user-dropdown-menu">
                                <div class="d-flex align-items-center gap-1 header-user-dropdown-header">
                                    ...
                                    <h4 class="hr-dropuser-name">{{ auth()->user()->name }}</h4>
                                </div>
                                <ul>
                        ...
                        <!-- without login -->
                        <div class="">
                            <a href="javascript:void(0)" onclick="formModal('{{ route('view', ['path' => 'auth.login_modal']) }}', '{{ get_phrase('Log In') }}')" class="header-svg-link" data-bs-toggle="modal" data-bs-target="#loginModal">
                                <span class="header-svg-link-inner" >
                                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none" data-bs-toggle="tooltip" data-bs-title="Login" data-bs-placement="top">
            ...
            <form action="{{route('filter.search')}}" method="post" class="mb-20px">
                ...
                <div class="position-relative">
                    ...
                    <button type="submit" class="btn search-submit-btn">
                        <img src="{{ asset('assets/frontend/sports/images/svg-icons/search-white-16.svg') }}" alt="icon">
                    </button>
                </div>
            </form>
            <nav class="mb-40px">
                <ul class="d-flex flex-column gap-30px mobile-menu-ul">
                    ...
                    <li>
                        <a href="{{route('events')}}" class="d-flex gap-2 mobile-menuitem-a">
                            <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M14.4833 2.02579C14.1075 1.64995 13.4567 1.90662 13.4567 2.42912V5.62829C13.4567 6.96662 14.5933 8.07579 15.9775 8.07579C16.8483 8.08495 18.0583 8.08495 19.0942 8.08495C19.6167 8.08495 19.8917 7.47079 19.525 7.10412C18.205 5.77495 15.84 3.38245 14.4833 2.02579Z" fill="#0D0E10"/>
                                <path d="M18.7916 9.34099H16.1425C13.97 9.34099 12.2008 7.57183 12.2008 5.39933V2.75016C12.2008 2.246 11.7883 1.8335 11.2841 1.8335H7.39746C4.57413 1.8335 2.29163 3.66683 2.29163 6.93933V15.061C2.29163 18.3335 4.57413 20.1668 7.39746 20.1668H14.6025C17.4258 20.1668 19.7083 18.3335 19.7083 15.061V10.2577C19.7083 9.75349 19.2958 9.34099 18.7916 9.34099ZM10.5416 16.271H6.87496C6.49913 16.271 6.18746 15.9593 6.18746 15.5835C6.18746 15.2077 6.49913 14.896 6.87496 14.896H10.5416C10.9175 14.896 11.2291 15.2077 11.2291 15.5835C11.2291 15.9593 10.9175 16.271 10.5416 16.271ZM12.375 12.6043H6.87496C6.49913 12.6043 6.18746 12.2927 6.18746 11.9168C6.18746 11.541 6.49913 11.2293 6.87496 11.2293H12.375C12.7508 11.2293 13.0625 11.541 13.0625 11.9168C13.0625 12.2927 12.7508 12.6043 12.375 12.6043Z" fill="#0D0E10"/>
                            </svg>                              
                    ...
                    <li>
                        <a href="{{route('blog')}}" class="d-flex gap-2 mobile-menuitem-a">
                            <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M12.8333 12.146H9.16663C8.79079 12.146 8.47913 12.4577 8.47913 12.8335C8.47913 13.2093 8.79079 13.521 9.16663 13.521H12.8333C13.2091 13.521 13.5208 13.2093 13.5208 12.8335C13.5208 12.4577 13.2091 12.146 12.8333 12.146Z" fill="#0D0E10"/>
                                <path d="M9.16663 9.854H11C11.3758 9.854 11.6875 9.54234 11.6875 9.1665C11.6875 8.79067 11.3758 8.479 11 8.479H9.16663C8.79079 8.479 8.47913 8.79067 8.47913 9.1665C8.47913 9.54234 8.79079 9.854 9.16663 9.854Z" fill="#0D0E10"/>
                                <path d="M14.8409 1.8335H7.16836C3.83169 1.8335 1.84253 3.82266 1.84253 7.15933V14.8318C1.84253 18.1685 3.83169 20.1577 7.16836 20.1577H14.8409C18.1775 20.1577 20.1667 18.1685 20.1667 14.8318V7.15933C20.1667 3.82266 18.1775 1.8335 14.8409 1.8335ZM16.5 13.7502C16.5 15.5835 15.5834 16.5002 13.75 16.5002H8.25002C6.41669 16.5002 5.50002 15.5835 5.50002 13.7502V8.25016C5.50002 6.41683 6.41669 5.50016 8.25002 5.50016H11.9167C13.75 5.50016 14.6667 6.41683 14.6667 8.25016V9.16683C14.6667 9.671 15.0792 10.0835 15.5834 10.0835C16.0875 10.0835 16.5 10.496 16.5 11.0002V13.7502Z" fill="#0D0E10"/>
                            </svg>                                      
                ...
                <div class="modal-body">
                    <div class="mb-20px">
                        <form action="{{route('filter.search')}}" method="post">
                            @csrf
                            <label for="searchFormControlInput1" class="form-label modal-search-label mb-12px builder-editable" builder-identity="ss1">{{get_phrase('Search')}}</label>
