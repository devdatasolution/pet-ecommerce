<link rel="stylesheet" href="{{ asset('assets/frontend/watch-dark/vendors/slick/slick.css') }}">
<link rel="stylesheet" href="{{ asset('assets/frontend/watch-dark/vendors/slick/slick-theme.css') }}">
<link rel="stylesheet" href="{{ asset('assets/frontend/watch-dark/css/header.css') }}">
<link rel="stylesheet" href="{{ asset('assets/frontend/watch-dark/css/footer.css') }}">
<link rel="stylesheet" href="{{ asset('assets/frontend/watch-dark/css/style.css') }}">
<link rel="stylesheet" href="{{ asset('assets/frontend/watch-dark/css/responsive.css') }}">
                    ...
                    <div class="header-menu-right">
                        <nav class="wch-header-navbar d-none d-lg-block">
                            <ul class="wch-navbar-nav">
                                ...
                                <li class="wch-nav-item wch-mega-menu-btn">
                                    <a href="javascript:void(0)" class="wch-nav-link wch-mega-menu-link">
                                        ...
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" height="6"
                                            ...
                                            <path d="M9 1L5 5L1 1" stroke="#ffffff" stroke-width="1.2"
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="wch-mega-inner">
                                                        ...
                                                        <div class="mega-nav-main flex-wrap">
                                ...
                                <li class="wch-nav-item"><a href="{{ route('events') }}"
                                        class="wch-nav-link">{{ get_phrase('Events') }}</a></li>
                        ...
                        <div class="wch-header-right d-flex align-items-center gap-2">
                            <div class="wch-header-right-items">
                                <a href="javascript:;" class="wch-header-right-item " data-bs-toggle="tooltip"
                                    data-bs-title="{{ get_phrase('Cart') }}">
                                    <span
                                        class="d-flex align-items-center justify-content-center h-100 w-100 rounded-circle py-14px position-relative"
                                        ...
                                        <span class="dark-circle-badge wc-badges"
                                ...
                                @else
                                    <a href="javascript:;" class="wch-header-right-item"
                                        ...
                                        <span
                                            ...
                                            data-bs-toggle="tooltip" data-bs-title="{{ get_phrase('Login') }}">
                                            <svg width="25" height="24" viewBox="0 0 25 24" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path
                                                    d="M12.6464 0.299805C15.5544 0.303112 18.3496 1.38822 20.495 3.33105L20.9159 3.73047C23.1093 5.92388 24.343 8.89805 24.3466 12L24.3387 12.4336C24.2639 14.4517 23.6674 16.4162 22.6083 18.1357L22.3749 18.5C21.1697 20.3036 19.4882 21.7343 17.5214 22.6357L17.1239 22.8096C15.1195 23.6398 12.9264 23.8951 10.7899 23.5518L10.3641 23.4756C8.23655 23.0524 6.27096 22.0464 4.68542 20.5742L4.37292 20.2734C2.83896 18.7395 1.76396 16.8111 1.26355 14.7061L1.17078 14.2822C0.747638 12.1546 0.925136 9.95402 1.67859 7.92578L1.83679 7.52246C2.66701 5.51817 4.03749 3.78742 5.79089 2.51953L6.14636 2.27148C7.95 1.0664 10.0507 0.387774 12.2128 0.307617L12.6464 0.299805ZM12.6464 16.5879C11.5506 16.5879 10.4701 16.8459 9.49304 17.3418C8.51615 17.8376 7.67008 18.5572 7.02332 19.4414L6.84363 19.6875L7.09167 19.8633C8.71509 21.0146 10.6562 21.6328 12.6464 21.6328C14.6366 21.6328 16.5776 21.0146 18.201 19.8633L18.4491 19.6875L18.2694 19.4414C17.6226 18.5572 16.7766 17.8376 15.7997 17.3418C14.8226 16.8459 13.7421 16.5879 12.6464 16.5879ZM12.6405 2.35742C10.9446 2.35748 9.28076 2.80498 7.81628 3.65234L7.52625 3.82715C6.08923 4.72747 4.91703 5.98998 4.12585 7.48535L3.97253 7.78809C3.23278 9.31394 2.90965 11.0061 3.03308 12.6934L3.06433 13.0312C3.24754 14.7172 3.87145 16.3232 4.87195 17.6875L5.07703 17.957L5.31335 18.2559L5.54871 17.9561C6.38494 16.8925 7.45111 16.032 8.66687 15.4385L9.04187 15.2549L8.7489 14.958C8.08457 14.2853 7.60701 13.4539 7.36023 12.5459L7.26843 12.1523C7.06269 11.0917 7.17606 9.99393 7.59265 8.99707C8.00927 8.00021 8.71095 7.14865 9.61023 6.5498C10.5095 5.95094 11.5659 5.63184 12.6464 5.63184C13.7268 5.63184 14.7832 5.95094 15.6825 6.5498C16.5818 7.14865 17.2835 8.00021 17.7001 8.99707C18.0646 9.86929 18.1964 10.8187 18.0858 11.7529L18.0243 12.1523C17.8185 13.213 17.303 14.1892 16.5438 14.958L16.2509 15.2549L16.6259 15.4385C17.7684 15.9963 18.7762 16.7922 19.5878 17.7686L19.3495 18.0713H20.5975L20.3524 17.7607C21.3176 16.4708 21.9456 14.9608 22.1757 13.3672L22.2177 13.0312C22.4008 11.3453 22.1351 9.6431 21.451 8.0957L21.3094 7.78809C20.5695 6.26197 19.4404 4.95986 18.0389 4.01172L17.7557 3.82715C16.2227 2.86673 14.4495 2.35742 12.6405 2.35742ZM13.3114 7.76562C12.7324 7.65052 12.1349 7.68788 11.577 7.87207L11.3407 7.95996C10.7176 8.21812 10.1852 8.6551 9.81042 9.21582C9.43561 9.77677 9.23523 10.4367 9.23523 11.1113C9.23529 12.0159 9.5946 12.8838 10.2343 13.5234C10.8739 14.1631 11.7417 14.5225 12.6464 14.5225C13.2367 14.5225 13.8158 14.3695 14.327 14.0801L14.5419 13.9473C15.0326 13.6193 15.428 13.1701 15.6923 12.6455L15.7977 12.416C16.0558 11.7928 16.1237 11.1069 15.9921 10.4453C15.8604 9.78378 15.5354 9.17619 15.0585 8.69922C14.5814 8.22217 13.9731 7.89724 13.3114 7.76562Z"
                                                    fill="white" stroke="#111116" stroke-width="0.6" />
                                            </svg>
                                        </span>
                                    </a>
