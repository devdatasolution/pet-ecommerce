                ...
                <div class="col-12">
                    <div class="mb-50px">
                        <div class="wch-section-badge mb-30px justify-content-center wow animate__fadeInUp" data-wow-delay=".1s">
                            ...
                            <p class="builder-editable" builder-identity="WAF1">{{get_phrase('Featured Collection')}}</p>
                            <img class="badge-shape-right" src="{{ asset('assets/frontend/watch-dark/images/badge-shape-right.svg') }}" alt="shape">
                        </div>
                        <h2 class="section-title mb-30px text-center max-w-922px mx-auto wow animate__fadeInUp builder-editable" builder-identity="WAF2" data-wow-delay=".2s">{{get_phrase('Curated Collections for Every Taste!')}}</h2>
                        <p class="section-subtitle mb-30px text-center max-w-676px mx-auto wow animate__fadeInUp builder-editable" builder-identity="WAF3" data-wow-delay=".3s">{{get_phrase("Our community's favorites timeless designs, exceptional quality & the pieces that keep selling out. Discover what everyone’s talking about.")}}</p>
                        <div class="text-center wow animate__fadeInUp" data-wow-delay=".4s">
                            <a href="{{route('all_products')}}" class="btn wch-btn-white min-w-209px builder-editable" builder-identity="WAF4">{{get_phrase('Explore All')}}</a>
                        </div>
                    </div>
                </div>
            </div>
