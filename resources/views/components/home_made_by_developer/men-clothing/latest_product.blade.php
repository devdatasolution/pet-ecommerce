        ...
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <div class="ps-title-area">
                        <h2 class="section-title text-center mb-30px max-w-888px mx-auto wow animate__fadeInUp builder-editable" builder-identity="MEP1" data-wow-delay=".1s">{{get_phrase('Most loved by our customers this week.')}}</h2>
                        <div class="text-center wow animate__fadeInUp" data-wow-delay=".2s">
                            <a href="{{route('all_products')}}" class="btn mc-btn-outline-black btn-min-218px mx-auto builder-editable" builder-identity="MEP2">{{get_phrase('View All')}}</a>
                        </div>
                    </div>
                </div>
            </div>
            <div class="product-card-wrap wow animate__fadeInUp" data-wow-delay=".3s">
                <div class="product-new-badge">
                    <img class="shape builder-editable" builder-identity="MEP3" src="{{ asset('assets/frontend/men-clothing/images/product-new-badge.png')}}" alt="">
                </div>
                <div class="row gy-4">
                    @php 
