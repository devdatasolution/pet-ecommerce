                                ...
                                <div class="skin-icon-box2">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewbox="0 0 24 24" fill="none">
                                        <g clip-path="url(#clip0_78_1410)">
                                            <path d="M20.4328 7.16888V17.6121C20.4328 21.7894 19.3885 22.8337 15.2112 22.8337H8.94524C4.76795 22.8337 3.72363 21.7894 3.72363 17.6121V7.16888C3.72363 2.99159 4.76795 1.94727 8.94524 1.94727H15.2112C19.3885 1.94727 20.4328 2.99159 20.4328 7.16888Z" stroke="#2B2B2B" stroke-width="1.56648" stroke-linecap="round" stroke-linejoin="round"></path>
                                            <path d="M14.1675 5.60254H9.99023" stroke="#2B2B2B" stroke-width="1.56648" stroke-linecap="round" stroke-linejoin="round"></path>
                                            <path d="M12.0787 19.8058C12.9726 19.8058 13.6974 19.081 13.6974 18.1871C13.6974 17.2931 12.9726 16.5684 12.0787 16.5684C11.1847 16.5684 10.46 17.2931 10.46 18.1871C10.46 19.081 11.1847 19.8058 12.0787 19.8058Z" stroke="#2B2B2B" stroke-width="1.56648" stroke-linecap="round" stroke-linejoin="round"></path>
                                        </g>
                                        <defs>
                                            <clippath id="clip0_78_1410">
                                            <rect width="22.9751" height="22.9751" fill="white" transform="translate(0.59082 0.90332)"></rect>
                                            </clippath>
                                        </defs>
                                    </svg>
                                </div>
                                ...
                                <div class="skin-icon-box2">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewbox="0 0 24 24" fill="none">
                                        ...
                                        <defs>
                                            ...
                                            <rect width="22.9751" height="22.9751" fill="white" transform="translate(0.59082 0.0488281)"></rect>
                                            </clippath>
                                        </defs>
                                    </svg>
                                </div>
