<link rel="stylesheet" href="{{ asset('assets/frontend/bags/css/header.css') }}">
<link rel="stylesheet" href="{{ asset('assets/frontend/bags/css/footer.css') }}">
<link rel="stylesheet" href="{{ asset('assets/frontend/bags/css/style.css') }}">
<link rel="stylesheet" href="{{ asset('assets/frontend/bags/css/custom.css') }}">
<link rel="stylesheet" href="{{ asset('assets/frontend/bags/css/responsive.css') }}">
...
<!-- Main Header -->
<header class="bs-header-section">
    <div class="container">
        <div class="row">
            <div class="col-12">
                <div class="bs-header-area">
                    <a href="{{ route('home') }}" class="bs-header-logo">
                    ...
                    <nav class="bs-header-navbar d-none d-lg-block">
                        <ul class="bs-navbar-nav">
                            <li class="bs-nav-item"><a
                                    class="bs-nav-link @if ($current_route == 'home') active @endif"
                                    href="{{ route('home') }}">{{ get_phrase('Home') }}</a></li>
                            <!-- Mega Menu Button -->
                            <li class="bs-nav-item bs-mega-menu-btn">
                                <a href="javascript:void(0)" class="bs-nav-link bs-mega-menu-link">
                                ...
                                @php
                                    $categories = App\Models\Category::where('parent_id', '=', 0)
                                        ...
                                        ->get();
                                @endphp
                                <div class="bs-mega-menu-wrap">
                                    <div class="container">
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="bs-mega-inner">
                                                    ...
                                                    <div class="mega-nav-main">
                                                        <div class="mega-nav-wrap mega-nav-wrap-top flex-wrap">
                                                            @foreach ($categories as $category)
                                                                @php
                                                                    $subCategories = App\Models\Category::where(
                                                                        ...
                                                                        ->get();
                                                                @endphp
                                                                <div class="bs-mega-nav fit-w-277px">
                            ...
                            <li class="bs-nav-item"><a href="{{ route('store') }}"
                                    class="bs-nav-link @if ($current_route == 'store') active @endif">{{ get_phrase('Store') }}</a>
                            </li>
                            <li class="bs-nav-item"><a href="{{ route('events') }}"
                                    class="bs-nav-link @if ($current_route == 'event') active @endif">{{ get_phrase('Events') }}</a>
                            </li>
                            <li class="bs-nav-item"><a href="{{ route('blog') }}"
                                    class="bs-nav-link @if ($current_route == 'blog') active @endif">{{ get_phrase('Blog') }}</a>
                            </li>
                        </ul>
                    </nav>
                    <div class="bs-header-right d-flex align-items-center gap-2">
                        <div class="bs-header-right-items">
                            <div class="d-none d-lg-block">
                                <a href="javascript:void(0)" class="bs-header-right-item" data-bs-toggle="modal"
                            ...
                            <a onclick="load_view('{{ route('view', ['path' => 'frontend.cart.offcanvas_cart_body']) }}', '#offcanvasCart')"
                                ...
                                aria-controls="offcanvasCart" href="javascript:;" class="bs-header-right-item">
                                <span
                            ...
                            <div class="d-none d-lg-block">
                                <a href="javascript:;" class="bs-header-right-item">
                                    <span
                                        class="d-flex align-items-center justify-content-center h-100 w-100 rounded-circle position-relative"
                            ...
                            @if (Auth::check())
                                <div class="dropdown">
                                    <button class="btn bs-user-dropdown-btn dropdown-toggle" type="button"
                                        data-bs-toggle="dropdown" aria-expanded="false">
                                        <div class="bs-user-dropdown-profile">
                                            <span
                                                class="d-flex align-items-center justify-content-center h-100 w-100 rounded-circle"
                                    ...
                                    <div class="dropdown-menu dropdown-menu-end bs-user-dropdown-menu">
                                        <div class="d-flex align-items-center gap-1 bs-user-dropdown-header">
                                            <div class="bs-user-dropdown-profile2">
                                                <img src="{{ get_image(auth()->user()->photo) }}" alt="user">
                                            </div>
                                            <h4 class="bs-user-dropdown-name">{{ auth()->user()->name }}</h4>
                                        </div>
                                        <ul>
                        ...
                        <!-- Menu Button -->
                        <button class="bs-menu-button d-block d-lg-none" type="button" data-bs-toggle="offcanvas"
...
<div class="d-block d-lg-none">
    <div class="offcanvas offcanvas-start menuoffcanvas" tabindex="-1" id="offcanvasMenu"
        ...
        <div class="offcanvas-body menuoffcanvas-body">
            <form action="{{ route('filter.search') }}" class="mb-20px" method="post">
                @csrf
