            ...
            <div class="row">
                <div class="col-12">
                    <div class="summnersale-section-title-area">
                        <h2 class="section-title text-center max-w-735px mx-auto wow animate__fadeInUp builder-editable" builder-identity="CSS1" data-wow-delay=".1s">{{get_phrase('Summer Sale is Here!')}}</h2>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="text-center">
                        <a href="{{route('all_products')}}" class="btn ca-btn-skin min-w-175px mx-auto builder-editable" builder-identity="CSS2">{{get_phrase('Shop Now')}}</a>
                    </div>
                </div>
            </div>
        </div>
