            ...
            <div class="row justify-content-between gx-4 gy-5 mb-20px">
                <div class="col-12 col-xl-4">
                    <div class="footer-logo-area">
                        ...
                        <p class="footer-info-text builder-editable" builder-identity="CLF1">{{get_phrase('From sleek interiors to smart gadgets everything your ride needs in one place.')}}</p>
                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="ft-nav-wrap">
                                 <h3 class="ft-nav-title builder-editable" builder-identity="CLF2">{{get_phrase('Quick Links')}}</h3>
                        ...
                        <div class="col-lg-4">
                            @php
                                ...
                                @endphp
                            <div class="ft-nav-wrap">
                                 <h4 class="ft-nav-title builder-editable" builder-identity="CLF20">{{get_phrase('Top Categories')}}</h4>
                                    <ul class="ft-navbar-nav">
                        ...
                        <div class="col-lg-4">
                             <div class="ft-nav-wrap">
                                 <h4 class="ft-nav-title builder-editable" builder-identity="CLF3">{{get_phrase('Support')}}</h4>
                                    <ul class="ft-navbar-nav">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="footer-copyright-area">
                        <p class="ft-copyright-text builder-editable" builder-identity="CLF4">{{get_phrase('Copyright ©')}} {{ date('Y') }} | {{get_phrase('All rights reserved by creativeitem.com')}}</p>
