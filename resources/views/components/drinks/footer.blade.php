                ...
                <div class="row">
                    ...
                    <div class="col-lg-2 col-md-4 col-sm-6 mb-3">
                        <nav class="footer-navbar">
                            <h4 class="footer-nav-title">{{get_phrase('Quick Links')}}</h4>
                    ...
                    <div class="col-lg-2 col-md-4 col-sm-6 mb-3">
                        ...
                        @endphp
                        <nav class="footer-navbar">
                             <h4 class="footer-nav-title">{{get_phrase('Top Categories')}}</h4>
                              <ul class="ft-navbar-nav">
                    ...
                    <div class="col-lg-2 col-md-4 col-sm-6 mb-3">
                         <nav class="footer-navbar">
                            <h4 class="footer-nav-title">{{get_phrase('Support')}}</h4>
                            <ul class="ft-navbar-nav">
                    ...
                    <div class="col-lg-2 col-md-4 col-sm-6 mb-3">
                       ...
                       <h4 class="ft-bottom-title">{{get_phrase('Our Social Links:')}}</h4>
...
<!-- Scroll Top -->
 ...
 <script src="{{ asset('assets/frontend/drinks/vendors/wow-js/wow.min.js') }}"></script>
