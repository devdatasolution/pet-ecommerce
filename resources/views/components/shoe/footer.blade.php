                ...
                <div class="footer-area">
                    <div class="footer-top-area">
                        ...
                        <div class="footer-nav-content">
                            <h2 class="footer-nav-title">{{get_phrase('Quick Links')}}</h2>
                        ...
                        @endphp
                        <div class="footer-nav-content">
                            <h2 class="footer-nav-title">{{get_phrase('Top Categories')}}</h2>
                            <ul class="footer-navbar-nav">
                        ...
                        <div class="footer-nav-content">
                            <h2 class="footer-nav-title">{{get_phrase('Support')}}</h2>
                                 <ul class="footer-navbar-nav">
...
<script src="{{ asset('assets/frontend/shoe/vendors/wow-js/wow.min.js') }}"></script>
