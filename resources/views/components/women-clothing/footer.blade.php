                ...
                <div class="col-12">
                    <div class="footer-main-area">
                        <div class="footer-logo-area">
                            ...
                            <p class="ft-info-text">{{get_phrase('Step into a world where fashion meets femininity. Discover the season’s latest must-haves.')}}</p>
                            <ul class="d-flex align-items-center flex-wrap gap-12px mb-40px">
                                <li>
                        ...
                        <div class="footer-nav-area">
                            <div class="ft-nav-wrap ft-nav-wrap-outer">
                                ...
                                <ul class="ft-navbar-nav">
                                    ...
                                    <li class="ft-nav-item"><a href="{{route('all_products')}}" class="ft-nav-link">{{get_phrase('Shop')}}</a></li>
                            ...
                            <div class="ft-nav-right">
                                <div class="ft-right-nav-main">
                                    <div class="ft-nav-wrap ft-nav-wrap-inner">
                                        <h3 class="ft-nav-title">{{get_phrase('Top Categories')}}</h3>
                                        <ul class="ft-navbar-nav">
                                    ...
                                    <div class="ft-nav-wrap ft-nav-wrap-inner">
                                        <h3 class="ft-nav-title">{{get_phrase('Support')}}</h3>
                                        <ul class="ft-navbar-nav">
