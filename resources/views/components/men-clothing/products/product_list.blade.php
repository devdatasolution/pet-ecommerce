...
.list  .pc-card-view ,
.list  .pc-card-bookmark {
	right: 30px;
    pointer-events: inherit;
}
.list:hover .product-card-btn ,
.list:hover .pc-card-view,
.list:hover .pc-card-bookmark{
    visibility: visible;
    opacity: 1;
}
.list .product-card-btn{
            ...
            <div class="w-100 product-card">
                <div class="d-flex align-items-start gap-3 mb-2 justify-content-between flex-column flex-md-row">
                    <div class="max-width">
                      ...
                      <a href="{{ route('product', $product->slug) }}"  class="product-card-btn w-auto">
                       {{get_phrase('Shop Now')}}
                    </a>
                </div>
