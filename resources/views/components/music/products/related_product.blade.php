                 ...
                 <div class="product-card  swiper-slide">
                        <div class="pc-banner-wrap">
                            ...
                            <div class="pc-banner-icons">
                                <a href="javascript:;"  class="product-card-wishlist mb-10px {{ wishlist_class($related_product->id) }}" 
                                ...
                                <a href="javascript:;"  onclick="load_view('{{ route('view', ['path' => 'frontend.products.quick_view', 'product_id' => $related_product->id]) }}', '#quickViewModal .modal-body')" data-bs-toggle="modal" data-bs-target="#quickViewModal"  class="product-card-view mb-10px">
                                    <span class="pc-view-inner" data-bs-toggle="tooltip" data-bs-title="{{get_phrase('Quick View')}}">
                        ...
                        <div class="product-card-body">
                            <div class="d-flex flex-wrap gap-3 justify-content-between pc-title-price">
                            ...
                            <p class="product-card-subtitle"> {{ \Illuminate\Support\Str::limit($related_product->summary, 90, '...') }}</p>
                            <a href="{{ route('product', $related_product->slug) }}"  class="product-card-btn">
                                {{get_phrase('Shop Now')}}
                            </a>
                        </div>
                </div>
