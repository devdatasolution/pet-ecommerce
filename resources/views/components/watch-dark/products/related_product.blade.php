...
.pc-inner-slider .swiper-wrapper{
    height: auto;
}
</style>
                   ...
                   <span class="product-card-bookmark-inner" data-bs-toggle="tooltip" data-bs-title="{{get_phrase('Wishlist')}}">
                        ...
                        <div class="product-card-body">
                            <div class="d-flex align-items-center gap-2 mb-12px flex-wrap">
                                ...
                                <p class="pc-rating-review-total">{{ number_format($related_product->average_rating, 1) }} ( {{ $related_product->reviews->count() }})</p>
                            </div>
                            ...
                            <p class="product-card-subtitle">  {{ \Illuminate\Support\Str::limit($related_product->summary, 50, '...') }}</p>
                            ...
                            <a href="{{ route('product', $related_product->slug) }}" class="btn wch-sm2-btn-white">{{get_phrase('Shop Now')}}</a>
                        </div>
                    </div>
             @endforeach
    </div>
